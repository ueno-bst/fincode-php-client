...
class DefaultApi
{
     ...
     * @throws \InvalidArgumentException
     */
    public function cancelInvoices(mixed $id, mixed $tenantShopId = null, string $contentType = self::contentTypes['cancelInvoices'][0]): mixed
    {
        list($response) = $this->cancelInvoicesWithHttpInfo($id, $tenantShopId, $contentType);

        return $response;
    }

    /**
     * cancelInvoicesWithHttpInfo: インボイス キャンセル.
     *
     * @param string $id           インボイスID (required)
     * @param string $tenantShopId &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書のキャンセルができます。 (optional)
     * @param string $contentType  The value for the Content-Type header. Check self::contentTypes['cancelInvoices'] to see the possible values for this operation
     ...
     * @throws \InvalidArgumentException
     */
    public function cancelInvoicesWithHttpInfo(mixed $id, mixed $tenantShopId = null, string $contentType = self::contentTypes['cancelInvoices'][0]): array
    {
    ...
    /**
     * cancelInvoicesAsync: インボイス キャンセル.
     *
     * @param string $id           インボイスID (required)
     * @param string $tenantShopId &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書のキャンセルができます。 (optional)
     * @param string $contentType  The value for the Content-Type header. Check self::contentTypes['cancelInvoices'] to see the possible values for this operation
     ...
     * @throws \InvalidArgumentException
     */
    public function cancelInvoicesAsync(mixed $id, mixed $tenantShopId = null, string $contentType = self::contentTypes['cancelInvoices'][0]): PromiseInterface
    {
        return $this->cancelInvoicesAsyncWithHttpInfo($id, $tenantShopId, $contentType)->then(function ($response) {
            return $response[0];
        });
    }

    /**
     * cancelInvoicesAsyncWithHttpInfo: インボイス キャンセル.
     *
     * @param string $id           インボイスID (required)
     * @param string $tenantShopId &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書のキャンセルができます。 (optional)
     * @param string $contentType  The value for the Content-Type header. Check self::contentTypes['cancelInvoices'] to see the possible values for this operation
    ...
    /**
     * Create request for operation 'cancelInvoices'.
     *
     * @param string $id           インボイスID (required)
     * @param string $tenantShopId &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書のキャンセルができます。 (optional)
     * @param string $contentType  The value for the Content-Type header. Check self::contentTypes['cancelInvoices'] to see the possible values for this operation
     ...
     * @throws \InvalidArgumentException
     */
    public function cancelInvoicesRequest(mixed $id, mixed $tenantShopId = null, string $contentType = self::contentTypes['cancelInvoices'][0]): Request
    {
        // verify the required parameter 'id' is set
        if (null === $id || is_array($id) && 0 === count($id)) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling cancelInvoices');
        }
        $resourcePath = '/v1/invoices/{id}/cancel';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \InvalidArgumentException
     */
    public function deleteInvoices(mixed $id, mixed $tenantShopId = null, string $contentType = self::contentTypes['deleteInvoices'][0]): mixed
    {
        list($response) = $this->deleteInvoicesWithHttpInfo($id, $tenantShopId, $contentType);

        return $response;
    }

    /**
     * deleteInvoicesWithHttpInfo: インボイス 削除.
     *
     * @param string $id           インボイスID (required)
     * @param string $tenantShopId &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを販売主とした請求書情報を削除します。 (optional)
     * @param string $contentType  The value for the Content-Type header. Check self::contentTypes['deleteInvoices'] to see the possible values for this operation
     ...
     * @throws \InvalidArgumentException
     */
    public function deleteInvoicesWithHttpInfo(mixed $id, mixed $tenantShopId = null, string $contentType = self::contentTypes['deleteInvoices'][0]): array
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function deleteInvoicesAsync(mixed $id, mixed $tenantShopId = null, string $contentType = self::contentTypes['deleteInvoices'][0]): PromiseInterface
    {
        return $this->deleteInvoicesAsyncWithHttpInfo($id, $tenantShopId, $contentType)->then(function ($response) {
            return $response[0];
        });
    }

    /**
     * deleteInvoicesAsyncWithHttpInfo: インボイス 削除.
     *
     * @param string $id           インボイスID (required)
     * @param string $tenantShopId &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを販売主とした請求書情報を削除します。 (optional)
     * @param string $contentType  The value for the Content-Type header. Check self::contentTypes['deleteInvoices'] to see the possible values for this operation
     ...
     * @throws \InvalidArgumentException
     */
    public function deleteInvoicesRequest(mixed $id, mixed $tenantShopId = null, string $contentType = self::contentTypes['deleteInvoices'][0]): Request
    {
        // verify the required parameter 'id' is set
        if (null === $id || is_array($id) && 0 === count($id)) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling deleteInvoices');
        }
     ...
     * @throws \InvalidArgumentException
     */
    public function getInvoices(mixed $id, mixed $tenantShopId = null, string $contentType = self::contentTypes['getInvoices'][0]): mixed
    {
        list($response) = $this->getInvoicesWithHttpInfo($id, $tenantShopId, $contentType);

        return $response;
    }

    /**
     * getInvoicesWithHttpInfo: インボイス 取得.
     *
     * @param string $id           インボイスID (required)
     * @param string $tenantShopId &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定することで、指定したテナントショップのインボイス請求書情報を取得できます。 (optional)
     * @param string $contentType  The value for the Content-Type header. Check self::contentTypes['getInvoices'] to see the possible values for this operation
     ...
     * @throws \InvalidArgumentException
     */
    public function getInvoicesWithHttpInfo(mixed $id, mixed $tenantShopId = null, string $contentType = self::contentTypes['getInvoices'][0]): array
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function getInvoicesAsync(mixed $id, mixed $tenantShopId = null, string $contentType = self::contentTypes['getInvoices'][0]): PromiseInterface
    {
        return $this->getInvoicesAsyncWithHttpInfo($id, $tenantShopId, $contentType)->then(function ($response) {
            return $response[0];
        });
    }

    /**
     * getInvoicesAsyncWithHttpInfo: インボイス 取得.
     *
     * @param string $id           インボイスID (required)
     * @param string $tenantShopId &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定することで、指定したテナントショップのインボイス請求書情報を取得できます。 (optional)
     * @param string $contentType  The value for the Content-Type header. Check self::contentTypes['getInvoices'] to see the possible values for this operation
     ...
     * @throws \InvalidArgumentException
     */
    public function getInvoicesRequest(mixed $id, mixed $tenantShopId = null, string $contentType = self::contentTypes['getInvoices'][0]): Request
    {
        // verify the required parameter 'id' is set
        if (null === $id || is_array($id) && 0 === count($id)) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling getInvoices');
        }
        $resourcePath = '/v1/invoices/{id}';
        $formParams = [];
        $queryParams = [];
     ...
     * @throws \InvalidArgumentException
     */
    public function getInvoicesList(mixed $tenantShopId = null, mixed $query = null, string $contentType = self::contentTypes['getInvoicesList'][0]): mixed
    {
        list($response) = $this->getInvoicesListWithHttpInfo($tenantShopId, $query, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function getInvoicesListWithHttpInfo(mixed $tenantShopId = null, mixed $query = null, string $contentType = self::contentTypes['getInvoicesList'][0]): array
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function getInvoicesListAsync(mixed $tenantShopId = null, mixed $query = null, string $contentType = self::contentTypes['getInvoicesList'][0]): PromiseInterface
    {
        return $this->getInvoicesListAsyncWithHttpInfo($tenantShopId, $query, $contentType)->then(function ($response) {
            return $response[0];
        });
    }
     ...
     * @throws \InvalidArgumentException
     */
    public function getInvoicesListRequest(mixed $tenantShopId = null, mixed $query = null, string $contentType = self::contentTypes['getInvoicesList'][0]): Request
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function openInvoices(mixed $id, mixed $tenantShopId = null, mixed $invoiceDetailOpeningRequest = null, string $contentType = self::contentTypes['openInvoices'][0]): mixed
    {
        list($response) = $this->openInvoicesWithHttpInfo($id, $tenantShopId, $invoiceDetailOpeningRequest, $contentType);

        return $response;
    }

    /**
     * openInvoicesWithHttpInfo: インボイス 発行.
     *
     * @param string                                             $id                          インボイスID (required)
     * @param string                                             $tenantShopId                &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書の請求を実施します。 (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function openInvoicesWithHttpInfo(mixed $id, mixed $tenantShopId = null, mixed $invoiceDetailOpeningRequest = null, string $contentType = self::contentTypes['openInvoices'][0]): array
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function openInvoicesAsync(mixed $id, mixed $tenantShopId = null, mixed $invoiceDetailOpeningRequest = null, string $contentType = self::contentTypes['openInvoices'][0]): PromiseInterface
    {
        return $this->openInvoicesAsyncWithHttpInfo($id, $tenantShopId, $invoiceDetailOpeningRequest, $contentType)->then(function ($response) {
            return $response[0];
        });
    }

    /**
     * openInvoicesAsyncWithHttpInfo: インボイス 発行.
     *
     * @param string                                             $id                          インボイスID (required)
     * @param string                                             $tenantShopId                &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書の請求を実施します。 (optional)
     * @param \Fincode\OpenAPI\Model\InvoiceDetailOpeningRequest $invoiceDetailOpeningRequest (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function openInvoicesRequest(mixed $id, mixed $tenantShopId = null, mixed $invoiceDetailOpeningRequest = null, string $contentType = self::contentTypes['openInvoices'][0]): Request
    {
        // verify the required parameter 'id' is set
        if (null === $id || is_array($id) && 0 === count($id)) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling openInvoices');
        }
        $resourcePath = '/v1/invoices/{id}/open';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $headers = $this->headerSelector->selectHeaders(['application/json'], $contentType, $multipart);
        // for model (json/xml)
        if (isset($invoiceDetailOpeningRequest)) {
            if (false !== stripos($headers['Content-Type'], 'application/json')) {
                // if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($invoiceDetailOpeningRequest));
            } else {
                $httpBody = $invoiceDetailOpeningRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * paidExternallyInvoices: インボイス 外部支払いマーク.
     *
     * @param string                                               $id                            インボイスID (required)
     ...
     * @throws \InvalidArgumentException
     */
    public function paidExternallyInvoices(mixed $id, mixed $tenantShopId = null, mixed $paidExternallyInvoicesRequest = null, string $contentType = self::contentTypes['paidExternallyInvoices'][0]): mixed
    {
        list($response) = $this->paidExternallyInvoicesWithHttpInfo($id, $tenantShopId, $paidExternallyInvoicesRequest, $contentType);

        return $response;
    }

    /**
     * paidExternallyInvoicesWithHttpInfo: インボイス 外部支払いマーク.
     *
     * @param string                                               $id                            インボイスID (required)
     * @param string                                               $tenantShopId                  &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書についての更新ができます。 (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function paidExternallyInvoicesWithHttpInfo(mixed $id, mixed $tenantShopId = null, mixed $paidExternallyInvoicesRequest = null, string $contentType = self::contentTypes['paidExternallyInvoices'][0]): array
    {
    ...
    /**
     * paidExternallyInvoicesAsync: インボイス 外部支払いマーク.
     *
     * @param string                                               $id                            インボイスID (required)
     * @param string                                               $tenantShopId                  &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書についての更新ができます。 (optional)
     * @param \Fincode\OpenAPI\Model\PaidExternallyInvoicesRequest $paidExternallyInvoicesRequest (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function paidExternallyInvoicesAsync(mixed $id, mixed $tenantShopId = null, mixed $paidExternallyInvoicesRequest = null, string $contentType = self::contentTypes['paidExternallyInvoices'][0]): PromiseInterface
    {
        return $this->paidExternallyInvoicesAsyncWithHttpInfo($id, $tenantShopId, $paidExternallyInvoicesRequest, $contentType)->then(function ($response) {
            return $response[0];
        });
    }

    /**
     * paidExternallyInvoicesAsyncWithHttpInfo: インボイス 外部支払いマーク.
     *
     * @param string                                               $id                            インボイスID (required)
     * @param string                                               $tenantShopId                  &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書についての更新ができます。 (optional)
     * @param \Fincode\OpenAPI\Model\PaidExternallyInvoicesRequest $paidExternallyInvoicesRequest (optional)
    ...
    /**
     * Create request for operation 'paidExternallyInvoices'.
     *
     * @param string                                               $id                            インボイスID (required)
     * @param string                                               $tenantShopId                  &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書についての更新ができます。 (optional)
     * @param \Fincode\OpenAPI\Model\PaidExternallyInvoicesRequest $paidExternallyInvoicesRequest (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function paidExternallyInvoicesRequest(mixed $id, mixed $tenantShopId = null, mixed $paidExternallyInvoicesRequest = null, string $contentType = self::contentTypes['paidExternallyInvoices'][0]): Request
    {
        // verify the required parameter 'id' is set
        if (null === $id || is_array($id) && 0 === count($id)) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling paidExternallyInvoices');
        }
        $resourcePath = '/v1/invoices/{id}/paid_externally';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $headers = $this->headerSelector->selectHeaders(['application/json'], $contentType, $multipart);
        // for model (json/xml)
        if (isset($paidExternallyInvoicesRequest)) {
            if (false !== stripos($headers['Content-Type'], 'application/json')) {
                // if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($paidExternallyInvoicesRequest));
            } else {
                $httpBody = $paidExternallyInvoicesRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * refreshInvoicesVirtualaccount: インボイス バーチャル口座再発行.
     *
     * @param string $id          インボイスID (required)
     ...
     * @throws \InvalidArgumentException
     */
    public function refreshInvoicesVirtualaccount(mixed $id, string $contentType = self::contentTypes['refreshInvoicesVirtualaccount'][0]): mixed
    {
        list($response) = $this->refreshInvoicesVirtualaccountWithHttpInfo($id, $contentType);

        return $response;
    }

    /**
     * refreshInvoicesVirtualaccountWithHttpInfo: インボイス バーチャル口座再発行.
     *
     * @param string $id          インボイスID (required)
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['refreshInvoicesVirtualaccount'] to see the possible values for this operation
     *
     ...
     * @throws \InvalidArgumentException
     */
    public function refreshInvoicesVirtualaccountWithHttpInfo(mixed $id, string $contentType = self::contentTypes['refreshInvoicesVirtualaccount'][0]): array
    {
    ...
    /**
     * refreshInvoicesVirtualaccountAsync: インボイス バーチャル口座再発行.
     *
     * @param string $id          インボイスID (required)
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['refreshInvoicesVirtualaccount'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     */
    public function refreshInvoicesVirtualaccountAsync(mixed $id, string $contentType = self::contentTypes['refreshInvoicesVirtualaccount'][0]): PromiseInterface
    {
        return $this->refreshInvoicesVirtualaccountAsyncWithHttpInfo($id, $contentType)->then(function ($response) {
            return $response[0];
        });
    }

    /**
     * refreshInvoicesVirtualaccountAsyncWithHttpInfo: インボイス バーチャル口座再発行.
     *
     * @param string $id          インボイスID (required)
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['refreshInvoicesVirtualaccount'] to see the possible values for this operation
     *
    ...
    /**
     * Create request for operation 'refreshInvoicesVirtualaccount'.
     *
     * @param string $id          インボイスID (required)
     * @param string $contentType The value for the Content-Type header. Check self::contentTypes['refreshInvoicesVirtualaccount'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     */
    public function refreshInvoicesVirtualaccountRequest(mixed $id, string $contentType = self::contentTypes['refreshInvoicesVirtualaccount'][0]): Request
    {
        // verify the required parameter 'id' is set
        if (null === $id || is_array($id) && 0 === count($id)) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling refreshInvoicesVirtualaccount');
        }
        if (strlen($id) > 30) {
            throw new \InvalidArgumentException('invalid length for "$id" when calling DefaultApi.refreshInvoicesVirtualaccount, must be smaller than or equal to 30.');
        }
        if (strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for "$id" when calling DefaultApi.refreshInvoicesVirtualaccount, must be bigger than or equal to 1.');
        }
        $resourcePath = '/v1/invoices/{id}/virtual_account/refresh';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \InvalidArgumentException
     */
    public function registerInvoices(mixed $tenantShopId = null, mixed $invoiceCreatingRequest = null, string $contentType = self::contentTypes['registerInvoices'][0]): mixed
    {
        list($response) = $this->registerInvoicesWithHttpInfo($tenantShopId, $invoiceCreatingRequest, $contentType);
     ...
     * @throws \InvalidArgumentException
     */
    public function registerInvoicesWithHttpInfo(mixed $tenantShopId = null, mixed $invoiceCreatingRequest = null, string $contentType = self::contentTypes['registerInvoices'][0]): array
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function registerInvoicesAsync(mixed $tenantShopId = null, mixed $invoiceCreatingRequest = null, string $contentType = self::contentTypes['registerInvoices'][0]): PromiseInterface
    {
        return $this->registerInvoicesAsyncWithHttpInfo($tenantShopId, $invoiceCreatingRequest, $contentType)->then(function ($response) {
            return $response[0];
        });
    }
     ...
     * @throws \InvalidArgumentException
     */
    public function registerInvoicesRequest(mixed $tenantShopId = null, mixed $invoiceCreatingRequest = null, string $contentType = self::contentTypes['registerInvoices'][0]): Request
    {
        $resourcePath = '/v1/invoices';
        $formParams = [];
        $queryParams = [];
        ...
        $headers = $this->headerSelector->selectHeaders(['application/json'], $contentType, $multipart);
        // for model (json/xml)
        if (isset($invoiceCreatingRequest)) {
            if (false !== stripos($headers['Content-Type'], 'application/json')) {
                // if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($invoiceCreatingRequest));
            } else {
                $httpBody = $invoiceCreatingRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @throws \InvalidArgumentException
     */
    public function updateInvoices(mixed $id, mixed $tenantShopId = null, mixed $invoiceDetailUpdatingRequest = null, string $contentType = self::contentTypes['updateInvoices'][0]): mixed
    {
        list($response) = $this->updateInvoicesWithHttpInfo($id, $tenantShopId, $invoiceDetailUpdatingRequest, $contentType);

        return $response;
    }

    /**
     * updateInvoicesWithHttpInfo: インボイス 更新.
     *
     * @param string                                              $id                           インボイスID (required)
     * @param string                                              $tenantShopId                 &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを販売主とした請求書情報を更新します。 (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function updateInvoicesWithHttpInfo(mixed $id, mixed $tenantShopId = null, mixed $invoiceDetailUpdatingRequest = null, string $contentType = self::contentTypes['updateInvoices'][0]): array
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function updateInvoicesAsync(mixed $id, mixed $tenantShopId = null, mixed $invoiceDetailUpdatingRequest = null, string $contentType = self::contentTypes['updateInvoices'][0]): PromiseInterface
    {
        return $this->updateInvoicesAsyncWithHttpInfo($id, $tenantShopId, $invoiceDetailUpdatingRequest, $contentType)->then(function ($response) {
            return $response[0];
        });
    }

    /**
     * updateInvoicesAsyncWithHttpInfo: インボイス 更新.
     *
     * @param string                                              $id                           インボイスID (required)
     * @param string                                              $tenantShopId                 &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを販売主とした請求書情報を更新します。 (optional)
     * @param \Fincode\OpenAPI\Model\InvoiceDetailUpdatingRequest $invoiceDetailUpdatingRequest (optional)
     ...
     * @throws \InvalidArgumentException
     */
    public function updateInvoicesRequest(mixed $id, mixed $tenantShopId = null, mixed $invoiceDetailUpdatingRequest = null, string $contentType = self::contentTypes['updateInvoices'][0]): Request
    {
        // verify the required parameter 'id' is set
        if (null === $id || is_array($id) && 0 === count($id)) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updateInvoices');
        }
        $resourcePath = '/v1/invoices/{id}';
        $formParams = [];
        $queryParams = [];
        ...
        $headers = $this->headerSelector->selectHeaders(['application/json'], $contentType, $multipart);
        // for model (json/xml)
        if (isset($invoiceDetailUpdatingRequest)) {
            if (false !== stripos($headers['Content-Type'], 'application/json')) {
                // if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($invoiceDetailUpdatingRequest));
            } else {
                $httpBody = $invoiceDetailUpdatingRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
