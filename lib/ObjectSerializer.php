...
class ObjectSerializer
{
     ...
     *
     * @param string|bool|\DateTime|\Stringable $value a string which will be part of the path
     *
     ...
     */
    public static function toQueryValue(mixed $value, string $paramName, string $openApiType = 'string', string $style = 'form', bool $explode = true, bool $required = true): array
    {
     ...
     *
     * @param string|bool|\DateTime|\Stringable $value the value of the parameter
     *
     * @return string the header string
     */
     ...
     * @param class-string $class       class name is passed as a string
     * @param string[]     $httpHeaders HTTP headers
     *
     * @return bool|int|float|string|array|object|null a single or an array of $class instances
     */
    public static function deserialize(mixed $data, string $class, ?array $httpHeaders = null): bool|int|float|string|array|object|null
    {
        if (null === $data) {
            return null;
        }
        ...
        if (enum_exists($class) && method_exists($class, 'tryFrom')) {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\OpenAPI\Fincode\Model\\'.$data->{$discriminator};
     ...
     */
    public static function buildQuery(mixed $data, string $numeric_prefix = '', ?string $arg_separator = null, int $encoding_type = \PHP_QUERY_RFC3986): string
    {
