 ...
 */
class PaymentCardReauthorizingRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Payment.Card.Reauthorizing.Request';
    /**
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentCardReauthorizingRequest., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentCardReauthorizingRequest., must be bigger than or equal to 24.');
        }
     ...
     * Sets method.
     *
     * @param CardPayMethod $method 支払方法  - `1`: 一括払い - `2`: 分割払い - `5`: リボ払い
     */
