 ...
 */
class WebhookSettingCreatingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'WebhookSetting.Creating.Response';
    /**
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 50) {
            throw new \InvalidArgumentException('invalid length for $id when calling WebhookSettingCreatingResponse., must be smaller than or equal to 50.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling WebhookSettingCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setSignature(mixed $signature): static
    {
        ...
        if (mb_strlen($signature) > 60) {
            throw new \InvalidArgumentException('invalid length for $signature when calling WebhookSettingCreatingResponse., must be smaller than or equal to 60.');
        }
        if (mb_strlen($signature) < 1) {
            throw new \InvalidArgumentException('invalid length for $signature when calling WebhookSettingCreatingResponse., must be bigger than or equal to 1.');
        }
