 ...
 */
class WebhookSettingUpdatingRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'WebhookSetting.Updating.Request';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['url' => 'string', 'event' => '\OpenAPI\Fincode\Model\FincodeEvent', 'signature' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['url' => 'uri', 'event' => null, 'signature' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['url' => false, 'event' => false, 'signature' => false];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['url' => 'url', 'event' => 'event', 'signature' => 'signature'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['url' => 'setUrl', 'event' => 'setEvent', 'signature' => 'setSignature'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['url' => 'getUrl', 'event' => 'getEvent', 'signature' => 'getSignature'];
    ...
    public function setSignature(mixed $signature): static
    {
        ...
        if (mb_strlen($signature) > 60) {
            throw new \InvalidArgumentException('invalid length for $signature when calling WebhookSettingUpdatingRequest., must be smaller than or equal to 60.');
        }
        if (mb_strlen($signature) < 1) {
            throw new \InvalidArgumentException('invalid length for $signature when calling WebhookSettingUpdatingRequest., must be bigger than or equal to 1.');
        }
