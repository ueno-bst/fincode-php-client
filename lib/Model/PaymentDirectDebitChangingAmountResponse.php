 ...
 */
class PaymentDirectDebitChangingAmountResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Payment.DirectDebit.ChangingAmount.Response';
    /**
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 30) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 30.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 24.');
        }
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (!is_null($customerId) && mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 60.');
        }
        if (!is_null($customerId) && mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId(mixed $customerGroupId): static
    {
        ...
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) > 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 13.');
        }
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) < 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setErrorCode(mixed $errorCode): static
    {
        ...
        if (!is_null($errorCode) && mb_strlen($errorCode) > 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 11.');
        }
        if (!is_null($errorCode) && mb_strlen($errorCode) < 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 11.');
        }
    ...
    public function setPaymentMethodId(mixed $paymentMethodId): static
    {
        ...
        if (!is_null($paymentMethodId) && mb_strlen($paymentMethodId) > 25) {
            throw new \InvalidArgumentException('invalid length for $paymentMethodId when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 25.');
        }
        if (!is_null($paymentMethodId) && mb_strlen($paymentMethodId) < 25) {
            throw new \InvalidArgumentException('invalid length for $paymentMethodId when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 25.');
        }
    ...
    public function setBankCode(mixed $bankCode): static
    {
        ...
        if (!is_null($bankCode) && mb_strlen($bankCode) > 4) {
            throw new \InvalidArgumentException('invalid length for $bankCode when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 4.');
        }
        if (!is_null($bankCode) && mb_strlen($bankCode) < 4) {
            throw new \InvalidArgumentException('invalid length for $bankCode when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 4.');
        }
    ...
    public function setBankName(mixed $bankName): static
    {
        ...
        if (!is_null($bankName) && mb_strlen($bankName) > 45) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 45.');
        }
        if (!is_null($bankName) && mb_strlen($bankName) < 1) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setBranchCode(mixed $branchCode): static
    {
        ...
        if (!is_null($branchCode) && mb_strlen($branchCode) > 3) {
            throw new \InvalidArgumentException('invalid length for $branchCode when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 3.');
        }
        if (!is_null($branchCode) && mb_strlen($branchCode) < 3) {
            throw new \InvalidArgumentException('invalid length for $branchCode when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 3.');
        }
    ...
    public function setBranchName(mixed $branchName): static
    {
        ...
        if (!is_null($branchName) && mb_strlen($branchName) > 45) {
            throw new \InvalidArgumentException('invalid length for $branchName when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 45.');
        }
        if (!is_null($branchName) && mb_strlen($branchName) < 1) {
            throw new \InvalidArgumentException('invalid length for $branchName when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setRemarks(mixed $remarks): static
    {
        ...
        if (!is_null($remarks) && mb_strlen($remarks) > 9) {
            throw new \InvalidArgumentException('invalid length for $remarks when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 9.');
        }
        if (!is_null($remarks) && mb_strlen($remarks) < 1) {
            throw new \InvalidArgumentException('invalid length for $remarks when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setSubscriptionId(mixed $subscriptionId): static
    {
        ...
        if (!is_null($subscriptionId) && mb_strlen($subscriptionId) > 25) {
            throw new \InvalidArgumentException('invalid length for $subscriptionId when calling PaymentDirectDebitChangingAmountResponse., must be smaller than or equal to 25.');
        }
        if (!is_null($subscriptionId) && mb_strlen($subscriptionId) < 1) {
            throw new \InvalidArgumentException('invalid length for $subscriptionId when calling PaymentDirectDebitChangingAmountResponse., must be bigger than or equal to 1.');
        }
