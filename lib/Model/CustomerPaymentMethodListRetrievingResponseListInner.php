 ...
 */
class CustomerPaymentMethodListRetrievingResponseListInner implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'CustomerPaymentMethod_ListRetrieving_Response_list_inner';
    /**
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 25) {
            throw new \InvalidArgumentException('invalid length for $id when calling CustomerPaymentMethodListRetrievingResponseListInner., must be smaller than or equal to 25.');
        }
        if (mb_strlen($id) < 25) {
            throw new \InvalidArgumentException('invalid length for $id when calling CustomerPaymentMethodListRetrievingResponseListInner., must be bigger than or equal to 25.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling CustomerPaymentMethodListRetrievingResponseListInner., must be smaller than or equal to 60.');
        }
    ...
    public function setRedirectUrl(mixed $redirectUrl): static
    {
        ...
        if (!is_null($redirectUrl) && mb_strlen($redirectUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $redirectUrl when calling CustomerPaymentMethodListRetrievingResponseListInner., must be smaller than or equal to 256.');
        }
    ...
    public function setReturnUrl(mixed $returnUrl): static
    {
        ...
        if (!is_null($returnUrl) && mb_strlen($returnUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $returnUrl when calling CustomerPaymentMethodListRetrievingResponseListInner., must be smaller than or equal to 256.');
        }
