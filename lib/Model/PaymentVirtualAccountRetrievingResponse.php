...
class PaymentVirtualAccountRetrievingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PaymentVirtualAccountRetrievingResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 30) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 30.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentVirtualAccountRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentVirtualAccountRetrievingResponse., must be bigger than or equal to 24.');
        }
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentVirtualAccountRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentVirtualAccountRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentVirtualAccountRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (!is_null($customerId) && mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 60.');
        }
        if (!is_null($customerId) && mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling PaymentVirtualAccountRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId(mixed $customerGroupId): static
    {
        ...
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) > 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 13.');
        }
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) < 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling PaymentVirtualAccountRetrievingResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setErrorCode(mixed $errorCode): static
    {
        ...
        if (!is_null($errorCode) && mb_strlen($errorCode) > 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 11.');
        }
        if (!is_null($errorCode) && mb_strlen($errorCode) < 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling PaymentVirtualAccountRetrievingResponse., must be bigger than or equal to 11.');
        }
    ...
    public function setPaymentMethodId(mixed $paymentMethodId): static
    {
        ...
        if (mb_strlen($paymentMethodId) > 25) {
            throw new \InvalidArgumentException('invalid length for $paymentMethodId when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 25.');
        }
        if (mb_strlen($paymentMethodId) < 25) {
            throw new \InvalidArgumentException('invalid length for $paymentMethodId when calling PaymentVirtualAccountRetrievingResponse., must be bigger than or equal to 25.');
        }
    ...
    public function setVaBranchCode(mixed $vaBranchCode): static
    {
        ...
        if (!is_null($vaBranchCode) && mb_strlen($vaBranchCode) > 3) {
            throw new \InvalidArgumentException('invalid length for $vaBranchCode when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 3.');
        }
        if (!is_null($vaBranchCode) && mb_strlen($vaBranchCode) < 1) {
            throw new \InvalidArgumentException('invalid length for $vaBranchCode when calling PaymentVirtualAccountRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setVaBranchName(mixed $vaBranchName): static
    {
        ...
        if (!is_null($vaBranchName) && mb_strlen($vaBranchName) > 15) {
            throw new \InvalidArgumentException('invalid length for $vaBranchName when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 15.');
        }
    ...
    public function setVaAccountNumber(mixed $vaAccountNumber): static
    {
        ...
        if (!is_null($vaAccountNumber) && mb_strlen($vaAccountNumber) > 7) {
            throw new \InvalidArgumentException('invalid length for $vaAccountNumber when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 7.');
        }
        if (!is_null($vaAccountNumber) && mb_strlen($vaAccountNumber) < 7) {
            throw new \InvalidArgumentException('invalid length for $vaAccountNumber when calling PaymentVirtualAccountRetrievingResponse., must be bigger than or equal to 7.');
        }
    ...
    public function setVaAccountName(mixed $vaAccountName): static
    {
        ...
        if (!is_null($vaAccountName) && mb_strlen($vaAccountName) > 40) {
            throw new \InvalidArgumentException('invalid length for $vaAccountName when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 40.');
        }
    ...
    public function setVirtualAccountId(mixed $virtualAccountId): static
    {
        ...
        if (!is_null($virtualAccountId) && mb_strlen($virtualAccountId) > 10) {
            throw new \InvalidArgumentException('invalid length for $virtualAccountId when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 10.');
        }
        if (!is_null($virtualAccountId) && mb_strlen($virtualAccountId) < 10) {
            throw new \InvalidArgumentException('invalid length for $virtualAccountId when calling PaymentVirtualAccountRetrievingResponse., must be bigger than or equal to 10.');
        }
    ...
    public function setRemitterAccountName(mixed $remitterAccountName): static
    {
        ...
        if (!is_null($remitterAccountName) && mb_strlen($remitterAccountName) > 48) {
            throw new \InvalidArgumentException('invalid length for $remitterAccountName when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 48.');
        }
    ...
    public function setRemitterBankName(mixed $remitterBankName): static
    {
        ...
        if (!is_null($remitterBankName) && mb_strlen($remitterBankName) > 30) {
            throw new \InvalidArgumentException('invalid length for $remitterBankName when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 30.');
        }
    ...
    public function setRemitterBranchName(mixed $remitterBranchName): static
    {
        ...
        if (!is_null($remitterBranchName) && mb_strlen($remitterBranchName) > 15) {
            throw new \InvalidArgumentException('invalid length for $remitterBranchName when calling PaymentVirtualAccountRetrievingResponse., must be smaller than or equal to 15.');
        }
