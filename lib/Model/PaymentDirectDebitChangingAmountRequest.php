 ...
 */
class PaymentDirectDebitChangingAmountRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Payment.DirectDebit.ChangingAmount.Request';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['payType' => '\OpenAPI\Fincode\Model\PayType', 'accessId' => 'string', 'amount' => 'string', 'tax' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['payType' => null, 'accessId' => null, 'amount' => null, 'tax' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['payType' => false, 'accessId' => false, 'amount' => false, 'tax' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['payType' => 'pay_type', 'accessId' => 'access_id', 'amount' => 'amount', 'tax' => 'tax'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['payType' => 'setPayType', 'accessId' => 'setAccessId', 'amount' => 'setAmount', 'tax' => 'setTax'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['payType' => 'getPayType', 'accessId' => 'getAccessId', 'amount' => 'getAmount', 'tax' => 'getTax'];
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentDirectDebitChangingAmountRequest., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentDirectDebitChangingAmountRequest., must be bigger than or equal to 24.');
        }
    ...
    public function setAmount(mixed $amount): static
    {
        ...
        if (mb_strlen($amount) > 10) {
            throw new \InvalidArgumentException('invalid length for $amount when calling PaymentDirectDebitChangingAmountRequest., must be smaller than or equal to 10.');
        }
        if (mb_strlen($amount) < 1) {
            throw new \InvalidArgumentException('invalid length for $amount when calling PaymentDirectDebitChangingAmountRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTax(mixed $tax): static
    {
        ...
        if (!is_null($tax) && mb_strlen($tax) > 10) {
            throw new \InvalidArgumentException('invalid length for $tax when calling PaymentDirectDebitChangingAmountRequest., must be smaller than or equal to 10.');
        }
        if (!is_null($tax) && mb_strlen($tax) < 1) {
            throw new \InvalidArgumentException('invalid length for $tax when calling PaymentDirectDebitChangingAmountRequest., must be bigger than or equal to 1.');
        }
