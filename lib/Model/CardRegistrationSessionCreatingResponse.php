 ...
 */
class CardRegistrationSessionCreatingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'CardRegistrationSession.Creating.Response';
    /**
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 25) {
            throw new \InvalidArgumentException('invalid length for $id when calling CardRegistrationSessionCreatingResponse., must be smaller than or equal to 25.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling CardRegistrationSessionCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setLinkUrl(mixed $linkUrl): static
    {
        ...
        if (mb_strlen($linkUrl) > 100) {
            throw new \InvalidArgumentException('invalid length for $linkUrl when calling CardRegistrationSessionCreatingResponse., must be smaller than or equal to 100.');
        }
        if (mb_strlen($linkUrl) < 1) {
            throw new \InvalidArgumentException('invalid length for $linkUrl when calling CardRegistrationSessionCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setSuccessUrl(mixed $successUrl): static
    {
        ...
        if (!is_null($successUrl) && mb_strlen($successUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $successUrl when calling CardRegistrationSessionCreatingResponse., must be smaller than or equal to 256.');
        }
    ...
    public function setCancelUrl(mixed $cancelUrl): static
    {
        ...
        if (!is_null($cancelUrl) && mb_strlen($cancelUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $cancelUrl when calling CardRegistrationSessionCreatingResponse., must be smaller than or equal to 256.');
        }
    ...
    public function setShopServiceName(mixed $shopServiceName): static
    {
        ...
        if (!is_null($shopServiceName) && mb_strlen($shopServiceName) > 100) {
            throw new \InvalidArgumentException('invalid length for $shopServiceName when calling CardRegistrationSessionCreatingResponse., must be smaller than or equal to 100.');
        }
    ...
    public function setReceiverMail(mixed $receiverMail): static
    {
        ...
        if (!is_null($receiverMail) && mb_strlen($receiverMail) > 254) {
            throw new \InvalidArgumentException('invalid length for $receiverMail when calling CardRegistrationSessionCreatingResponse., must be smaller than or equal to 254.');
        }
    ...
    public function setMailCustomerName(mixed $mailCustomerName): static
    {
        ...
        if (!is_null($mailCustomerName) && mb_strlen($mailCustomerName) > 384) {
            throw new \InvalidArgumentException('invalid length for $mailCustomerName when calling CardRegistrationSessionCreatingResponse., must be smaller than or equal to 384.');
        }
    ...
    public function setShopMailTemplateId(mixed $shopMailTemplateId): static
    {
        ...
        if (!is_null($shopMailTemplateId) && mb_strlen($shopMailTemplateId) > 25) {
            throw new \InvalidArgumentException('invalid length for $shopMailTemplateId when calling CardRegistrationSessionCreatingResponse., must be smaller than or equal to 25.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling CardRegistrationSessionCreatingResponse., must be smaller than or equal to 60.');
        }
        if (mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling CardRegistrationSessionCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerName(mixed $customerName): static
    {
        ...
        if (!is_null($customerName) && mb_strlen($customerName) > 384) {
            throw new \InvalidArgumentException('invalid length for $customerName when calling CardRegistrationSessionCreatingResponse., must be smaller than or equal to 384.');
        }
        if (!is_null($customerName) && mb_strlen($customerName) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerName when calling CardRegistrationSessionCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setTdTenantName(mixed $tdTenantName): static
    {
        ...
        if (mb_strlen($tdTenantName) > 25) {
            throw new \InvalidArgumentException('invalid length for $tdTenantName when calling CardRegistrationSessionCreatingResponse., must be smaller than or equal to 25.');
        }
