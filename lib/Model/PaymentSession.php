...
class PaymentSession implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'PaymentSession';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['id' => 'string', 'linkUrl' => 'string', 'successUrl' => 'string', 'cancelUrl' => 'string', 'status' => '\Fincode\OpenAPI\Model\PaymentSessionStatus', 'expire' => 'string', 'shopServiceName' => 'string', 'guideMailSendFlag' => 'string', 'receiverMail' => 'string', 'mailCustomerName' => 'string', 'thanksMailSendFlag' => 'string', 'shopMailTemplateId' => 'string', 'transaction' => '\Fincode\OpenAPI\Model\PaymentSessionTransaction', 'card' => '\Fincode\OpenAPI\Model\PaymentSessionCard', 'konbini' => '\Fincode\OpenAPI\Model\PaymentSessionKonbini', 'paypay' => '\Fincode\OpenAPI\Model\PaymentSessionPayPay', 'virtualaccount' => '\Fincode\OpenAPI\Model\PaymentSessionVirtualAccount', 'created' => 'string', 'updated' => 'string'];
    /**
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 25) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentSession., must be smaller than or equal to 25.');
        }
        if (mb_strlen($id) < 25) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentSession., must be bigger than or equal to 25.');
        }
    ...
    public function setLinkUrl(mixed $linkUrl): static
    {
        ...
        if (mb_strlen($linkUrl) > 100) {
            throw new \InvalidArgumentException('invalid length for $linkUrl when calling PaymentSession., must be smaller than or equal to 100.');
        }
    ...
    public function setSuccessUrl(mixed $successUrl): static
    {
        ...
        if (!is_null($successUrl) && mb_strlen($successUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $successUrl when calling PaymentSession., must be smaller than or equal to 256.');
        }
    ...
    public function setCancelUrl(mixed $cancelUrl): static
    {
        ...
        if (!is_null($cancelUrl) && mb_strlen($cancelUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $cancelUrl when calling PaymentSession., must be smaller than or equal to 256.');
        }
    ...
    public function setShopServiceName(mixed $shopServiceName): static
    {
        ...
        if (!is_null($shopServiceName) && mb_strlen($shopServiceName) > 100) {
            throw new \InvalidArgumentException('invalid length for $shopServiceName when calling PaymentSession., must be smaller than or equal to 100.');
        }
    ...
    public function setReceiverMail(mixed $receiverMail): static
    {
        ...
        if (!is_null($receiverMail) && mb_strlen($receiverMail) > 254) {
            throw new \InvalidArgumentException('invalid length for $receiverMail when calling PaymentSession., must be smaller than or equal to 254.');
        }
    ...
    public function setMailCustomerName(mixed $mailCustomerName): static
    {
        ...
        if (!is_null($mailCustomerName) && mb_strlen($mailCustomerName) > 384) {
            throw new \InvalidArgumentException('invalid length for $mailCustomerName when calling PaymentSession., must be smaller than or equal to 384.');
        }
    ...
    public function setShopMailTemplateId(mixed $shopMailTemplateId): static
    {
        ...
        if (!is_null($shopMailTemplateId) && mb_strlen($shopMailTemplateId) > 25) {
            throw new \InvalidArgumentException('invalid length for $shopMailTemplateId when calling PaymentSession., must be smaller than or equal to 25.');
        }
