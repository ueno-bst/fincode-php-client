 ...
 */
class CustomerCreatingRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Customer.Creating.Request';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['id' => 'string', 'name' => 'string', 'email' => 'string', 'phoneCc' => 'string', 'phoneNo' => 'string', 'addrCountry' => 'string', 'addrState' => 'string', 'addrCity' => 'string', 'addrLine1' => 'string', 'addrLine2' => 'string', 'addrLine3' => 'string', 'addrPostCode' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['id' => null, 'name' => null, 'email' => null, 'phoneCc' => null, 'phoneNo' => null, 'addrCountry' => null, 'addrState' => null, 'addrCity' => null, 'addrLine1' => null, 'addrLine2' => null, 'addrLine3' => null, 'addrPostCode' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['id' => true, 'name' => true, 'email' => true, 'phoneCc' => true, 'phoneNo' => true, 'addrCountry' => true, 'addrState' => true, 'addrCity' => true, 'addrLine1' => true, 'addrLine2' => true, 'addrLine3' => true, 'addrPostCode' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['id' => 'id', 'name' => 'name', 'email' => 'email', 'phoneCc' => 'phone_cc', 'phoneNo' => 'phone_no', 'addrCountry' => 'addr_country', 'addrState' => 'addr_state', 'addrCity' => 'addr_city', 'addrLine1' => 'addr_line_1', 'addrLine2' => 'addr_line_2', 'addrLine3' => 'addr_line_3', 'addrPostCode' => 'addr_post_code'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['id' => 'setId', 'name' => 'setName', 'email' => 'setEmail', 'phoneCc' => 'setPhoneCc', 'phoneNo' => 'setPhoneNo', 'addrCountry' => 'setAddrCountry', 'addrState' => 'setAddrState', 'addrCity' => 'setAddrCity', 'addrLine1' => 'setAddrLine1', 'addrLine2' => 'setAddrLine2', 'addrLine3' => 'setAddrLine3', 'addrPostCode' => 'setAddrPostCode'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['id' => 'getId', 'name' => 'getName', 'email' => 'getEmail', 'phoneCc' => 'getPhoneCc', 'phoneNo' => 'getPhoneNo', 'addrCountry' => 'getAddrCountry', 'addrState' => 'getAddrState', 'addrCity' => 'getAddrCity', 'addrLine1' => 'getAddrLine1', 'addrLine2' => 'getAddrLine2', 'addrLine3' => 'getAddrLine3', 'addrPostCode' => 'getAddrPostCode'];
     ...
     * Sets id.
     *
     * @param string|null $id 顧客ID\\ 任意の値を指定できます。指定しない場合はfincodeが自動的に生成します。\\ 一度fincodeに登録された顧客IDは削除後も利用できません。
     */
    public function setId(mixed $id): static
    {
        ...
        if (!is_null($id) && mb_strlen($id) > 60) {
            throw new \InvalidArgumentException('invalid length for $id when calling CustomerCreatingRequest., must be smaller than or equal to 60.');
        }
        if (!is_null($id) && mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling CustomerCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setName(mixed $name): static
    {
        ...
        if (!is_null($name) && mb_strlen($name) > 384) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomerCreatingRequest., must be smaller than or equal to 384.');
        }
        if (!is_null($name) && mb_strlen($name) < 1) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomerCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail(mixed $email): static
    {
        ...
        if (!is_null($email) && mb_strlen($email) > 254) {
            throw new \InvalidArgumentException('invalid length for $email when calling CustomerCreatingRequest., must be smaller than or equal to 254.');
        }
        if (!is_null($email) && mb_strlen($email) < 1) {
            throw new \InvalidArgumentException('invalid length for $email when calling CustomerCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneCc(mixed $phoneCc): static
    {
        ...
        if (!is_null($phoneCc) && mb_strlen($phoneCc) > 3) {
            throw new \InvalidArgumentException('invalid length for $phoneCc when calling CustomerCreatingRequest., must be smaller than or equal to 3.');
        }
        if (!is_null($phoneCc) && mb_strlen($phoneCc) < 1) {
            throw new \InvalidArgumentException('invalid length for $phoneCc when calling CustomerCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneNo(mixed $phoneNo): static
    {
        ...
        if (!is_null($phoneNo) && mb_strlen($phoneNo) > 15) {
            throw new \InvalidArgumentException('invalid length for $phoneNo when calling CustomerCreatingRequest., must be smaller than or equal to 15.');
        }
        if (!is_null($phoneNo) && mb_strlen($phoneNo) < 1) {
            throw new \InvalidArgumentException('invalid length for $phoneNo when calling CustomerCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrCountry(mixed $addrCountry): static
    {
        ...
        if (!is_null($addrCountry) && mb_strlen($addrCountry) > 3) {
            throw new \InvalidArgumentException('invalid length for $addrCountry when calling CustomerCreatingRequest., must be smaller than or equal to 3.');
        }
        if (!is_null($addrCountry) && mb_strlen($addrCountry) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrCountry when calling CustomerCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrState(mixed $addrState): static
    {
        ...
        if (!is_null($addrState) && mb_strlen($addrState) > 3) {
            throw new \InvalidArgumentException('invalid length for $addrState when calling CustomerCreatingRequest., must be smaller than or equal to 3.');
        }
        if (!is_null($addrState) && mb_strlen($addrState) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrState when calling CustomerCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrCity(mixed $addrCity): static
    {
        ...
        if (!is_null($addrCity) && mb_strlen($addrCity) > 50) {
            throw new \InvalidArgumentException('invalid length for $addrCity when calling CustomerCreatingRequest., must be smaller than or equal to 50.');
        }
        if (!is_null($addrCity) && mb_strlen($addrCity) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrCity when calling CustomerCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrLine1(mixed $addrLine1): static
    {
        ...
        if (!is_null($addrLine1) && mb_strlen($addrLine1) > 50) {
            throw new \InvalidArgumentException('invalid length for $addrLine1 when calling CustomerCreatingRequest., must be smaller than or equal to 50.');
        }
        if (!is_null($addrLine1) && mb_strlen($addrLine1) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrLine1 when calling CustomerCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrLine2(mixed $addrLine2): static
    {
        ...
        if (!is_null($addrLine2) && mb_strlen($addrLine2) > 50) {
            throw new \InvalidArgumentException('invalid length for $addrLine2 when calling CustomerCreatingRequest., must be smaller than or equal to 50.');
        }
        if (!is_null($addrLine2) && mb_strlen($addrLine2) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrLine2 when calling CustomerCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrLine3(mixed $addrLine3): static
    {
        ...
        if (!is_null($addrLine3) && mb_strlen($addrLine3) > 50) {
            throw new \InvalidArgumentException('invalid length for $addrLine3 when calling CustomerCreatingRequest., must be smaller than or equal to 50.');
        }
        if (!is_null($addrLine3) && mb_strlen($addrLine3) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrLine3 when calling CustomerCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrPostCode(mixed $addrPostCode): static
    {
        ...
        if (!is_null($addrPostCode) && mb_strlen($addrPostCode) > 16) {
            throw new \InvalidArgumentException('invalid length for $addrPostCode when calling CustomerCreatingRequest., must be smaller than or equal to 16.');
        }
        if (!is_null($addrPostCode) && mb_strlen($addrPostCode) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrPostCode when calling CustomerCreatingRequest., must be bigger than or equal to 1.');
        }
