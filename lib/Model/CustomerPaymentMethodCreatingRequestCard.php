...
class CustomerPaymentMethodCreatingRequestCard implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (mb_strlen($this->container['token']) > 512) {
     ...
     * Sets token.
     *
     * @param string $token カードトークン\\ \\ fincode JSの`tokens`メソッドで取得したトークンを指定します。\\ JavaScriptの利用については、[JavaScriptリファレンス](https://docs.fincode.jp/js)をご参照ください。
     */
    public function setToken(mixed $token): static
    {
        ...
        if (mb_strlen($token) > 512) {
            throw new \InvalidArgumentException('invalid length for $token when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 512.');
        }
        if (mb_strlen($token) < 1) {
            throw new \InvalidArgumentException('invalid length for $token when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTdTenantName(mixed $tdTenantName): static
    {
        ...
        if (!is_null($tdTenantName) && mb_strlen($tdTenantName) > 25) {
            throw new \InvalidArgumentException('invalid length for $tdTenantName when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 25.');
        }
    ...
    public function setTds2ChAccChange(mixed $tds2ChAccChange): static
    {
        ...
        if (!is_null($tds2ChAccChange) && mb_strlen($tds2ChAccChange) > 8) {
            throw new \InvalidArgumentException('invalid length for $tds2ChAccChange when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 8.');
        }
        if (!is_null($tds2ChAccChange) && mb_strlen($tds2ChAccChange) < 8) {
            throw new \InvalidArgumentException('invalid length for $tds2ChAccChange when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 8.');
        }
    ...
    public function setTds2ChAccDate(mixed $tds2ChAccDate): static
    {
        ...
        if (!is_null($tds2ChAccDate) && mb_strlen($tds2ChAccDate) > 8) {
            throw new \InvalidArgumentException('invalid length for $tds2ChAccDate when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 8.');
        }
        if (!is_null($tds2ChAccDate) && mb_strlen($tds2ChAccDate) < 8) {
            throw new \InvalidArgumentException('invalid length for $tds2ChAccDate when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 8.');
        }
    ...
    public function setTds2ChAccPwChange(mixed $tds2ChAccPwChange): static
    {
        ...
        if (!is_null($tds2ChAccPwChange) && mb_strlen($tds2ChAccPwChange) > 8) {
            throw new \InvalidArgumentException('invalid length for $tds2ChAccPwChange when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 8.');
        }
        if (!is_null($tds2ChAccPwChange) && mb_strlen($tds2ChAccPwChange) < 8) {
            throw new \InvalidArgumentException('invalid length for $tds2ChAccPwChange when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 8.');
        }
    ...
    public function setTds2NbPurchaseAccount(mixed $tds2NbPurchaseAccount): static
    {
        ...
        if (!is_null($tds2NbPurchaseAccount) && mb_strlen($tds2NbPurchaseAccount) > 4) {
            throw new \InvalidArgumentException('invalid length for $tds2NbPurchaseAccount when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 4.');
        }
        if (!is_null($tds2NbPurchaseAccount) && mb_strlen($tds2NbPurchaseAccount) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2NbPurchaseAccount when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2PaymentAccAge(mixed $tds2PaymentAccAge): static
    {
        ...
        if (!is_null($tds2PaymentAccAge) && mb_strlen($tds2PaymentAccAge) > 8) {
            throw new \InvalidArgumentException('invalid length for $tds2PaymentAccAge when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 8.');
        }
        if (!is_null($tds2PaymentAccAge) && mb_strlen($tds2PaymentAccAge) < 8) {
            throw new \InvalidArgumentException('invalid length for $tds2PaymentAccAge when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 8.');
        }
    ...
    public function setTds2ProvisionAttemptsDay(mixed $tds2ProvisionAttemptsDay): static
    {
        ...
        if (!is_null($tds2ProvisionAttemptsDay) && mb_strlen($tds2ProvisionAttemptsDay) > 3) {
            throw new \InvalidArgumentException('invalid length for $tds2ProvisionAttemptsDay when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 3.');
        }
        if (!is_null($tds2ProvisionAttemptsDay) && mb_strlen($tds2ProvisionAttemptsDay) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2ProvisionAttemptsDay when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2ShipAddressUsage(mixed $tds2ShipAddressUsage): static
    {
        ...
        if (!is_null($tds2ShipAddressUsage) && mb_strlen($tds2ShipAddressUsage) > 8) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddressUsage when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 8.');
        }
        if (!is_null($tds2ShipAddressUsage) && mb_strlen($tds2ShipAddressUsage) < 8) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddressUsage when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 8.');
        }
    ...
    public function setTds2TxnActivityDay(mixed $tds2TxnActivityDay): static
    {
        ...
        if (!is_null($tds2TxnActivityDay) && mb_strlen($tds2TxnActivityDay) > 3) {
            throw new \InvalidArgumentException('invalid length for $tds2TxnActivityDay when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 3.');
        }
        if (!is_null($tds2TxnActivityDay) && mb_strlen($tds2TxnActivityDay) < 3) {
            throw new \InvalidArgumentException('invalid length for $tds2TxnActivityDay when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 3.');
        }
    ...
    public function setTds2TxnActivityYear(mixed $tds2TxnActivityYear): static
    {
        ...
        if (!is_null($tds2TxnActivityYear) && mb_strlen($tds2TxnActivityYear) > 3) {
            throw new \InvalidArgumentException('invalid length for $tds2TxnActivityYear when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 3.');
        }
        if (!is_null($tds2TxnActivityYear) && mb_strlen($tds2TxnActivityYear) < 3) {
            throw new \InvalidArgumentException('invalid length for $tds2TxnActivityYear when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 3.');
        }
    ...
    public function setTds2ThreeDsReqAuthData(mixed $tds2ThreeDsReqAuthData): static
    {
        ...
        if (!is_null($tds2ThreeDsReqAuthData) && mb_strlen($tds2ThreeDsReqAuthData) > 2048) {
            throw new \InvalidArgumentException('invalid length for $tds2ThreeDsReqAuthData when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 2048.');
        }
        if (!is_null($tds2ThreeDsReqAuthData) && mb_strlen($tds2ThreeDsReqAuthData) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2ThreeDsReqAuthData when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2ThreeDsReqAuthTimestamp(mixed $tds2ThreeDsReqAuthTimestamp): static
    {
        ...
        if (!is_null($tds2ThreeDsReqAuthTimestamp) && mb_strlen($tds2ThreeDsReqAuthTimestamp) > 12) {
            throw new \InvalidArgumentException('invalid length for $tds2ThreeDsReqAuthTimestamp when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 12.');
        }
        if (!is_null($tds2ThreeDsReqAuthTimestamp) && mb_strlen($tds2ThreeDsReqAuthTimestamp) < 12) {
            throw new \InvalidArgumentException('invalid length for $tds2ThreeDsReqAuthTimestamp when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 12.');
        }
    ...
    public function setTds2Email(mixed $tds2Email): static
    {
        ...
        if (!is_null($tds2Email) && mb_strlen($tds2Email) > 254) {
            throw new \InvalidArgumentException('invalid length for $tds2Email when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 254.');
        }
        if (!is_null($tds2Email) && mb_strlen($tds2Email) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2Email when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2BillAddrCountry(mixed $tds2BillAddrCountry): static
    {
        ...
        if (!is_null($tds2BillAddrCountry) && mb_strlen($tds2BillAddrCountry) > 3) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrCountry when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 3.');
        }
        if (!is_null($tds2BillAddrCountry) && mb_strlen($tds2BillAddrCountry) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrCountry when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2BillAddrState(mixed $tds2BillAddrState): static
    {
        ...
        if (!is_null($tds2BillAddrState) && mb_strlen($tds2BillAddrState) > 3) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrState when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 3.');
        }
        if (!is_null($tds2BillAddrState) && mb_strlen($tds2BillAddrState) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrState when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2BillAddrCity(mixed $tds2BillAddrCity): static
    {
        ...
        if (!is_null($tds2BillAddrCity) && mb_strlen($tds2BillAddrCity) > 50) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrCity when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 50.');
        }
        if (!is_null($tds2BillAddrCity) && mb_strlen($tds2BillAddrCity) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrCity when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2BillAddrLine1(mixed $tds2BillAddrLine1): static
    {
        ...
        if (!is_null($tds2BillAddrLine1) && mb_strlen($tds2BillAddrLine1) > 100) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrLine1 when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 100.');
        }
        if (!is_null($tds2BillAddrLine1) && mb_strlen($tds2BillAddrLine1) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrLine1 when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2BillAddrLine2(mixed $tds2BillAddrLine2): static
    {
        ...
        if (!is_null($tds2BillAddrLine2) && mb_strlen($tds2BillAddrLine2) > 100) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrLine2 when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 100.');
        }
        if (!is_null($tds2BillAddrLine2) && mb_strlen($tds2BillAddrLine2) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrLine2 when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2BillAddrLine3(mixed $tds2BillAddrLine3): static
    {
        ...
        if (!is_null($tds2BillAddrLine3) && mb_strlen($tds2BillAddrLine3) > 100) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrLine3 when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 100.');
        }
        if (!is_null($tds2BillAddrLine3) && mb_strlen($tds2BillAddrLine3) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrLine3 when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2BillAddrPostCode(mixed $tds2BillAddrPostCode): static
    {
        ...
        if (!is_null($tds2BillAddrPostCode) && mb_strlen($tds2BillAddrPostCode) > 16) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrPostCode when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 16.');
        }
        if (!is_null($tds2BillAddrPostCode) && mb_strlen($tds2BillAddrPostCode) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2BillAddrPostCode when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2ShipAddrCountry(mixed $tds2ShipAddrCountry): static
    {
        ...
        if (!is_null($tds2ShipAddrCountry) && mb_strlen($tds2ShipAddrCountry) > 3) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrCountry when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 3.');
        }
        if (!is_null($tds2ShipAddrCountry) && mb_strlen($tds2ShipAddrCountry) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrCountry when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2ShipAddrState(mixed $tds2ShipAddrState): static
    {
        ...
        if (!is_null($tds2ShipAddrState) && mb_strlen($tds2ShipAddrState) > 3) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrState when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 3.');
        }
        if (!is_null($tds2ShipAddrState) && mb_strlen($tds2ShipAddrState) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrState when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2ShipAddrCity(mixed $tds2ShipAddrCity): static
    {
        ...
        if (!is_null($tds2ShipAddrCity) && mb_strlen($tds2ShipAddrCity) > 50) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrCity when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 50.');
        }
        if (!is_null($tds2ShipAddrCity) && mb_strlen($tds2ShipAddrCity) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrCity when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2ShipAddrLine1(mixed $tds2ShipAddrLine1): static
    {
        ...
        if (!is_null($tds2ShipAddrLine1) && mb_strlen($tds2ShipAddrLine1) > 100) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrLine1 when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 100.');
        }
        if (!is_null($tds2ShipAddrLine1) && mb_strlen($tds2ShipAddrLine1) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrLine1 when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2ShipAddrLine2(mixed $tds2ShipAddrLine2): static
    {
        ...
        if (!is_null($tds2ShipAddrLine2) && mb_strlen($tds2ShipAddrLine2) > 100) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrLine2 when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 100.');
        }
        if (!is_null($tds2ShipAddrLine2) && mb_strlen($tds2ShipAddrLine2) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrLine2 when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2ShipAddrLine3(mixed $tds2ShipAddrLine3): static
    {
        ...
        if (!is_null($tds2ShipAddrLine3) && mb_strlen($tds2ShipAddrLine3) > 100) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrLine3 when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 100.');
        }
        if (!is_null($tds2ShipAddrLine3) && mb_strlen($tds2ShipAddrLine3) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrLine3 when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2ShipAddrPostCode(mixed $tds2ShipAddrPostCode): static
    {
        ...
        if (!is_null($tds2ShipAddrPostCode) && mb_strlen($tds2ShipAddrPostCode) > 16) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrPostCode when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 16.');
        }
        if (!is_null($tds2ShipAddrPostCode) && mb_strlen($tds2ShipAddrPostCode) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2ShipAddrPostCode when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2DeliveryEmailAddress(mixed $tds2DeliveryEmailAddress): static
    {
        ...
        if (!is_null($tds2DeliveryEmailAddress) && mb_strlen($tds2DeliveryEmailAddress) > 254) {
            throw new \InvalidArgumentException('invalid length for $tds2DeliveryEmailAddress when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 254.');
        }
        if (!is_null($tds2DeliveryEmailAddress) && mb_strlen($tds2DeliveryEmailAddress) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2DeliveryEmailAddress when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2HomePhoneCc(mixed $tds2HomePhoneCc): static
    {
        ...
        if (!is_null($tds2HomePhoneCc) && mb_strlen($tds2HomePhoneCc) > 3) {
            throw new \InvalidArgumentException('invalid length for $tds2HomePhoneCc when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 3.');
        }
        if (!is_null($tds2HomePhoneCc) && mb_strlen($tds2HomePhoneCc) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2HomePhoneCc when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2HomePhoneNo(mixed $tds2HomePhoneNo): static
    {
        ...
        if (!is_null($tds2HomePhoneNo) && mb_strlen($tds2HomePhoneNo) > 15) {
            throw new \InvalidArgumentException('invalid length for $tds2HomePhoneNo when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 15.');
        }
        if (!is_null($tds2HomePhoneNo) && mb_strlen($tds2HomePhoneNo) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2HomePhoneNo when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2MobilePhoneCc(mixed $tds2MobilePhoneCc): static
    {
        ...
        if (!is_null($tds2MobilePhoneCc) && mb_strlen($tds2MobilePhoneCc) > 3) {
            throw new \InvalidArgumentException('invalid length for $tds2MobilePhoneCc when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 3.');
        }
        if (!is_null($tds2MobilePhoneCc) && mb_strlen($tds2MobilePhoneCc) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2MobilePhoneCc when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2MobilePhoneNo(mixed $tds2MobilePhoneNo): static
    {
        ...
        if (!is_null($tds2MobilePhoneNo) && mb_strlen($tds2MobilePhoneNo) > 15) {
            throw new \InvalidArgumentException('invalid length for $tds2MobilePhoneNo when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 15.');
        }
        if (!is_null($tds2MobilePhoneNo) && mb_strlen($tds2MobilePhoneNo) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2MobilePhoneNo when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2WorkPhoneCc(mixed $tds2WorkPhoneCc): static
    {
        ...
        if (!is_null($tds2WorkPhoneCc) && mb_strlen($tds2WorkPhoneCc) > 3) {
            throw new \InvalidArgumentException('invalid length for $tds2WorkPhoneCc when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 3.');
        }
        if (!is_null($tds2WorkPhoneCc) && mb_strlen($tds2WorkPhoneCc) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2WorkPhoneCc when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2WorkPhoneNo(mixed $tds2WorkPhoneNo): static
    {
        ...
        if (!is_null($tds2WorkPhoneNo) && mb_strlen($tds2WorkPhoneNo) > 15) {
            throw new \InvalidArgumentException('invalid length for $tds2WorkPhoneNo when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 15.');
        }
        if (!is_null($tds2WorkPhoneNo) && mb_strlen($tds2WorkPhoneNo) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2WorkPhoneNo when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2PreOrderDate(mixed $tds2PreOrderDate): static
    {
        ...
        if (!is_null($tds2PreOrderDate) && mb_strlen($tds2PreOrderDate) > 8) {
            throw new \InvalidArgumentException('invalid length for $tds2PreOrderDate when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 8.');
        }
        if (!is_null($tds2PreOrderDate) && mb_strlen($tds2PreOrderDate) < 8) {
            throw new \InvalidArgumentException('invalid length for $tds2PreOrderDate when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 8.');
        }
    ...
    public function setTds2RecurringExpiry(mixed $tds2RecurringExpiry): static
    {
        ...
        if (!is_null($tds2RecurringExpiry) && mb_strlen($tds2RecurringExpiry) > 8) {
            throw new \InvalidArgumentException('invalid length for $tds2RecurringExpiry when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 8.');
        }
        if (!is_null($tds2RecurringExpiry) && mb_strlen($tds2RecurringExpiry) < 8) {
            throw new \InvalidArgumentException('invalid length for $tds2RecurringExpiry when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 8.');
        }
    ...
    public function setTds2RecurringFrequency(mixed $tds2RecurringFrequency): static
    {
        ...
        if (!is_null($tds2RecurringFrequency) && mb_strlen($tds2RecurringFrequency) > 4) {
            throw new \InvalidArgumentException('invalid length for $tds2RecurringFrequency when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 4.');
        }
        if (!is_null($tds2RecurringFrequency) && mb_strlen($tds2RecurringFrequency) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2RecurringFrequency when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2GiftCardAmount(mixed $tds2GiftCardAmount): static
    {
        ...
        if (!is_null($tds2GiftCardAmount) && mb_strlen($tds2GiftCardAmount) > 15) {
            throw new \InvalidArgumentException('invalid length for $tds2GiftCardAmount when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 15.');
        }
        if (!is_null($tds2GiftCardAmount) && mb_strlen($tds2GiftCardAmount) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2GiftCardAmount when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2GiftCardCount(mixed $tds2GiftCardCount): static
    {
        ...
        if (!is_null($tds2GiftCardCount) && mb_strlen($tds2GiftCardCount) > 2) {
            throw new \InvalidArgumentException('invalid length for $tds2GiftCardCount when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 2.');
        }
        if (!is_null($tds2GiftCardCount) && mb_strlen($tds2GiftCardCount) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2GiftCardCount when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2GiftCardCurr(mixed $tds2GiftCardCurr): static
    {
        ...
        if (!is_null($tds2GiftCardCurr) && mb_strlen($tds2GiftCardCurr) > 3) {
            throw new \InvalidArgumentException('invalid length for $tds2GiftCardCurr when calling CustomerPaymentMethodCreatingRequestCard., must be smaller than or equal to 3.');
        }
        if (!is_null($tds2GiftCardCurr) && mb_strlen($tds2GiftCardCurr) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2GiftCardCurr when calling CustomerPaymentMethodCreatingRequestCard., must be bigger than or equal to 1.');
        }
