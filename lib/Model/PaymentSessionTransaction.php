...
/**
 * 決済共通項目\\ 決済手段を問わず共通して使用される、決済に関するデータです。
 *
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentSessionTransaction implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'PaymentSession_transaction';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['payType' => '\OpenAPI\Fincode\Model\PaymentSessionPayType[]', 'orderId' => 'string', 'amount' => 'int', 'tax' => 'int', 'clientField1' => 'string', 'clientField2' => 'string', 'clientField3' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['payType' => null, 'orderId' => null, 'amount' => 'int32', 'tax' => 'int32', 'clientField1' => null, 'clientField2' => null, 'clientField3' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['payType' => false, 'orderId' => false, 'amount' => false, 'tax' => false, 'clientField1' => true, 'clientField2' => true, 'clientField3' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['payType' => 'pay_type', 'orderId' => 'order_id', 'amount' => 'amount', 'tax' => 'tax', 'clientField1' => 'client_field_1', 'clientField2' => 'client_field_2', 'clientField3' => 'client_field_3'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['payType' => 'setPayType', 'orderId' => 'setOrderId', 'amount' => 'setAmount', 'tax' => 'setTax', 'clientField1' => 'setClientField1', 'clientField2' => 'setClientField2', 'clientField3' => 'setClientField3'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['payType' => 'getPayType', 'orderId' => 'getOrderId', 'amount' => 'getAmount', 'tax' => 'getTax', 'clientField1' => 'getClientField1', 'clientField2' => 'getClientField2', 'clientField3' => 'getClientField3'];
     ...
     * Sets payType.
     *
     * @param PaymentSessionPayType[] $payType 決済手段\\ この決済URL上で使用できる決済手段を指定します。複数指定可能です。  - `Card`：カード決済 - `Konbini`：コンビニ決済 - `Paypay`：PayPay - `Virtualaccount`：バーチャル口座決済
     */
     ...
     * Sets orderId.
     *
     * @param string $orderId オーダーID\\ このリダイレクト型決済URL上で決済後生成される決済情報のID
     */
    public function setOrderId(mixed $orderId): static
    {
        ...
        if (mb_strlen($orderId) > 30) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling PaymentSessionTransaction., must be smaller than or equal to 30.');
        }
        if (mb_strlen($orderId) < 1) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling PaymentSessionTransaction., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentSessionTransaction., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentSessionTransaction., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentSessionTransaction., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentSessionTransaction., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentSessionTransaction., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentSessionTransaction., must be bigger than or equal to 1.');
        }
