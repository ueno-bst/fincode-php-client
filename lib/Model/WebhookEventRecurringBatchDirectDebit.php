 ...
 */
class WebhookEventRecurringBatchDirectDebit implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'WebhookEvent.RecurringBatch.DirectDebit';
    /**
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling WebhookEventRecurringBatchDirectDebit., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling WebhookEventRecurringBatchDirectDebit., must be bigger than or equal to 13.');
        }
    ...
    public function setSucceeded(mixed $succeeded): static
    {
        ...
        if (mb_strlen($succeeded) > 10) {
            throw new \InvalidArgumentException('invalid length for $succeeded when calling WebhookEventRecurringBatchDirectDebit., must be smaller than or equal to 10.');
        }
    ...
    public function setFailed(mixed $failed): static
    {
        ...
        if (mb_strlen($failed) > 10) {
            throw new \InvalidArgumentException('invalid length for $failed when calling WebhookEventRecurringBatchDirectDebit., must be smaller than or equal to 10.');
        }
    ...
    public function setTotal(mixed $total): static
    {
        ...
        if (mb_strlen($total) > 10) {
            throw new \InvalidArgumentException('invalid length for $total when calling WebhookEventRecurringBatchDirectDebit., must be smaller than or equal to 10.');
        }
