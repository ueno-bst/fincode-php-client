...
class PlanCreatingRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static array $openAPITypes = ['id' => 'string', 'planName' => 'string', 'description' => 'string', 'amount' => 'string', 'tax' => 'string', 'intervalPattern' => '\Fincode\OpenAPI\Model\IntervalPattern', 'intervalCount' => '\Fincode\OpenAPI\Model\IntervalCount'];
    /**
