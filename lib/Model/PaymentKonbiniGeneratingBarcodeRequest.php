 ...
 */
class PaymentKonbiniGeneratingBarcodeRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Payment.Konbini.GeneratingBarcode.Request';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['payType' => '\OpenAPI\Fincode\Model\PayType', 'accessId' => 'string', 'deviceName' => 'string', 'winWidth' => 'string', 'winHeight' => 'string', 'pixelRatio' => 'string', 'winSizeType' => '\OpenAPI\Fincode\Model\WinSizeType'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['payType' => null, 'accessId' => null, 'deviceName' => null, 'winWidth' => null, 'winHeight' => null, 'pixelRatio' => null, 'winSizeType' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['payType' => false, 'accessId' => false, 'deviceName' => false, 'winWidth' => false, 'winHeight' => false, 'pixelRatio' => false, 'winSizeType' => false];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['payType' => 'pay_type', 'accessId' => 'access_id', 'deviceName' => 'device_name', 'winWidth' => 'win_width', 'winHeight' => 'win_height', 'pixelRatio' => 'pixel_ratio', 'winSizeType' => 'win_size_type'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['payType' => 'setPayType', 'accessId' => 'setAccessId', 'deviceName' => 'setDeviceName', 'winWidth' => 'setWinWidth', 'winHeight' => 'setWinHeight', 'pixelRatio' => 'setPixelRatio', 'winSizeType' => 'setWinSizeType'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['payType' => 'getPayType', 'accessId' => 'getAccessId', 'deviceName' => 'getDeviceName', 'winWidth' => 'getWinWidth', 'winHeight' => 'getWinHeight', 'pixelRatio' => 'getPixelRatio', 'winSizeType' => 'getWinSizeType'];
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentKonbiniGeneratingBarcodeRequest., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentKonbiniGeneratingBarcodeRequest., must be bigger than or equal to 24.');
        }
    ...
    public function setDeviceName(mixed $deviceName): static
    {
        ...
        if (mb_strlen($deviceName) > 20) {
            throw new \InvalidArgumentException('invalid length for $deviceName when calling PaymentKonbiniGeneratingBarcodeRequest., must be smaller than or equal to 20.');
        }
        if (mb_strlen($deviceName) < 1) {
            throw new \InvalidArgumentException('invalid length for $deviceName when calling PaymentKonbiniGeneratingBarcodeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setWinWidth(mixed $winWidth): static
    {
        ...
        if (mb_strlen($winWidth) > 5) {
            throw new \InvalidArgumentException('invalid length for $winWidth when calling PaymentKonbiniGeneratingBarcodeRequest., must be smaller than or equal to 5.');
        }
        if (mb_strlen($winWidth) < 1) {
            throw new \InvalidArgumentException('invalid length for $winWidth when calling PaymentKonbiniGeneratingBarcodeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setWinHeight(mixed $winHeight): static
    {
        ...
        if (mb_strlen($winHeight) > 5) {
            throw new \InvalidArgumentException('invalid length for $winHeight when calling PaymentKonbiniGeneratingBarcodeRequest., must be smaller than or equal to 5.');
        }
        if (mb_strlen($winHeight) < 1) {
            throw new \InvalidArgumentException('invalid length for $winHeight when calling PaymentKonbiniGeneratingBarcodeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPixelRatio(mixed $pixelRatio): static
    {
        ...
        if (mb_strlen($pixelRatio) > 5) {
            throw new \InvalidArgumentException('invalid length for $pixelRatio when calling PaymentKonbiniGeneratingBarcodeRequest., must be smaller than or equal to 5.');
        }
        if (mb_strlen($pixelRatio) < 1) {
            throw new \InvalidArgumentException('invalid length for $pixelRatio when calling PaymentKonbiniGeneratingBarcodeRequest., must be bigger than or equal to 1.');
        }
