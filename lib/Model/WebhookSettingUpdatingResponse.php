 ...
 */
class WebhookSettingUpdatingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'WebhookSetting.Updating.Response';
    /**
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 50) {
            throw new \InvalidArgumentException('invalid length for $id when calling WebhookSettingUpdatingResponse., must be smaller than or equal to 50.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling WebhookSettingUpdatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setSignature(mixed $signature): static
    {
        ...
        if (mb_strlen($signature) > 60) {
            throw new \InvalidArgumentException('invalid length for $signature when calling WebhookSettingUpdatingResponse., must be smaller than or equal to 60.');
        }
        if (mb_strlen($signature) < 1) {
            throw new \InvalidArgumentException('invalid length for $signature when calling WebhookSettingUpdatingResponse., must be bigger than or equal to 1.');
        }
