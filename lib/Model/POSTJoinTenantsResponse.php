 ...
 */
class POSTJoinTenantsResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'POST.JoinTenants.Response';
    /**
     ...
     */
    protected static array $openAPIFormats = ['id' => null, 'shopName' => null, 'shopNameKana' => null, 'shopType' => null, 'platformId' => null, 'platformName' => null, 'sharedCustomerFlag' => null, 'customerGroupId' => null, 'sendMailAddress' => null, 'shopMailAddress' => null, 'logKeepDays' => null, 'apiVersion' => null, 'apiKeyDisplayFlag' => null, 'created' => null, 'updated' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['id' => false, 'shopName' => true, 'shopNameKana' => true, 'shopType' => false, 'platformId' => false, 'platformName' => true, 'sharedCustomerFlag' => true, 'customerGroupId' => true, 'sendMailAddress' => true, 'shopMailAddress' => true, 'logKeepDays' => true, 'apiVersion' => true, 'apiKeyDisplayFlag' => true, 'created' => false, 'updated' => true];
    /**
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 13) {
            throw new \InvalidArgumentException('invalid length for $id when calling POSTJoinTenantsResponse., must be smaller than or equal to 13.');
        }
        if (mb_strlen($id) < 13) {
            throw new \InvalidArgumentException('invalid length for $id when calling POSTJoinTenantsResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setShopName(mixed $shopName): static
    {
        ...
        if (!is_null($shopName) && mb_strlen($shopName) > 20) {
            throw new \InvalidArgumentException('invalid length for $shopName when calling POSTJoinTenantsResponse., must be smaller than or equal to 20.');
        }
        if (!is_null($shopName) && mb_strlen($shopName) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopName when calling POSTJoinTenantsResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setShopNameKana(mixed $shopNameKana): static
    {
        ...
        if (!is_null($shopNameKana) && mb_strlen($shopNameKana) > 40) {
            throw new \InvalidArgumentException('invalid length for $shopNameKana when calling POSTJoinTenantsResponse., must be smaller than or equal to 40.');
        }
        if (!is_null($shopNameKana) && mb_strlen($shopNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopNameKana when calling POSTJoinTenantsResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setPlatformId(mixed $platformId): static
    {
        ...
        if (mb_strlen($platformId) > 13) {
            throw new \InvalidArgumentException('invalid length for $platformId when calling POSTJoinTenantsResponse., must be smaller than or equal to 13.');
        }
        if (mb_strlen($platformId) < 13) {
            throw new \InvalidArgumentException('invalid length for $platformId when calling POSTJoinTenantsResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setPlatformName(mixed $platformName): static
    {
        ...
        if (!is_null($platformName) && mb_strlen($platformName) > 50) {
            throw new \InvalidArgumentException('invalid length for $platformName when calling POSTJoinTenantsResponse., must be smaller than or equal to 50.');
        }
        if (!is_null($platformName) && mb_strlen($platformName) < 1) {
            throw new \InvalidArgumentException('invalid length for $platformName when calling POSTJoinTenantsResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId(mixed $customerGroupId): static
    {
        ...
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) > 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling POSTJoinTenantsResponse., must be smaller than or equal to 13.');
        }
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) < 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling POSTJoinTenantsResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setSendMailAddress(mixed $sendMailAddress): static
    {
        ...
        if (!is_null($sendMailAddress) && mb_strlen($sendMailAddress) > 255) {
            throw new \InvalidArgumentException('invalid length for $sendMailAddress when calling POSTJoinTenantsResponse., must be smaller than or equal to 255.');
        }
        if (!is_null($sendMailAddress) && mb_strlen($sendMailAddress) < 1) {
            throw new \InvalidArgumentException('invalid length for $sendMailAddress when calling POSTJoinTenantsResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setShopMailAddress(mixed $shopMailAddress): static
    {
        ...
        if (!is_null($shopMailAddress) && mb_strlen($shopMailAddress) > 255) {
            throw new \InvalidArgumentException('invalid length for $shopMailAddress when calling POSTJoinTenantsResponse., must be smaller than or equal to 255.');
        }
        if (!is_null($shopMailAddress) && mb_strlen($shopMailAddress) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopMailAddress when calling POSTJoinTenantsResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setLogKeepDays(mixed $logKeepDays): static
    {
        ...
        if (!is_null($logKeepDays) && $logKeepDays > 9999) {
            throw new \InvalidArgumentException('invalid value for $logKeepDays when calling POSTJoinTenantsResponse., must be smaller than or equal to 9999.');
        }
        if (!is_null($logKeepDays) && $logKeepDays < 0) {
            throw new \InvalidArgumentException('invalid value for $logKeepDays when calling POSTJoinTenantsResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setApiVersion(mixed $apiVersion): static
    {
        ...
        if (!is_null($apiVersion) && mb_strlen($apiVersion) > 8) {
            throw new \InvalidArgumentException('invalid length for $apiVersion when calling POSTJoinTenantsResponse., must be smaller than or equal to 8.');
        }
        if (!is_null($apiVersion) && mb_strlen($apiVersion) < 1) {
            throw new \InvalidArgumentException('invalid length for $apiVersion when calling POSTJoinTenantsResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param ApiKeyDisplayFlag|null $apiKeyDisplayFlag apiKeyDisplayFlag
     */
