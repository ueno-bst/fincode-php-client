 ...
 */
class PlanListRetrievingQueryParams implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Plan.ListRetrieving.QueryParams';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['totalAmountMin' => 'int', 'totalAmountMax' => 'int', 'intervalPattern' => 'string', 'updateDateFrom' => 'string', 'updateDateTo' => 'string', 'planName' => 'string', 'deleteFlag' => 'string', 'sort' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['totalAmountMin' => 'int64', 'totalAmountMax' => 'int64', 'intervalPattern' => null, 'updateDateFrom' => null, 'updateDateTo' => null, 'planName' => null, 'deleteFlag' => null, 'sort' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['totalAmountMin' => false, 'totalAmountMax' => false, 'intervalPattern' => false, 'updateDateFrom' => false, 'updateDateTo' => false, 'planName' => true, 'deleteFlag' => true, 'sort' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['totalAmountMin' => 'total_amount_min', 'totalAmountMax' => 'total_amount_max', 'intervalPattern' => 'interval_pattern', 'updateDateFrom' => 'update_date_from', 'updateDateTo' => 'update_date_to', 'planName' => 'plan_name', 'deleteFlag' => 'delete_flag', 'sort' => 'sort'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['totalAmountMin' => 'setTotalAmountMin', 'totalAmountMax' => 'setTotalAmountMax', 'intervalPattern' => 'setIntervalPattern', 'updateDateFrom' => 'setUpdateDateFrom', 'updateDateTo' => 'setUpdateDateTo', 'planName' => 'setPlanName', 'deleteFlag' => 'setDeleteFlag', 'sort' => 'setSort'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['totalAmountMin' => 'getTotalAmountMin', 'totalAmountMax' => 'getTotalAmountMax', 'intervalPattern' => 'getIntervalPattern', 'updateDateFrom' => 'getUpdateDateFrom', 'updateDateTo' => 'getUpdateDateTo', 'planName' => 'getPlanName', 'deleteFlag' => 'getDeleteFlag', 'sort' => 'getSort'];
    ...
    public function setPlanName(mixed $planName): static
    {
        ...
        if (!is_null($planName) && mb_strlen($planName) > 25) {
            throw new \InvalidArgumentException('invalid length for $planName when calling PlanListRetrievingQueryParams., must be smaller than or equal to 25.');
        }
        if (!is_null($planName) && mb_strlen($planName) < 1) {
            throw new \InvalidArgumentException('invalid length for $planName when calling PlanListRetrievingQueryParams., must be bigger than or equal to 1.');
        }
    ...
    public function setDeleteFlag(mixed $deleteFlag): static
    {
        ...
        if (!is_null($deleteFlag) && mb_strlen($deleteFlag) > 1) {
            throw new \InvalidArgumentException('invalid length for $deleteFlag when calling PlanListRetrievingQueryParams., must be smaller than or equal to 1.');
        }
        if (!is_null($deleteFlag) && mb_strlen($deleteFlag) < 1) {
            throw new \InvalidArgumentException('invalid length for $deleteFlag when calling PlanListRetrievingQueryParams., must be bigger than or equal to 1.');
        }
