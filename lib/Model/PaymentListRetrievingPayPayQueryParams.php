 ...
 */
class PaymentListRetrievingPayPayQueryParams implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Payment.ListRetrieving.PayPay.QueryParams';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['status' => '\OpenAPI\Fincode\Model\PaymentStatus', 'authMaxDateFrom' => 'string', 'authMaxDateTo' => 'string', 'paymentDateFrom' => 'string', 'paymentDateTo' => 'string', 'updatedFrom' => 'string', 'updatedTo' => 'string', 'sort' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['status' => null, 'authMaxDateFrom' => null, 'authMaxDateTo' => null, 'paymentDateFrom' => null, 'paymentDateTo' => null, 'updatedFrom' => null, 'updatedTo' => null, 'sort' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['status' => false, 'authMaxDateFrom' => false, 'authMaxDateTo' => false, 'paymentDateFrom' => false, 'paymentDateTo' => false, 'updatedFrom' => false, 'updatedTo' => false, 'sort' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['status' => 'status', 'authMaxDateFrom' => 'auth_max_date_from', 'authMaxDateTo' => 'auth_max_date_to', 'paymentDateFrom' => 'payment_date_from', 'paymentDateTo' => 'payment_date_to', 'updatedFrom' => 'updated_from', 'updatedTo' => 'updated_to', 'sort' => 'sort'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['status' => 'setStatus', 'authMaxDateFrom' => 'setAuthMaxDateFrom', 'authMaxDateTo' => 'setAuthMaxDateTo', 'paymentDateFrom' => 'setPaymentDateFrom', 'paymentDateTo' => 'setPaymentDateTo', 'updatedFrom' => 'setUpdatedFrom', 'updatedTo' => 'setUpdatedTo', 'sort' => 'setSort'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['status' => 'getStatus', 'authMaxDateFrom' => 'getAuthMaxDateFrom', 'authMaxDateTo' => 'getAuthMaxDateTo', 'paymentDateFrom' => 'getPaymentDateFrom', 'paymentDateTo' => 'getPaymentDateTo', 'updatedFrom' => 'getUpdatedFrom', 'updatedTo' => 'getUpdatedTo', 'sort' => 'getSort'];
     ...
     * Sets sort.
     *
     * @param string|null $sort ソートする項目と順序を指定します。\\ 例： `?sort=updated␣desc,created␣asc`\\ \\ ソート可能な項目  - `status`: ステータス - `process_date`: 処理日時 - `total_amount`: 合計金額 - `auth_max_date`: 仮売上有効期限 - `payment_date`: 支払い日時 - `created`: 作成日時 - `updated`: 更新日時
     */
