 ...
 */
class POSTContractsExaminations implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'POST.ContractsExaminations';
    /**
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling POSTContractsExaminations., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling POSTContractsExaminations., must be bigger than or equal to 13.');
        }
