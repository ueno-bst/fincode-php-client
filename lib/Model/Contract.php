...
class Contract implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling Contract., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling Contract., must be bigger than or equal to 13.');
        }
    ...
    public function setPlatformId(mixed $platformId): static
    {
        ...
        if (mb_strlen($platformId) > 13) {
            throw new \InvalidArgumentException('invalid length for $platformId when calling Contract., must be smaller than or equal to 13.');
        }
        if (mb_strlen($platformId) < 13) {
            throw new \InvalidArgumentException('invalid length for $platformId when calling Contract., must be bigger than or equal to 13.');
        }
    ...
    public function setStopCancelaltionMemo(mixed $stopCancelaltionMemo): static
    {
        ...
        if (!is_null($stopCancelaltionMemo) && mb_strlen($stopCancelaltionMemo) > 5000) {
            throw new \InvalidArgumentException('invalid length for $stopCancelaltionMemo when calling Contract., must be smaller than or equal to 5000.');
        }
        if (!is_null($stopCancelaltionMemo) && mb_strlen($stopCancelaltionMemo) < 1) {
            throw new \InvalidArgumentException('invalid length for $stopCancelaltionMemo when calling Contract., must be bigger than or equal to 1.');
        }
    ...
    public function setObligationsNotice(mixed $obligationsNotice): static
    {
        ...
        if (!is_null($obligationsNotice) && mb_strlen($obligationsNotice) > 5000) {
            throw new \InvalidArgumentException('invalid length for $obligationsNotice when calling Contract., must be smaller than or equal to 5000.');
        }
        if (!is_null($obligationsNotice) && mb_strlen($obligationsNotice) < 1) {
            throw new \InvalidArgumentException('invalid length for $obligationsNotice when calling Contract., must be bigger than or equal to 1.');
        }
    ...
    public function setUserShopName(mixed $userShopName): static
    {
        ...
        if (!is_null($userShopName) && mb_strlen($userShopName) > 50) {
            throw new \InvalidArgumentException('invalid length for $userShopName when calling Contract., must be smaller than or equal to 50.');
        }
        if (!is_null($userShopName) && mb_strlen($userShopName) < 1) {
            throw new \InvalidArgumentException('invalid length for $userShopName when calling Contract., must be bigger than or equal to 1.');
        }
    ...
    public function setRegisterMail(mixed $registerMail): static
    {
        ...
        if (!is_null($registerMail) && mb_strlen($registerMail) > 384) {
            throw new \InvalidArgumentException('invalid length for $registerMail when calling Contract., must be smaller than or equal to 384.');
        }
        if (!is_null($registerMail) && mb_strlen($registerMail) < 1) {
            throw new \InvalidArgumentException('invalid length for $registerMail when calling Contract., must be bigger than or equal to 1.');
        }
