...
class PaymentSessionCreatingRequestCard implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setTds2ProvisionAttemptsDay(mixed $tds2ProvisionAttemptsDay): static
    {
        ...
        if (!is_null($tds2ProvisionAttemptsDay) && mb_strlen($tds2ProvisionAttemptsDay) < 3) {
            throw new \InvalidArgumentException('invalid length for $tds2ProvisionAttemptsDay when calling PaymentSessionCreatingRequestCard., must be bigger than or equal to 3.');
        }
