...
class PaymentBulkListRetrievingQueryParams implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static array $openAPITypes = ['processPlanDateFrom' => 'string', 'processPlanDateTo' => 'string', 'status' => '\Fincode\OpenAPI\Model\PaymentBulkStatus', 'payType' => '\Fincode\OpenAPI\Model\PaymentBulkPayType', 'fileName' => 'string', 'deleteFlag' => '\Fincode\OpenAPI\Model\DeleteFlag', 'createdFrom' => 'string', 'createdTo' => 'string', 'sort' => 'string'];
    /**
