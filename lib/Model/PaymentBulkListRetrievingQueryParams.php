 ...
 */
class PaymentBulkListRetrievingQueryParams implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'PaymentBulk.ListRetrieving.QueryParams';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['processPlanDateFrom' => 'string', 'processPlanDateTo' => 'string', 'status' => '\OpenAPI\Fincode\Model\PaymentBulkStatus', 'payType' => '\OpenAPI\Fincode\Model\PaymentBulkPayType', 'fileName' => 'string', 'deleteFlag' => '\OpenAPI\Fincode\Model\DeleteFlag', 'createdFrom' => 'string', 'createdTo' => 'string', 'sort' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['processPlanDateFrom' => null, 'processPlanDateTo' => null, 'status' => null, 'payType' => null, 'fileName' => null, 'deleteFlag' => null, 'createdFrom' => null, 'createdTo' => null, 'sort' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['processPlanDateFrom' => true, 'processPlanDateTo' => true, 'status' => false, 'payType' => false, 'fileName' => false, 'deleteFlag' => false, 'createdFrom' => true, 'createdTo' => true, 'sort' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['processPlanDateFrom' => 'process_plan_date_from', 'processPlanDateTo' => 'process_plan_date_to', 'status' => 'status', 'payType' => 'pay_type', 'fileName' => 'file_name', 'deleteFlag' => 'delete_flag', 'createdFrom' => 'created_from', 'createdTo' => 'created_to', 'sort' => 'sort'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['processPlanDateFrom' => 'setProcessPlanDateFrom', 'processPlanDateTo' => 'setProcessPlanDateTo', 'status' => 'setStatus', 'payType' => 'setPayType', 'fileName' => 'setFileName', 'deleteFlag' => 'setDeleteFlag', 'createdFrom' => 'setCreatedFrom', 'createdTo' => 'setCreatedTo', 'sort' => 'setSort'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['processPlanDateFrom' => 'getProcessPlanDateFrom', 'processPlanDateTo' => 'getProcessPlanDateTo', 'status' => 'getStatus', 'payType' => 'getPayType', 'fileName' => 'getFileName', 'deleteFlag' => 'getDeleteFlag', 'createdFrom' => 'getCreatedFrom', 'createdTo' => 'getCreatedTo', 'sort' => 'getSort'];
    ...
    public function setFileName(mixed $fileName): static
    {
        ...
        if (mb_strlen($fileName) > 100) {
            throw new \InvalidArgumentException('invalid length for $fileName when calling PaymentBulkListRetrievingQueryParams., must be smaller than or equal to 100.');
        }
        if (mb_strlen($fileName) < 1) {
            throw new \InvalidArgumentException('invalid length for $fileName when calling PaymentBulkListRetrievingQueryParams., must be bigger than or equal to 1.');
        }
