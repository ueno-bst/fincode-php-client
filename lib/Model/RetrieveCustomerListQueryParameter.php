 ...
 */
class RetrieveCustomerListQueryParameter implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'retrieveCustomerList_query_parameter';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['page' => 'int', 'limit' => 'int', 'countOnly' => 'bool', 'id' => 'string', 'name' => 'string', 'email' => 'string', 'createdFrom' => 'string', 'createdTo' => 'string', 'sort' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['page' => null, 'limit' => null, 'countOnly' => null, 'id' => null, 'name' => null, 'email' => null, 'createdFrom' => null, 'createdTo' => null, 'sort' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['page' => true, 'limit' => true, 'countOnly' => true, 'id' => true, 'name' => true, 'email' => true, 'createdFrom' => true, 'createdTo' => true, 'sort' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['page' => 'page', 'limit' => 'limit', 'countOnly' => 'count_only', 'id' => 'id', 'name' => 'name', 'email' => 'email', 'createdFrom' => 'created_from', 'createdTo' => 'created_to', 'sort' => 'sort'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['page' => 'setPage', 'limit' => 'setLimit', 'countOnly' => 'setCountOnly', 'id' => 'setId', 'name' => 'setName', 'email' => 'setEmail', 'createdFrom' => 'setCreatedFrom', 'createdTo' => 'setCreatedTo', 'sort' => 'setSort'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['page' => 'getPage', 'limit' => 'getLimit', 'countOnly' => 'getCountOnly', 'id' => 'getId', 'name' => 'getName', 'email' => 'getEmail', 'createdFrom' => 'getCreatedFrom', 'createdTo' => 'getCreatedTo', 'sort' => 'getSort'];
    ...
    public function setId(mixed $id): static
    {
        ...
        if (!is_null($id) && mb_strlen($id) > 60) {
            throw new \InvalidArgumentException('invalid length for $id when calling RetrieveCustomerListQueryParameter., must be smaller than or equal to 60.');
        }
        if (!is_null($id) && mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling RetrieveCustomerListQueryParameter., must be bigger than or equal to 1.');
        }
    ...
    public function setName(mixed $name): static
    {
        ...
        if (!is_null($name) && mb_strlen($name) > 384) {
            throw new \InvalidArgumentException('invalid length for $name when calling RetrieveCustomerListQueryParameter., must be smaller than or equal to 384.');
        }
        if (!is_null($name) && mb_strlen($name) < 1) {
            throw new \InvalidArgumentException('invalid length for $name when calling RetrieveCustomerListQueryParameter., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail(mixed $email): static
    {
        ...
        if (!is_null($email) && mb_strlen($email) > 254) {
            throw new \InvalidArgumentException('invalid length for $email when calling RetrieveCustomerListQueryParameter., must be smaller than or equal to 254.');
        }
        if (!is_null($email) && mb_strlen($email) < 1) {
            throw new \InvalidArgumentException('invalid length for $email when calling RetrieveCustomerListQueryParameter., must be bigger than or equal to 1.');
        }
