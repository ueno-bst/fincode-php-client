...
class Customer implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 60) {
            throw new \InvalidArgumentException('invalid length for $id when calling Customer., must be smaller than or equal to 60.');
        }
        if (mb_strlen($id) < 1) {
    ...
    public function setName(mixed $name): static
    {
        ...
        if (!is_null($name) && mb_strlen($name) > 384) {
            throw new \InvalidArgumentException('invalid length for $name when calling Customer., must be smaller than or equal to 384.');
        }
    ...
    public function setEmail(mixed $email): static
    {
        ...
        if (!is_null($email) && mb_strlen($email) < 1) {
            throw new \InvalidArgumentException('invalid length for $email when calling Customer., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneCc(mixed $phoneCc): static
    {
        ...
        if (!is_null($phoneCc) && mb_strlen($phoneCc) > 3) {
            throw new \InvalidArgumentException('invalid length for $phoneCc when calling Customer., must be smaller than or equal to 3.');
        }
        if (!is_null($phoneCc) && mb_strlen($phoneCc) < 1) {
            throw new \InvalidArgumentException('invalid length for $phoneCc when calling Customer., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneNo(mixed $phoneNo): static
    {
        ...
        if (!is_null($phoneNo) && mb_strlen($phoneNo) > 15) {
            throw new \InvalidArgumentException('invalid length for $phoneNo when calling Customer., must be smaller than or equal to 15.');
        }
        if (!is_null($phoneNo) && mb_strlen($phoneNo) < 1) {
            throw new \InvalidArgumentException('invalid length for $phoneNo when calling Customer., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrCountry(mixed $addrCountry): static
    {
        ...
        if (!is_null($addrCountry) && mb_strlen($addrCountry) > 3) {
            throw new \InvalidArgumentException('invalid length for $addrCountry when calling Customer., must be smaller than or equal to 3.');
        }
        if (!is_null($addrCountry) && mb_strlen($addrCountry) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrCountry when calling Customer., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrState(mixed $addrState): static
    {
        ...
        if (!is_null($addrState) && mb_strlen($addrState) > 3) {
            throw new \InvalidArgumentException('invalid length for $addrState when calling Customer., must be smaller than or equal to 3.');
        }
        if (!is_null($addrState) && mb_strlen($addrState) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrState when calling Customer., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrCity(mixed $addrCity): static
    {
        ...
        if (!is_null($addrCity) && mb_strlen($addrCity) > 50) {
            throw new \InvalidArgumentException('invalid length for $addrCity when calling Customer., must be smaller than or equal to 50.');
        }
        if (!is_null($addrCity) && mb_strlen($addrCity) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrCity when calling Customer., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrLine1(mixed $addrLine1): static
    {
        ...
        if (!is_null($addrLine1) && mb_strlen($addrLine1) > 50) {
            throw new \InvalidArgumentException('invalid length for $addrLine1 when calling Customer., must be smaller than or equal to 50.');
        }
        if (!is_null($addrLine1) && mb_strlen($addrLine1) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrLine1 when calling Customer., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrLine2(mixed $addrLine2): static
    {
        ...
        if (!is_null($addrLine2) && mb_strlen($addrLine2) > 50) {
            throw new \InvalidArgumentException('invalid length for $addrLine2 when calling Customer., must be smaller than or equal to 50.');
        }
        if (!is_null($addrLine2) && mb_strlen($addrLine2) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrLine2 when calling Customer., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrLine3(mixed $addrLine3): static
    {
        ...
        if (!is_null($addrLine3) && mb_strlen($addrLine3) > 50) {
            throw new \InvalidArgumentException('invalid length for $addrLine3 when calling Customer., must be smaller than or equal to 50.');
        }
        if (!is_null($addrLine3) && mb_strlen($addrLine3) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrLine3 when calling Customer., must be bigger than or equal to 1.');
        }
    ...
    public function setAddrPostCode(mixed $addrPostCode): static
    {
        ...
        if (!is_null($addrPostCode) && mb_strlen($addrPostCode) > 16) {
            throw new \InvalidArgumentException('invalid length for $addrPostCode when calling Customer., must be smaller than or equal to 16.');
        }
        if (!is_null($addrPostCode) && mb_strlen($addrPostCode) < 1) {
            throw new \InvalidArgumentException('invalid length for $addrPostCode when calling Customer., must be bigger than or equal to 1.');
        }
    ...
    public function setCardRegistration(mixed $cardRegistration): static
    {
        ...
        if (!is_null($cardRegistration) && mb_strlen($cardRegistration) > 1) {
            throw new \InvalidArgumentException('invalid length for $cardRegistration when calling Customer., must be smaller than or equal to 1.');
        }
        if (!is_null($cardRegistration) && mb_strlen($cardRegistration) < 1) {
            throw new \InvalidArgumentException('invalid length for $cardRegistration when calling Customer., must be bigger than or equal to 1.');
        }
    ...
    public function setDirectdebitRegistration(mixed $directdebitRegistration): static
    {
        ...
        if (!is_null($directdebitRegistration) && mb_strlen($directdebitRegistration) > 1) {
            throw new \InvalidArgumentException('invalid length for $directdebitRegistration when calling Customer., must be smaller than or equal to 1.');
        }
        if (!is_null($directdebitRegistration) && mb_strlen($directdebitRegistration) < 1) {
            throw new \InvalidArgumentException('invalid length for $directdebitRegistration when calling Customer., must be bigger than or equal to 1.');
        }
