 ...
 */
class PaymentMethodDirectdebit implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'PaymentMethod_directdebit';
    /**
    ...
    public function setBankType(mixed $bankType): static
    {
        ...
        if (!is_null($bankType) && mb_strlen($bankType) > 1) {
            throw new \InvalidArgumentException('invalid length for $bankType when calling PaymentMethodDirectdebit., must be smaller than or equal to 1.');
        }
        if (!is_null($bankType) && mb_strlen($bankType) < 1) {
            throw new \InvalidArgumentException('invalid length for $bankType when calling PaymentMethodDirectdebit., must be bigger than or equal to 1.');
        }
    ...
    public function setBankCode(mixed $bankCode): static
    {
        ...
        if (!is_null($bankCode) && mb_strlen($bankCode) > 4) {
            throw new \InvalidArgumentException('invalid length for $bankCode when calling PaymentMethodDirectdebit., must be smaller than or equal to 4.');
        }
        if (!is_null($bankCode) && mb_strlen($bankCode) < 4) {
            throw new \InvalidArgumentException('invalid length for $bankCode when calling PaymentMethodDirectdebit., must be bigger than or equal to 4.');
        }
    ...
    public function setBankName(mixed $bankName): static
    {
        ...
        if (!is_null($bankName) && mb_strlen($bankName) > 45) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling PaymentMethodDirectdebit., must be smaller than or equal to 45.');
        }
        if (!is_null($bankName) && mb_strlen($bankName) < 1) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling PaymentMethodDirectdebit., must be bigger than or equal to 1.');
        }
    ...
    public function setBranchCode(mixed $branchCode): static
    {
        ...
        if (!is_null($branchCode) && mb_strlen($branchCode) > 3) {
            throw new \InvalidArgumentException('invalid length for $branchCode when calling PaymentMethodDirectdebit., must be smaller than or equal to 3.');
        }
        if (!is_null($branchCode) && mb_strlen($branchCode) < 3) {
            throw new \InvalidArgumentException('invalid length for $branchCode when calling PaymentMethodDirectdebit., must be bigger than or equal to 3.');
        }
    ...
    public function setBranchName(mixed $branchName): static
    {
        ...
        if (mb_strlen($branchName) > 45) {
            throw new \InvalidArgumentException('invalid length for $branchName when calling PaymentMethodDirectdebit., must be smaller than or equal to 45.');
        }
        if (mb_strlen($branchName) < 1) {
            throw new \InvalidArgumentException('invalid length for $branchName when calling PaymentMethodDirectdebit., must be bigger than or equal to 1.');
        }
    ...
    public function setAccountType(mixed $accountType): static
    {
        ...
        if (!is_null($accountType) && mb_strlen($accountType) > 1) {
            throw new \InvalidArgumentException('invalid length for $accountType when calling PaymentMethodDirectdebit., must be smaller than or equal to 1.');
        }
        if (!is_null($accountType) && mb_strlen($accountType) < 1) {
            throw new \InvalidArgumentException('invalid length for $accountType when calling PaymentMethodDirectdebit., must be bigger than or equal to 1.');
        }
    ...
    public function setAccountNumber(mixed $accountNumber): static
    {
        ...
        if (!is_null($accountNumber) && mb_strlen($accountNumber) > 7) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling PaymentMethodDirectdebit., must be smaller than or equal to 7.');
        }
        if (!is_null($accountNumber) && mb_strlen($accountNumber) < 1) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling PaymentMethodDirectdebit., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalAccountNumber1(mixed $postalAccountNumber1): static
    {
        ...
        if (!is_null($postalAccountNumber1) && mb_strlen($postalAccountNumber1) > 5) {
            throw new \InvalidArgumentException('invalid length for $postalAccountNumber1 when calling PaymentMethodDirectdebit., must be smaller than or equal to 5.');
        }
        if (!is_null($postalAccountNumber1) && mb_strlen($postalAccountNumber1) < 1) {
            throw new \InvalidArgumentException('invalid length for $postalAccountNumber1 when calling PaymentMethodDirectdebit., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalAccountNumber2(mixed $postalAccountNumber2): static
    {
        ...
        if (!is_null($postalAccountNumber2) && mb_strlen($postalAccountNumber2) > 8) {
            throw new \InvalidArgumentException('invalid length for $postalAccountNumber2 when calling PaymentMethodDirectdebit., must be smaller than or equal to 8.');
        }
        if (!is_null($postalAccountNumber2) && mb_strlen($postalAccountNumber2) < 1) {
            throw new \InvalidArgumentException('invalid length for $postalAccountNumber2 when calling PaymentMethodDirectdebit., must be bigger than or equal to 1.');
        }
    ...
    public function setAccountName(mixed $accountName): static
    {
        ...
        if (!is_null($accountName) && mb_strlen($accountName) > 45) {
            throw new \InvalidArgumentException('invalid length for $accountName when calling PaymentMethodDirectdebit., must be smaller than or equal to 45.');
        }
        if (!is_null($accountName) && mb_strlen($accountName) < 1) {
            throw new \InvalidArgumentException('invalid length for $accountName when calling PaymentMethodDirectdebit., must be bigger than or equal to 1.');
        }
    ...
    public function setAccountNameKana(mixed $accountNameKana): static
    {
        ...
        if (!is_null($accountNameKana) && mb_strlen($accountNameKana) > 45) {
            throw new \InvalidArgumentException('invalid length for $accountNameKana when calling PaymentMethodDirectdebit., must be smaller than or equal to 45.');
        }
        if (!is_null($accountNameKana) && mb_strlen($accountNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $accountNameKana when calling PaymentMethodDirectdebit., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return DirectdebitPaperApplication|null
     */
     ...
     *
     * @param DirectdebitPaperApplication|null $paperApplication paperApplication
     */
