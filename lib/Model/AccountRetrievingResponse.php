 ...
 */
class AccountRetrievingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Account.Retrieving.Response';
    /**
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 32) {
            throw new \InvalidArgumentException('invalid length for $id when calling AccountRetrievingResponse., must be smaller than or equal to 32.');
        }
        if (mb_strlen($id) < 32) {
            throw new \InvalidArgumentException('invalid length for $id when calling AccountRetrievingResponse., must be bigger than or equal to 32.');
        }
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling AccountRetrievingResponse., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling AccountRetrievingResponse., must be bigger than or equal to 13.');
        }
