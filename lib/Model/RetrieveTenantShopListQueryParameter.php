 ...
 */
class RetrieveTenantShopListQueryParameter implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'retrieveTenantShopList_query_parameter';
    /**
    ...
    public function setId(mixed $id): static
    {
        ...
        if (!is_null($id) && mb_strlen($id) > 13) {
            throw new \InvalidArgumentException('invalid length for $id when calling RetrieveTenantShopListQueryParameter., must be smaller than or equal to 13.');
        }
        if (!is_null($id) && mb_strlen($id) < 13) {
            throw new \InvalidArgumentException('invalid length for $id when calling RetrieveTenantShopListQueryParameter., must be bigger than or equal to 13.');
        }
    ...
    public function setShopName(mixed $shopName): static
    {
        ...
        if (!is_null($shopName) && mb_strlen($shopName) > 20) {
            throw new \InvalidArgumentException('invalid length for $shopName when calling RetrieveTenantShopListQueryParameter., must be smaller than or equal to 20.');
        }
        if (!is_null($shopName) && mb_strlen($shopName) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopName when calling RetrieveTenantShopListQueryParameter., must be bigger than or equal to 1.');
        }
    ...
    public function setShopMailAddress(mixed $shopMailAddress): static
    {
        ...
        if (!is_null($shopMailAddress) && mb_strlen($shopMailAddress) > 255) {
            throw new \InvalidArgumentException('invalid length for $shopMailAddress when calling RetrieveTenantShopListQueryParameter., must be smaller than or equal to 255.');
        }
        if (!is_null($shopMailAddress) && mb_strlen($shopMailAddress) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopMailAddress when calling RetrieveTenantShopListQueryParameter., must be bigger than or equal to 1.');
        }
