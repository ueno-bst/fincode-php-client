...
class PlatformAccountRetrievingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 20) {
            throw new \InvalidArgumentException('invalid length for $id when calling PlatformAccountRetrievingResponse., must be smaller than or equal to 20.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling PlatformAccountRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PlatformAccountRetrievingResponse., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PlatformAccountRetrievingResponse., must be bigger than or equal to 13.');
        }
