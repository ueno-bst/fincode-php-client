 ...
 */
class PaymentPayPayCapturingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Payment.PayPay.Capturing.Response';
    /**
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 30) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 30.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 24.');
        }
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (!is_null($customerId) && mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 60.');
        }
        if (!is_null($customerId) && mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId(mixed $customerGroupId): static
    {
        ...
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) > 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 13.');
        }
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) < 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setErrorCode(mixed $errorCode): static
    {
        ...
        if (!is_null($errorCode) && mb_strlen($errorCode) > 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 11.');
        }
        if (!is_null($errorCode) && mb_strlen($errorCode) < 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 11.');
        }
    ...
    public function setCodeUrl(mixed $codeUrl): static
    {
        ...
        if (!is_null($codeUrl) && mb_strlen($codeUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $codeUrl when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 256.');
        }
        if (!is_null($codeUrl) && mb_strlen($codeUrl) < 1) {
            throw new \InvalidArgumentException('invalid length for $codeUrl when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setRedirectUrl(mixed $redirectUrl): static
    {
        ...
        if (!is_null($redirectUrl) && mb_strlen($redirectUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $redirectUrl when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 256.');
        }
        if (!is_null($redirectUrl) && mb_strlen($redirectUrl) < 1) {
            throw new \InvalidArgumentException('invalid length for $redirectUrl when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderDescription(mixed $orderDescription): static
    {
        ...
        if (!is_null($orderDescription) && mb_strlen($orderDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $orderDescription when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 100.');
        }
    ...
    public function setCaptureDescription(mixed $captureDescription): static
    {
        ...
        if (!is_null($captureDescription) && mb_strlen($captureDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $captureDescription when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 100.');
        }
    ...
    public function setUpdateDescription(mixed $updateDescription): static
    {
        ...
        if (!is_null($updateDescription) && mb_strlen($updateDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $updateDescription when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 100.');
        }
    ...
    public function setCancelDescription(mixed $cancelDescription): static
    {
        ...
        if (!is_null($cancelDescription) && mb_strlen($cancelDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $cancelDescription when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 100.');
        }
    ...
    public function setStoreId(mixed $storeId): static
    {
        ...
        if (!is_null($storeId) && mb_strlen($storeId) > 18) {
            throw new \InvalidArgumentException('invalid length for $storeId when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 18.');
        }
        if (!is_null($storeId) && mb_strlen($storeId) < 1) {
            throw new \InvalidArgumentException('invalid length for $storeId when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCodeId(mixed $codeId): static
    {
        ...
        if (!is_null($codeId) && mb_strlen($codeId) > 64) {
            throw new \InvalidArgumentException('invalid length for $codeId when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 64.');
        }
        if (!is_null($codeId) && mb_strlen($codeId) < 1) {
            throw new \InvalidArgumentException('invalid length for $codeId when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentId(mixed $paymentId): static
    {
        ...
        if (!is_null($paymentId) && mb_strlen($paymentId) > 64) {
            throw new \InvalidArgumentException('invalid length for $paymentId when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 64.');
        }
        if (!is_null($paymentId) && mb_strlen($paymentId) < 1) {
            throw new \InvalidArgumentException('invalid length for $paymentId when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setPaypayResultCode(mixed $paypayResultCode): static
    {
        ...
        if (!is_null($paypayResultCode) && mb_strlen($paypayResultCode) > 256) {
            throw new \InvalidArgumentException('invalid length for $paypayResultCode when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 256.');
        }
        if (!is_null($paypayResultCode) && mb_strlen($paypayResultCode) < 1) {
            throw new \InvalidArgumentException('invalid length for $paypayResultCode when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantPaymentId(mixed $merchantPaymentId): static
    {
        ...
        if (!is_null($merchantPaymentId) && mb_strlen($merchantPaymentId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantPaymentId when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantPaymentId) && mb_strlen($merchantPaymentId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantPaymentId when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantCaptureId(mixed $merchantCaptureId): static
    {
        ...
        if (!is_null($merchantCaptureId) && mb_strlen($merchantCaptureId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantCaptureId when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantCaptureId) && mb_strlen($merchantCaptureId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantCaptureId when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantUpdateId(mixed $merchantUpdateId): static
    {
        ...
        if (!is_null($merchantUpdateId) && mb_strlen($merchantUpdateId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantUpdateId when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantUpdateId) && mb_strlen($merchantUpdateId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantUpdateId when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantRevertId(mixed $merchantRevertId): static
    {
        ...
        if (!is_null($merchantRevertId) && mb_strlen($merchantRevertId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantRevertId when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantRevertId) && mb_strlen($merchantRevertId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantRevertId when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantRefundId(mixed $merchantRefundId): static
    {
        ...
        if (!is_null($merchantRefundId) && mb_strlen($merchantRefundId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantRefundId when calling PaymentPayPayCapturingResponse., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantRefundId) && mb_strlen($merchantRefundId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantRefundId when calling PaymentPayPayCapturingResponse., must be bigger than or equal to 1.');
        }
