 ...
 */
class POSTJoinTenants implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'POST.JoinTenants';
    /**
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 13) {
            throw new \InvalidArgumentException('invalid length for $id when calling POSTJoinTenants., must be smaller than or equal to 13.');
        }
        if (mb_strlen($id) < 13) {
            throw new \InvalidArgumentException('invalid length for $id when calling POSTJoinTenants., must be bigger than or equal to 13.');
        }
    ...
    public function setShopName(mixed $shopName): static
    {
        ...
        if (!is_null($shopName) && mb_strlen($shopName) > 20) {
            throw new \InvalidArgumentException('invalid length for $shopName when calling POSTJoinTenants., must be smaller than or equal to 20.');
        }
        if (!is_null($shopName) && mb_strlen($shopName) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopName when calling POSTJoinTenants., must be bigger than or equal to 1.');
        }
    ...
    public function setShopNameKana(mixed $shopNameKana): static
    {
        ...
        if (!is_null($shopNameKana) && mb_strlen($shopNameKana) > 40) {
            throw new \InvalidArgumentException('invalid length for $shopNameKana when calling POSTJoinTenants., must be smaller than or equal to 40.');
        }
        if (!is_null($shopNameKana) && mb_strlen($shopNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopNameKana when calling POSTJoinTenants., must be bigger than or equal to 1.');
        }
    ...
    public function setPlatformId(mixed $platformId): static
    {
        ...
        if (mb_strlen($platformId) > 13) {
            throw new \InvalidArgumentException('invalid length for $platformId when calling POSTJoinTenants., must be smaller than or equal to 13.');
        }
        if (mb_strlen($platformId) < 13) {
            throw new \InvalidArgumentException('invalid length for $platformId when calling POSTJoinTenants., must be bigger than or equal to 13.');
        }
    ...
    public function setPlatformName(mixed $platformName): static
    {
        ...
        if (!is_null($platformName) && mb_strlen($platformName) > 50) {
            throw new \InvalidArgumentException('invalid length for $platformName when calling POSTJoinTenants., must be smaller than or equal to 50.');
        }
        if (!is_null($platformName) && mb_strlen($platformName) < 1) {
            throw new \InvalidArgumentException('invalid length for $platformName when calling POSTJoinTenants., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId(mixed $customerGroupId): static
    {
        ...
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) > 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling POSTJoinTenants., must be smaller than or equal to 13.');
        }
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) < 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling POSTJoinTenants., must be bigger than or equal to 13.');
        }
    ...
    public function setSendMailAddress(mixed $sendMailAddress): static
    {
        ...
        if (!is_null($sendMailAddress) && mb_strlen($sendMailAddress) > 255) {
            throw new \InvalidArgumentException('invalid length for $sendMailAddress when calling POSTJoinTenants., must be smaller than or equal to 255.');
        }
        if (!is_null($sendMailAddress) && mb_strlen($sendMailAddress) < 1) {
            throw new \InvalidArgumentException('invalid length for $sendMailAddress when calling POSTJoinTenants., must be bigger than or equal to 1.');
        }
    ...
    public function setShopMailAddress(mixed $shopMailAddress): static
    {
        ...
        if (!is_null($shopMailAddress) && mb_strlen($shopMailAddress) > 255) {
            throw new \InvalidArgumentException('invalid length for $shopMailAddress when calling POSTJoinTenants., must be smaller than or equal to 255.');
        }
        if (!is_null($shopMailAddress) && mb_strlen($shopMailAddress) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopMailAddress when calling POSTJoinTenants., must be bigger than or equal to 1.');
        }
    ...
    public function setLogKeepDays(mixed $logKeepDays): static
    {
        ...
        if (!is_null($logKeepDays) && $logKeepDays > 9999) {
            throw new \InvalidArgumentException('invalid value for $logKeepDays when calling POSTJoinTenants., must be smaller than or equal to 9999.');
        }
        if (!is_null($logKeepDays) && $logKeepDays < 0) {
            throw new \InvalidArgumentException('invalid value for $logKeepDays when calling POSTJoinTenants., must be bigger than or equal to 0.');
        }
    ...
    public function setApiVersion(mixed $apiVersion): static
    {
        ...
        if (!is_null($apiVersion) && mb_strlen($apiVersion) > 8) {
            throw new \InvalidArgumentException('invalid length for $apiVersion when calling POSTJoinTenants., must be smaller than or equal to 8.');
        }
        if (!is_null($apiVersion) && mb_strlen($apiVersion) < 1) {
            throw new \InvalidArgumentException('invalid length for $apiVersion when calling POSTJoinTenants., must be bigger than or equal to 1.');
        }
