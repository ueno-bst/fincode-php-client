...
class PaymentMethod implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 25) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentMethod., must be smaller than or equal to 25.');
        }
        if (mb_strlen($id) < 25) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentMethod., must be bigger than or equal to 25.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling PaymentMethod., must be smaller than or equal to 60.');
        }
    ...
    public function setRedirectUrl(mixed $redirectUrl): static
    {
        ...
        if (!is_null($redirectUrl) && mb_strlen($redirectUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $redirectUrl when calling PaymentMethod., must be smaller than or equal to 256.');
        }
    ...
    public function setReturnUrl(mixed $returnUrl): static
    {
        ...
        if (!is_null($returnUrl) && mb_strlen($returnUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $returnUrl when calling PaymentMethod., must be smaller than or equal to 256.');
        }
    ...
    public function setReturnUrlOnFailure(mixed $returnUrlOnFailure): static
    {
        ...
        if (!is_null($returnUrlOnFailure) && mb_strlen($returnUrlOnFailure) > 256) {
            throw new \InvalidArgumentException('invalid length for $returnUrlOnFailure when calling PaymentMethod., must be smaller than or equal to 256.');
        }
    ...
    public function setDefaultFlag(mixed $defaultFlag): static
    {
        ...
        if (mb_strlen($defaultFlag) > 1) {
            throw new \InvalidArgumentException('invalid length for $defaultFlag when calling PaymentMethod., must be smaller than or equal to 1.');
        }
        if (mb_strlen($defaultFlag) < 1) {
            throw new \InvalidArgumentException('invalid length for $defaultFlag when calling PaymentMethod., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentMethod., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentMethod., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentMethod., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentMethod., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentMethod., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentMethod., must be bigger than or equal to 1.');
        }
