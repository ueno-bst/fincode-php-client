 ...
 */
class PaymentKonbiniCreatingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Payment.Konbini.Creating.Response';
    /**
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 30) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 30.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 24.');
        }
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (!is_null($customerId) && mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 60.');
        }
        if (!is_null($customerId) && mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId(mixed $customerGroupId): static
    {
        ...
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) > 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 13.');
        }
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) < 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setErrorCode(mixed $errorCode): static
    {
        ...
        if (!is_null($errorCode) && mb_strlen($errorCode) > 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 11.');
        }
        if (!is_null($errorCode) && mb_strlen($errorCode) < 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 11.');
        }
    ...
    public function setBarcodeWidth(mixed $barcodeWidth): static
    {
        ...
        if (!is_null($barcodeWidth) && mb_strlen($barcodeWidth) > 9) {
            throw new \InvalidArgumentException('invalid length for $barcodeWidth when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 9.');
        }
        if (!is_null($barcodeWidth) && mb_strlen($barcodeWidth) < 1) {
            throw new \InvalidArgumentException('invalid length for $barcodeWidth when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setBarcodeHeight(mixed $barcodeHeight): static
    {
        ...
        if (!is_null($barcodeHeight) && mb_strlen($barcodeHeight) > 9) {
            throw new \InvalidArgumentException('invalid length for $barcodeHeight when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 9.');
        }
        if (!is_null($barcodeHeight) && mb_strlen($barcodeHeight) < 1) {
            throw new \InvalidArgumentException('invalid length for $barcodeHeight when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setKonbiniStoreCode(mixed $konbiniStoreCode): static
    {
        ...
        if (!is_null($konbiniStoreCode) && mb_strlen($konbiniStoreCode) > 8) {
            throw new \InvalidArgumentException('invalid length for $konbiniStoreCode when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 8.');
        }
        if (!is_null($konbiniStoreCode) && mb_strlen($konbiniStoreCode) < 1) {
            throw new \InvalidArgumentException('invalid length for $konbiniStoreCode when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setDeviceName(mixed $deviceName): static
    {
        ...
        if (!is_null($deviceName) && mb_strlen($deviceName) > 20) {
            throw new \InvalidArgumentException('invalid length for $deviceName when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 20.');
        }
        if (!is_null($deviceName) && mb_strlen($deviceName) < 1) {
            throw new \InvalidArgumentException('invalid length for $deviceName when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setOsVersion(mixed $osVersion): static
    {
        ...
        if (!is_null($osVersion) && mb_strlen($osVersion) > 10) {
            throw new \InvalidArgumentException('invalid length for $osVersion when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 10.');
        }
        if (!is_null($osVersion) && mb_strlen($osVersion) < 1) {
            throw new \InvalidArgumentException('invalid length for $osVersion when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setWinWidth(mixed $winWidth): static
    {
        ...
        if (!is_null($winWidth) && mb_strlen($winWidth) > 5) {
            throw new \InvalidArgumentException('invalid length for $winWidth when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 5.');
        }
        if (!is_null($winWidth) && mb_strlen($winWidth) < 1) {
            throw new \InvalidArgumentException('invalid length for $winWidth when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setWinHeight(mixed $winHeight): static
    {
        ...
        if (!is_null($winHeight) && mb_strlen($winHeight) > 5) {
            throw new \InvalidArgumentException('invalid length for $winHeight when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 5.');
        }
        if (!is_null($winHeight) && mb_strlen($winHeight) < 1) {
            throw new \InvalidArgumentException('invalid length for $winHeight when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setXdpi(mixed $xdpi): static
    {
        ...
        if (!is_null($xdpi) && mb_strlen($xdpi) > 6) {
            throw new \InvalidArgumentException('invalid length for $xdpi when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 6.');
        }
        if (!is_null($xdpi) && mb_strlen($xdpi) < 1) {
            throw new \InvalidArgumentException('invalid length for $xdpi when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setYdpi(mixed $ydpi): static
    {
        ...
        if (!is_null($ydpi) && mb_strlen($ydpi) > 6) {
            throw new \InvalidArgumentException('invalid length for $ydpi when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 6.');
        }
        if (!is_null($ydpi) && mb_strlen($ydpi) < 1) {
            throw new \InvalidArgumentException('invalid length for $ydpi when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderSerial(mixed $orderSerial): static
    {
        ...
        if (!is_null($orderSerial) && mb_strlen($orderSerial) > 18) {
            throw new \InvalidArgumentException('invalid length for $orderSerial when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 18.');
        }
        if (!is_null($orderSerial) && mb_strlen($orderSerial) < 1) {
            throw new \InvalidArgumentException('invalid length for $orderSerial when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setInvoiceId(mixed $invoiceId): static
    {
        ...
        if (!is_null($invoiceId) && mb_strlen($invoiceId) > 20) {
            throw new \InvalidArgumentException('invalid length for $invoiceId when calling PaymentKonbiniCreatingResponse., must be smaller than or equal to 20.');
        }
        if (!is_null($invoiceId) && mb_strlen($invoiceId) < 1) {
            throw new \InvalidArgumentException('invalid length for $invoiceId when calling PaymentKonbiniCreatingResponse., must be bigger than or equal to 1.');
        }
