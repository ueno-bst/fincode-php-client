 ...
 */
class CancelPayment200Response implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'cancelPayment_200_response';
    /**
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling CancelPayment200Response., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling CancelPayment200Response., must be bigger than or equal to 13.');
        }
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 30) {
            throw new \InvalidArgumentException('invalid length for $id when calling CancelPayment200Response., must be smaller than or equal to 30.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling CancelPayment200Response., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling CancelPayment200Response., must be bigger than or equal to 24.');
        }
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling CancelPayment200Response., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling CancelPayment200Response., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling CancelPayment200Response., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (!is_null($customerId) && mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling CancelPayment200Response., must be smaller than or equal to 60.');
        }
        if (!is_null($customerId) && mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId(mixed $customerGroupId): static
    {
        ...
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) > 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling CancelPayment200Response., must be smaller than or equal to 13.');
        }
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) < 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling CancelPayment200Response., must be bigger than or equal to 13.');
        }
    ...
    public function setErrorCode(mixed $errorCode): static
    {
        ...
        if (!is_null($errorCode) && mb_strlen($errorCode) > 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling CancelPayment200Response., must be smaller than or equal to 11.');
        }
        if (!is_null($errorCode) && mb_strlen($errorCode) < 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling CancelPayment200Response., must be bigger than or equal to 11.');
        }
    ...
    public function setCardId(mixed $cardId): static
    {
        ...
        if (!is_null($cardId) && mb_strlen($cardId) > 25) {
            throw new \InvalidArgumentException('invalid length for $cardId when calling CancelPayment200Response., must be smaller than or equal to 25.');
        }
        if (!is_null($cardId) && mb_strlen($cardId) < 25) {
            throw new \InvalidArgumentException('invalid length for $cardId when calling CancelPayment200Response., must be bigger than or equal to 25.');
        }
    ...
    public function setCardNo(mixed $cardNo): static
    {
        ...
        if (!is_null($cardNo) && mb_strlen($cardNo) > 16) {
            throw new \InvalidArgumentException('invalid length for $cardNo when calling CancelPayment200Response., must be smaller than or equal to 16.');
        }
    ...
    public function setExpire(mixed $expire): static
    {
        ...
        if (!is_null($expire) && mb_strlen($expire) > 4) {
            throw new \InvalidArgumentException('invalid length for $expire when calling CancelPayment200Response., must be smaller than or equal to 4.');
        }
        if (!is_null($expire) && mb_strlen($expire) < 4) {
            throw new \InvalidArgumentException('invalid length for $expire when calling CancelPayment200Response., must be bigger than or equal to 4.');
        }
        if (!is_null($expire) && is_string($expire) && !preg_match('/^\\d{2}\\d{2}$/', $expire)) {
            throw new \InvalidArgumentException('invalid value for $expire when calling CancelPayment200Response., must conform to the pattern /^\\d{2}\\d{2}$/.');
        }
    ...
    public function setHolderName(mixed $holderName): static
    {
        ...
        if (!is_null($holderName) && mb_strlen($holderName) > 50) {
            throw new \InvalidArgumentException('invalid length for $holderName when calling CancelPayment200Response., must be smaller than or equal to 50.');
        }
        if (!is_null($holderName) && mb_strlen($holderName) < 1) {
            throw new \InvalidArgumentException('invalid length for $holderName when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setCardNoHash(mixed $cardNoHash): static
    {
        ...
        if (!is_null($cardNoHash) && mb_strlen($cardNoHash) > 64) {
            throw new \InvalidArgumentException('invalid length for $cardNoHash when calling CancelPayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($cardNoHash) && mb_strlen($cardNoHash) < 1) {
            throw new \InvalidArgumentException('invalid length for $cardNoHash when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setBulkPaymentId(mixed $bulkPaymentId): static
    {
        ...
        if (!is_null($bulkPaymentId) && mb_strlen($bulkPaymentId) > 25) {
            throw new \InvalidArgumentException('invalid length for $bulkPaymentId when calling CancelPayment200Response., must be smaller than or equal to 25.');
        }
        if (!is_null($bulkPaymentId) && mb_strlen($bulkPaymentId) < 25) {
            throw new \InvalidArgumentException('invalid length for $bulkPaymentId when calling CancelPayment200Response., must be bigger than or equal to 25.');
        }
    ...
    public function setSubscriptionId(mixed $subscriptionId): static
    {
        ...
        if (!is_null($subscriptionId) && mb_strlen($subscriptionId) > 25) {
            throw new \InvalidArgumentException('invalid length for $subscriptionId when calling CancelPayment200Response., must be smaller than or equal to 25.');
        }
        if (!is_null($subscriptionId) && mb_strlen($subscriptionId) < 1) {
            throw new \InvalidArgumentException('invalid length for $subscriptionId when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2RetUrl(mixed $tds2RetUrl): static
    {
        ...
        if (!is_null($tds2RetUrl) && mb_strlen($tds2RetUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $tds2RetUrl when calling CancelPayment200Response., must be smaller than or equal to 256.');
        }
    ...
    public function setReturnUrl(mixed $returnUrl): static
    {
        ...
        if (!is_null($returnUrl) && mb_strlen($returnUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $returnUrl when calling CancelPayment200Response., must be smaller than or equal to 256.');
        }
    ...
    public function setReturnUrlOnFailure(mixed $returnUrlOnFailure): static
    {
        ...
        if (!is_null($returnUrlOnFailure) && mb_strlen($returnUrlOnFailure) > 256) {
            throw new \InvalidArgumentException('invalid length for $returnUrlOnFailure when calling CancelPayment200Response., must be smaller than or equal to 256.');
        }
    ...
    public function setMerchantName(mixed $merchantName): static
    {
        ...
        if (!is_null($merchantName) && mb_strlen($merchantName) > 25) {
            throw new \InvalidArgumentException('invalid length for $merchantName when calling CancelPayment200Response., must be smaller than or equal to 25.');
        }
    ...
    public function setForward(mixed $forward): static
    {
        ...
        if (!is_null($forward) && mb_strlen($forward) > 7) {
            throw new \InvalidArgumentException('invalid length for $forward when calling CancelPayment200Response., must be smaller than or equal to 7.');
        }
        if (!is_null($forward) && mb_strlen($forward) < 1) {
            throw new \InvalidArgumentException('invalid length for $forward when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setIssuer(mixed $issuer): static
    {
        ...
        if (!is_null($issuer) && mb_strlen($issuer) > 7) {
            throw new \InvalidArgumentException('invalid length for $issuer when calling CancelPayment200Response., must be smaller than or equal to 7.');
        }
        if (!is_null($issuer) && mb_strlen($issuer) < 1) {
            throw new \InvalidArgumentException('invalid length for $issuer when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setTransactionId(mixed $transactionId): static
    {
        ...
        if (!is_null($transactionId) && mb_strlen($transactionId) > 28) {
            throw new \InvalidArgumentException('invalid length for $transactionId when calling CancelPayment200Response., must be smaller than or equal to 28.');
        }
        if (!is_null($transactionId) && mb_strlen($transactionId) < 28) {
            throw new \InvalidArgumentException('invalid length for $transactionId when calling CancelPayment200Response., must be bigger than or equal to 28.');
        }
    ...
    public function setApprove(mixed $approve): static
    {
        ...
        if (!is_null($approve) && mb_strlen($approve) > 7) {
            throw new \InvalidArgumentException('invalid length for $approve when calling CancelPayment200Response., must be smaller than or equal to 7.');
        }
        if (!is_null($approve) && mb_strlen($approve) < 1) {
            throw new \InvalidArgumentException('invalid length for $approve when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setItemCode(mixed $itemCode): static
    {
        ...
        if (!is_null($itemCode) && mb_strlen($itemCode) > 7) {
            throw new \InvalidArgumentException('invalid length for $itemCode when calling CancelPayment200Response., must be smaller than or equal to 7.');
        }
        if (!is_null($itemCode) && mb_strlen($itemCode) < 7) {
            throw new \InvalidArgumentException('invalid length for $itemCode when calling CancelPayment200Response., must be bigger than or equal to 7.');
        }
    ...
    public function setAcs(mixed $acs): static
    {
        ...
        if (!is_null($acs) && mb_strlen($acs) > 1) {
            throw new \InvalidArgumentException('invalid length for $acs when calling CancelPayment200Response., must be smaller than or equal to 1.');
        }
        if (!is_null($acs) && mb_strlen($acs) < 1) {
            throw new \InvalidArgumentException('invalid length for $acs when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setBarcodeWidth(mixed $barcodeWidth): static
    {
        ...
        if (!is_null($barcodeWidth) && mb_strlen($barcodeWidth) > 9) {
            throw new \InvalidArgumentException('invalid length for $barcodeWidth when calling CancelPayment200Response., must be smaller than or equal to 9.');
        }
        if (!is_null($barcodeWidth) && mb_strlen($barcodeWidth) < 1) {
            throw new \InvalidArgumentException('invalid length for $barcodeWidth when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setBarcodeHeight(mixed $barcodeHeight): static
    {
        ...
        if (!is_null($barcodeHeight) && mb_strlen($barcodeHeight) > 9) {
            throw new \InvalidArgumentException('invalid length for $barcodeHeight when calling CancelPayment200Response., must be smaller than or equal to 9.');
        }
        if (!is_null($barcodeHeight) && mb_strlen($barcodeHeight) < 1) {
            throw new \InvalidArgumentException('invalid length for $barcodeHeight when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setKonbiniStoreCode(mixed $konbiniStoreCode): static
    {
        ...
        if (!is_null($konbiniStoreCode) && mb_strlen($konbiniStoreCode) > 8) {
            throw new \InvalidArgumentException('invalid length for $konbiniStoreCode when calling CancelPayment200Response., must be smaller than or equal to 8.');
        }
        if (!is_null($konbiniStoreCode) && mb_strlen($konbiniStoreCode) < 1) {
            throw new \InvalidArgumentException('invalid length for $konbiniStoreCode when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setDeviceName(mixed $deviceName): static
    {
        ...
        if (!is_null($deviceName) && mb_strlen($deviceName) > 20) {
            throw new \InvalidArgumentException('invalid length for $deviceName when calling CancelPayment200Response., must be smaller than or equal to 20.');
        }
        if (!is_null($deviceName) && mb_strlen($deviceName) < 1) {
            throw new \InvalidArgumentException('invalid length for $deviceName when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setOsVersion(mixed $osVersion): static
    {
        ...
        if (!is_null($osVersion) && mb_strlen($osVersion) > 10) {
            throw new \InvalidArgumentException('invalid length for $osVersion when calling CancelPayment200Response., must be smaller than or equal to 10.');
        }
        if (!is_null($osVersion) && mb_strlen($osVersion) < 1) {
            throw new \InvalidArgumentException('invalid length for $osVersion when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setWinWidth(mixed $winWidth): static
    {
        ...
        if (!is_null($winWidth) && mb_strlen($winWidth) > 5) {
            throw new \InvalidArgumentException('invalid length for $winWidth when calling CancelPayment200Response., must be smaller than or equal to 5.');
        }
        if (!is_null($winWidth) && mb_strlen($winWidth) < 1) {
            throw new \InvalidArgumentException('invalid length for $winWidth when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setWinHeight(mixed $winHeight): static
    {
        ...
        if (!is_null($winHeight) && mb_strlen($winHeight) > 5) {
            throw new \InvalidArgumentException('invalid length for $winHeight when calling CancelPayment200Response., must be smaller than or equal to 5.');
        }
        if (!is_null($winHeight) && mb_strlen($winHeight) < 1) {
            throw new \InvalidArgumentException('invalid length for $winHeight when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setXdpi(mixed $xdpi): static
    {
        ...
        if (!is_null($xdpi) && mb_strlen($xdpi) > 6) {
            throw new \InvalidArgumentException('invalid length for $xdpi when calling CancelPayment200Response., must be smaller than or equal to 6.');
        }
        if (!is_null($xdpi) && mb_strlen($xdpi) < 1) {
            throw new \InvalidArgumentException('invalid length for $xdpi when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setYdpi(mixed $ydpi): static
    {
        ...
        if (!is_null($ydpi) && mb_strlen($ydpi) > 6) {
            throw new \InvalidArgumentException('invalid length for $ydpi when calling CancelPayment200Response., must be smaller than or equal to 6.');
        }
        if (!is_null($ydpi) && mb_strlen($ydpi) < 1) {
            throw new \InvalidArgumentException('invalid length for $ydpi when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderSerial(mixed $orderSerial): static
    {
        ...
        if (!is_null($orderSerial) && mb_strlen($orderSerial) > 18) {
            throw new \InvalidArgumentException('invalid length for $orderSerial when calling CancelPayment200Response., must be smaller than or equal to 18.');
        }
        if (!is_null($orderSerial) && mb_strlen($orderSerial) < 1) {
            throw new \InvalidArgumentException('invalid length for $orderSerial when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setInvoiceId(mixed $invoiceId): static
    {
        ...
        if (!is_null($invoiceId) && mb_strlen($invoiceId) > 20) {
            throw new \InvalidArgumentException('invalid length for $invoiceId when calling CancelPayment200Response., must be smaller than or equal to 20.');
        }
        if (!is_null($invoiceId) && mb_strlen($invoiceId) < 1) {
            throw new \InvalidArgumentException('invalid length for $invoiceId when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setCodeUrl(mixed $codeUrl): static
    {
        ...
        if (!is_null($codeUrl) && mb_strlen($codeUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $codeUrl when calling CancelPayment200Response., must be smaller than or equal to 256.');
        }
        if (!is_null($codeUrl) && mb_strlen($codeUrl) < 1) {
            throw new \InvalidArgumentException('invalid length for $codeUrl when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setRedirectUrl(mixed $redirectUrl): static
    {
        ...
        if (!is_null($redirectUrl) && mb_strlen($redirectUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $redirectUrl when calling CancelPayment200Response., must be smaller than or equal to 256.');
        }
        if (!is_null($redirectUrl) && mb_strlen($redirectUrl) < 1) {
            throw new \InvalidArgumentException('invalid length for $redirectUrl when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderDescription(mixed $orderDescription): static
    {
        ...
        if (!is_null($orderDescription) && mb_strlen($orderDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $orderDescription when calling CancelPayment200Response., must be smaller than or equal to 100.');
        }
    ...
    public function setCaptureDescription(mixed $captureDescription): static
    {
        ...
        if (!is_null($captureDescription) && mb_strlen($captureDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $captureDescription when calling CancelPayment200Response., must be smaller than or equal to 100.');
        }
    ...
    public function setUpdateDescription(mixed $updateDescription): static
    {
        ...
        if (!is_null($updateDescription) && mb_strlen($updateDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $updateDescription when calling CancelPayment200Response., must be smaller than or equal to 100.');
        }
    ...
    public function setCancelDescription(mixed $cancelDescription): static
    {
        ...
        if (!is_null($cancelDescription) && mb_strlen($cancelDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $cancelDescription when calling CancelPayment200Response., must be smaller than or equal to 100.');
        }
    ...
    public function setStoreId(mixed $storeId): static
    {
        ...
        if (!is_null($storeId) && mb_strlen($storeId) > 18) {
            throw new \InvalidArgumentException('invalid length for $storeId when calling CancelPayment200Response., must be smaller than or equal to 18.');
        }
        if (!is_null($storeId) && mb_strlen($storeId) < 1) {
            throw new \InvalidArgumentException('invalid length for $storeId when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setCodeId(mixed $codeId): static
    {
        ...
        if (!is_null($codeId) && mb_strlen($codeId) > 64) {
            throw new \InvalidArgumentException('invalid length for $codeId when calling CancelPayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($codeId) && mb_strlen($codeId) < 1) {
            throw new \InvalidArgumentException('invalid length for $codeId when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentId(mixed $paymentId): static
    {
        ...
        if (!is_null($paymentId) && mb_strlen($paymentId) > 64) {
            throw new \InvalidArgumentException('invalid length for $paymentId when calling CancelPayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($paymentId) && mb_strlen($paymentId) < 1) {
            throw new \InvalidArgumentException('invalid length for $paymentId when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setPaypayResultCode(mixed $paypayResultCode): static
    {
        ...
        if (!is_null($paypayResultCode) && mb_strlen($paypayResultCode) > 256) {
            throw new \InvalidArgumentException('invalid length for $paypayResultCode when calling CancelPayment200Response., must be smaller than or equal to 256.');
        }
        if (!is_null($paypayResultCode) && mb_strlen($paypayResultCode) < 1) {
            throw new \InvalidArgumentException('invalid length for $paypayResultCode when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantPaymentId(mixed $merchantPaymentId): static
    {
        ...
        if (!is_null($merchantPaymentId) && mb_strlen($merchantPaymentId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantPaymentId when calling CancelPayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantPaymentId) && mb_strlen($merchantPaymentId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantPaymentId when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantCaptureId(mixed $merchantCaptureId): static
    {
        ...
        if (!is_null($merchantCaptureId) && mb_strlen($merchantCaptureId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantCaptureId when calling CancelPayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantCaptureId) && mb_strlen($merchantCaptureId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantCaptureId when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantUpdateId(mixed $merchantUpdateId): static
    {
        ...
        if (!is_null($merchantUpdateId) && mb_strlen($merchantUpdateId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantUpdateId when calling CancelPayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantUpdateId) && mb_strlen($merchantUpdateId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantUpdateId when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantRevertId(mixed $merchantRevertId): static
    {
        ...
        if (!is_null($merchantRevertId) && mb_strlen($merchantRevertId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantRevertId when calling CancelPayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantRevertId) && mb_strlen($merchantRevertId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantRevertId when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantRefundId(mixed $merchantRefundId): static
    {
        ...
        if (!is_null($merchantRefundId) && mb_strlen($merchantRefundId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantRefundId when calling CancelPayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantRefundId) && mb_strlen($merchantRefundId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantRefundId when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentMethodId(mixed $paymentMethodId): static
    {
        ...
        if (mb_strlen($paymentMethodId) > 25) {
            throw new \InvalidArgumentException('invalid length for $paymentMethodId when calling CancelPayment200Response., must be smaller than or equal to 25.');
        }
        if (mb_strlen($paymentMethodId) < 25) {
            throw new \InvalidArgumentException('invalid length for $paymentMethodId when calling CancelPayment200Response., must be bigger than or equal to 25.');
        }
    ...
    public function setBankCode(mixed $bankCode): static
    {
        ...
        if (!is_null($bankCode) && mb_strlen($bankCode) > 4) {
            throw new \InvalidArgumentException('invalid length for $bankCode when calling CancelPayment200Response., must be smaller than or equal to 4.');
        }
        if (!is_null($bankCode) && mb_strlen($bankCode) < 4) {
            throw new \InvalidArgumentException('invalid length for $bankCode when calling CancelPayment200Response., must be bigger than or equal to 4.');
        }
    ...
    public function setBankName(mixed $bankName): static
    {
        ...
        if (!is_null($bankName) && mb_strlen($bankName) > 45) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling CancelPayment200Response., must be smaller than or equal to 45.');
        }
        if (!is_null($bankName) && mb_strlen($bankName) < 1) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setBranchCode(mixed $branchCode): static
    {
        ...
        if (!is_null($branchCode) && mb_strlen($branchCode) > 3) {
            throw new \InvalidArgumentException('invalid length for $branchCode when calling CancelPayment200Response., must be smaller than or equal to 3.');
        }
        if (!is_null($branchCode) && mb_strlen($branchCode) < 3) {
            throw new \InvalidArgumentException('invalid length for $branchCode when calling CancelPayment200Response., must be bigger than or equal to 3.');
        }
    ...
    public function setBranchName(mixed $branchName): static
    {
        ...
        if (!is_null($branchName) && mb_strlen($branchName) > 45) {
            throw new \InvalidArgumentException('invalid length for $branchName when calling CancelPayment200Response., must be smaller than or equal to 45.');
        }
        if (!is_null($branchName) && mb_strlen($branchName) < 1) {
            throw new \InvalidArgumentException('invalid length for $branchName when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setRemarks(mixed $remarks): static
    {
        ...
        if (!is_null($remarks) && mb_strlen($remarks) > 9) {
            throw new \InvalidArgumentException('invalid length for $remarks when calling CancelPayment200Response., must be smaller than or equal to 9.');
        }
        if (!is_null($remarks) && mb_strlen($remarks) < 1) {
            throw new \InvalidArgumentException('invalid length for $remarks when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setVaBranchCode(mixed $vaBranchCode): static
    {
        ...
        if (!is_null($vaBranchCode) && mb_strlen($vaBranchCode) > 3) {
            throw new \InvalidArgumentException('invalid length for $vaBranchCode when calling CancelPayment200Response., must be smaller than or equal to 3.');
        }
        if (!is_null($vaBranchCode) && mb_strlen($vaBranchCode) < 1) {
            throw new \InvalidArgumentException('invalid length for $vaBranchCode when calling CancelPayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setVaBranchName(mixed $vaBranchName): static
    {
        ...
        if (!is_null($vaBranchName) && mb_strlen($vaBranchName) > 15) {
            throw new \InvalidArgumentException('invalid length for $vaBranchName when calling CancelPayment200Response., must be smaller than or equal to 15.');
        }
    ...
    public function setVaAccountNumber(mixed $vaAccountNumber): static
    {
        ...
        if (!is_null($vaAccountNumber) && mb_strlen($vaAccountNumber) > 7) {
            throw new \InvalidArgumentException('invalid length for $vaAccountNumber when calling CancelPayment200Response., must be smaller than or equal to 7.');
        }
        if (!is_null($vaAccountNumber) && mb_strlen($vaAccountNumber) < 7) {
            throw new \InvalidArgumentException('invalid length for $vaAccountNumber when calling CancelPayment200Response., must be bigger than or equal to 7.');
        }
    ...
    public function setVaAccountName(mixed $vaAccountName): static
    {
        ...
        if (!is_null($vaAccountName) && mb_strlen($vaAccountName) > 40) {
            throw new \InvalidArgumentException('invalid length for $vaAccountName when calling CancelPayment200Response., must be smaller than or equal to 40.');
        }
    ...
    public function setVirtualAccountId(mixed $virtualAccountId): static
    {
        ...
        if (!is_null($virtualAccountId) && mb_strlen($virtualAccountId) > 10) {
            throw new \InvalidArgumentException('invalid length for $virtualAccountId when calling CancelPayment200Response., must be smaller than or equal to 10.');
        }
        if (!is_null($virtualAccountId) && mb_strlen($virtualAccountId) < 10) {
            throw new \InvalidArgumentException('invalid length for $virtualAccountId when calling CancelPayment200Response., must be bigger than or equal to 10.');
        }
    ...
    public function setRemitterAccountName(mixed $remitterAccountName): static
    {
        ...
        if (!is_null($remitterAccountName) && mb_strlen($remitterAccountName) > 48) {
            throw new \InvalidArgumentException('invalid length for $remitterAccountName when calling CancelPayment200Response., must be smaller than or equal to 48.');
        }
    ...
    public function setRemitterBankName(mixed $remitterBankName): static
    {
        ...
        if (!is_null($remitterBankName) && mb_strlen($remitterBankName) > 30) {
            throw new \InvalidArgumentException('invalid length for $remitterBankName when calling CancelPayment200Response., must be smaller than or equal to 30.');
        }
    ...
    public function setRemitterBranchName(mixed $remitterBranchName): static
    {
        ...
        if (!is_null($remitterBranchName) && mb_strlen($remitterBranchName) > 15) {
            throw new \InvalidArgumentException('invalid length for $remitterBranchName when calling CancelPayment200Response., must be smaller than or equal to 15.');
        }
