 ...
 */
class SubscriptionRetrievingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Subscription.Retrieving.Response';
    /**
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 25) {
            throw new \InvalidArgumentException('invalid length for $id when calling SubscriptionRetrievingResponse., must be smaller than or equal to 25.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling SubscriptionRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling SubscriptionRetrievingResponse., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling SubscriptionRetrievingResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setPlanId(mixed $planId): static
    {
        ...
        if (mb_strlen($planId) > 25) {
            throw new \InvalidArgumentException('invalid length for $planId when calling SubscriptionRetrievingResponse., must be smaller than or equal to 25.');
        }
        if (mb_strlen($planId) < 1) {
            throw new \InvalidArgumentException('invalid length for $planId when calling SubscriptionRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setPlanName(mixed $planName): static
    {
        ...
        if (!is_null($planName) && mb_strlen($planName) > 200) {
            throw new \InvalidArgumentException('invalid length for $planName when calling SubscriptionRetrievingResponse., must be smaller than or equal to 200.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling SubscriptionRetrievingResponse., must be smaller than or equal to 60.');
        }
        if (mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling SubscriptionRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCardId(mixed $cardId): static
    {
        ...
        if (mb_strlen($cardId) > 25) {
            throw new \InvalidArgumentException('invalid length for $cardId when calling SubscriptionRetrievingResponse., must be smaller than or equal to 25.');
        }
        if (mb_strlen($cardId) < 25) {
            throw new \InvalidArgumentException('invalid length for $cardId when calling SubscriptionRetrievingResponse., must be bigger than or equal to 25.');
        }
    ...
    public function setPaymentMethodId(mixed $paymentMethodId): static
    {
        ...
        if (mb_strlen($paymentMethodId) > 25) {
            throw new \InvalidArgumentException('invalid length for $paymentMethodId when calling SubscriptionRetrievingResponse., must be smaller than or equal to 25.');
        }
        if (mb_strlen($paymentMethodId) < 25) {
            throw new \InvalidArgumentException('invalid length for $paymentMethodId when calling SubscriptionRetrievingResponse., must be bigger than or equal to 25.');
        }
    ...
    public function setErrorCode(mixed $errorCode): static
    {
        ...
        if (!is_null($errorCode) && mb_strlen($errorCode) > 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling SubscriptionRetrievingResponse., must be smaller than or equal to 11.');
        }
        if (!is_null($errorCode) && mb_strlen($errorCode) < 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling SubscriptionRetrievingResponse., must be bigger than or equal to 11.');
        }
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling SubscriptionRetrievingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling SubscriptionRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling SubscriptionRetrievingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling SubscriptionRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling SubscriptionRetrievingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling SubscriptionRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setRemarks(mixed $remarks): static
    {
        ...
        if (!is_null($remarks) && mb_strlen($remarks) > 9) {
            throw new \InvalidArgumentException('invalid length for $remarks when calling SubscriptionRetrievingResponse., must be smaller than or equal to 9.');
        }
        if (!is_null($remarks) && mb_strlen($remarks) < 1) {
            throw new \InvalidArgumentException('invalid length for $remarks when calling SubscriptionRetrievingResponse., must be bigger than or equal to 1.');
        }
