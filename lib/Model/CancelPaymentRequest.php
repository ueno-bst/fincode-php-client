...
class CancelPaymentRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'cancelPayment_request';
    /**
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling CancelPaymentRequest., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling CancelPaymentRequest., must be bigger than or equal to 24.');
        }
    ...
    public function setCancelDescription(mixed $cancelDescription): static
    {
        ...
        if (!is_null($cancelDescription) && mb_strlen($cancelDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $cancelDescription when calling CancelPaymentRequest., must be smaller than or equal to 100.');
        }
