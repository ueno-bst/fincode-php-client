 ...
 */
class PaymentApplePayCapturingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Payment.ApplePay.Capturing.Response';
    /**
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 30) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 30.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 24.');
        }
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (!is_null($customerId) && mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 60.');
        }
        if (!is_null($customerId) && mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId(mixed $customerGroupId): static
    {
        ...
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) > 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 13.');
        }
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) < 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 13.');
        }
    ...
    public function setErrorCode(mixed $errorCode): static
    {
        ...
        if (!is_null($errorCode) && mb_strlen($errorCode) > 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 11.');
        }
        if (!is_null($errorCode) && mb_strlen($errorCode) < 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 11.');
        }
    ...
    public function setCardNo(mixed $cardNo): static
    {
        ...
        if (!is_null($cardNo) && mb_strlen($cardNo) > 16) {
            throw new \InvalidArgumentException('invalid length for $cardNo when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 16.');
        }
    ...
    public function setExpire(mixed $expire): static
    {
        ...
        if (!is_null($expire) && mb_strlen($expire) > 4) {
            throw new \InvalidArgumentException('invalid length for $expire when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 4.');
        }
        if (!is_null($expire) && mb_strlen($expire) < 4) {
            throw new \InvalidArgumentException('invalid length for $expire when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 4.');
        }
        if (!is_null($expire) && is_string($expire) && !preg_match('/^\\d{2}\\d{2}$/', $expire)) {
            throw new \InvalidArgumentException('invalid value for $expire when calling PaymentApplePayCapturingResponse., must conform to the pattern /^\\d{2}\\d{2}$/.');
        }
    ...
    public function setHolderName(mixed $holderName): static
    {
        ...
        if (!is_null($holderName) && mb_strlen($holderName) > 50) {
            throw new \InvalidArgumentException('invalid length for $holderName when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 50.');
        }
        if (!is_null($holderName) && mb_strlen($holderName) < 1) {
            throw new \InvalidArgumentException('invalid length for $holderName when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCardNoHash(mixed $cardNoHash): static
    {
        ...
        if (!is_null($cardNoHash) && mb_strlen($cardNoHash) > 64) {
            throw new \InvalidArgumentException('invalid length for $cardNoHash when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 64.');
        }
        if (!is_null($cardNoHash) && mb_strlen($cardNoHash) < 1) {
            throw new \InvalidArgumentException('invalid length for $cardNoHash when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setForward(mixed $forward): static
    {
        ...
        if (!is_null($forward) && mb_strlen($forward) > 7) {
            throw new \InvalidArgumentException('invalid length for $forward when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 7.');
        }
        if (!is_null($forward) && mb_strlen($forward) < 1) {
            throw new \InvalidArgumentException('invalid length for $forward when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setIssuer(mixed $issuer): static
    {
        ...
        if (!is_null($issuer) && mb_strlen($issuer) > 7) {
            throw new \InvalidArgumentException('invalid length for $issuer when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 7.');
        }
        if (!is_null($issuer) && mb_strlen($issuer) < 1) {
            throw new \InvalidArgumentException('invalid length for $issuer when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setTransactionId(mixed $transactionId): static
    {
        ...
        if (!is_null($transactionId) && mb_strlen($transactionId) > 28) {
            throw new \InvalidArgumentException('invalid length for $transactionId when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 28.');
        }
        if (!is_null($transactionId) && mb_strlen($transactionId) < 28) {
            throw new \InvalidArgumentException('invalid length for $transactionId when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 28.');
        }
    ...
    public function setApprove(mixed $approve): static
    {
        ...
        if (!is_null($approve) && mb_strlen($approve) > 7) {
            throw new \InvalidArgumentException('invalid length for $approve when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 7.');
        }
        if (!is_null($approve) && mb_strlen($approve) < 1) {
            throw new \InvalidArgumentException('invalid length for $approve when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setItemCode(mixed $itemCode): static
    {
        ...
        if (!is_null($itemCode) && mb_strlen($itemCode) > 7) {
            throw new \InvalidArgumentException('invalid length for $itemCode when calling PaymentApplePayCapturingResponse., must be smaller than or equal to 7.');
        }
        if (!is_null($itemCode) && mb_strlen($itemCode) < 7) {
            throw new \InvalidArgumentException('invalid length for $itemCode when calling PaymentApplePayCapturingResponse., must be bigger than or equal to 7.');
        }
