 ...
 */
class PaymentPayPayCreatingRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Payment.PayPay.Creating.Request';
    /**
     ...
     */
    protected static array $openAPIFormats = ['id' => null, 'payType' => null, 'jobCode' => null, 'amount' => null, 'tax' => null, 'clientField1' => null, 'clientField2' => null, 'clientField3' => null, 'orderDescription' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['id' => false, 'payType' => false, 'jobCode' => false, 'amount' => false, 'tax' => true, 'clientField1' => true, 'clientField2' => true, 'clientField3' => true, 'orderDescription' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['id' => 'id', 'payType' => 'pay_type', 'jobCode' => 'job_code', 'amount' => 'amount', 'tax' => 'tax', 'clientField1' => 'client_field_1', 'clientField2' => 'client_field_2', 'clientField3' => 'client_field_3', 'orderDescription' => 'order_description'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['id' => 'setId', 'payType' => 'setPayType', 'jobCode' => 'setJobCode', 'amount' => 'setAmount', 'tax' => 'setTax', 'clientField1' => 'setClientField1', 'clientField2' => 'setClientField2', 'clientField3' => 'setClientField3', 'orderDescription' => 'setOrderDescription'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['id' => 'getId', 'payType' => 'getPayType', 'jobCode' => 'getJobCode', 'amount' => 'getAmount', 'tax' => 'getTax', 'clientField1' => 'getClientField1', 'clientField2' => 'getClientField2', 'clientField3' => 'getClientField3', 'orderDescription' => 'getOrderDescription'];
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 30) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentPayPayCreatingRequest., must be smaller than or equal to 30.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentPayPayCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAmount(mixed $amount): static
    {
        ...
        if (mb_strlen($amount) > 9) {
            throw new \InvalidArgumentException('invalid length for $amount when calling PaymentPayPayCreatingRequest., must be smaller than or equal to 9.');
        }
        if (mb_strlen($amount) < 1) {
            throw new \InvalidArgumentException('invalid length for $amount when calling PaymentPayPayCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTax(mixed $tax): static
    {
        ...
        if (!is_null($tax) && mb_strlen($tax) > 9) {
            throw new \InvalidArgumentException('invalid length for $tax when calling PaymentPayPayCreatingRequest., must be smaller than or equal to 9.');
        }
        if (!is_null($tax) && mb_strlen($tax) < 1) {
            throw new \InvalidArgumentException('invalid length for $tax when calling PaymentPayPayCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentPayPayCreatingRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling PaymentPayPayCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentPayPayCreatingRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling PaymentPayPayCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentPayPayCreatingRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling PaymentPayPayCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderDescription(mixed $orderDescription): static
    {
        ...
        if (!is_null($orderDescription) && mb_strlen($orderDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $orderDescription when calling PaymentPayPayCreatingRequest., must be smaller than or equal to 100.');
        }
