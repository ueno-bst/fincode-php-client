 ...
 */
class ApplePay implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Apple_Pay';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['payType' => '\Fincode\OpenAPI\Model\PayType', 'keyword' => 'string', 'totalAmountMin' => 'int', 'totalAmountMax' => 'int', 'customerId' => 'string', 'processDateFrom' => 'string', 'processDateTo' => 'string', 'status' => '\Fincode\OpenAPI\Model\PaymentStatus', 'authMaxDateFrom' => 'string', 'authMaxDateTo' => 'string', 'updatedFrom' => 'string', 'updatedTo' => 'string', 'sort' => 'string', 'page' => 'int', 'limit' => 'int', 'countOnly' => 'bool'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['payType' => null, 'keyword' => null, 'totalAmountMin' => 'int64', 'totalAmountMax' => 'int64', 'customerId' => null, 'processDateFrom' => null, 'processDateTo' => null, 'status' => null, 'authMaxDateFrom' => null, 'authMaxDateTo' => null, 'updatedFrom' => null, 'updatedTo' => null, 'sort' => null, 'page' => null, 'limit' => null, 'countOnly' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['payType' => false, 'keyword' => true, 'totalAmountMin' => false, 'totalAmountMax' => false, 'customerId' => false, 'processDateFrom' => false, 'processDateTo' => false, 'status' => false, 'authMaxDateFrom' => false, 'authMaxDateTo' => false, 'updatedFrom' => false, 'updatedTo' => false, 'sort' => true, 'page' => true, 'limit' => true, 'countOnly' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['payType' => 'pay_type', 'keyword' => 'keyword', 'totalAmountMin' => 'total_amount_min', 'totalAmountMax' => 'total_amount_max', 'customerId' => 'customer_id', 'processDateFrom' => 'process_date_from', 'processDateTo' => 'process_date_to', 'status' => 'status', 'authMaxDateFrom' => 'auth_max_date_from', 'authMaxDateTo' => 'auth_max_date_to', 'updatedFrom' => 'updated_from', 'updatedTo' => 'updated_to', 'sort' => 'sort', 'page' => 'page', 'limit' => 'limit', 'countOnly' => 'count_only'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['payType' => 'setPayType', 'keyword' => 'setKeyword', 'totalAmountMin' => 'setTotalAmountMin', 'totalAmountMax' => 'setTotalAmountMax', 'customerId' => 'setCustomerId', 'processDateFrom' => 'setProcessDateFrom', 'processDateTo' => 'setProcessDateTo', 'status' => 'setStatus', 'authMaxDateFrom' => 'setAuthMaxDateFrom', 'authMaxDateTo' => 'setAuthMaxDateTo', 'updatedFrom' => 'setUpdatedFrom', 'updatedTo' => 'setUpdatedTo', 'sort' => 'setSort', 'page' => 'setPage', 'limit' => 'setLimit', 'countOnly' => 'setCountOnly'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['payType' => 'getPayType', 'keyword' => 'getKeyword', 'totalAmountMin' => 'getTotalAmountMin', 'totalAmountMax' => 'getTotalAmountMax', 'customerId' => 'getCustomerId', 'processDateFrom' => 'getProcessDateFrom', 'processDateTo' => 'getProcessDateTo', 'status' => 'getStatus', 'authMaxDateFrom' => 'getAuthMaxDateFrom', 'authMaxDateTo' => 'getAuthMaxDateTo', 'updatedFrom' => 'getUpdatedFrom', 'updatedTo' => 'getUpdatedTo', 'sort' => 'getSort', 'page' => 'getPage', 'limit' => 'getLimit', 'countOnly' => 'getCountOnly'];
    ...
    public function setKeyword(mixed $keyword): static
    {
        ...
        if (!is_null($keyword) && mb_strlen($keyword) > 100) {
            throw new \InvalidArgumentException('invalid length for $keyword when calling ApplePay., must be smaller than or equal to 100.');
        }
        if (!is_null($keyword) && mb_strlen($keyword) < 1) {
            throw new \InvalidArgumentException('invalid length for $keyword when calling ApplePay., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling ApplePay., must be smaller than or equal to 60.');
        }
        if (mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling ApplePay., must be bigger than or equal to 1.');
        }
     ...
     * Sets status.
     *
     * @param PaymentStatus $status 決済ステータス\\ 指定したステータスの決済情報を取得します。カンマ区切りにすることで複数指定（OR検索）できます。  - `UNPROCESSED`: 未処理 - `AUTHORIZED`: 仮売上 - `CAPTURED`: 売上確定 - `CANCELED`: キャンセル
     */
