...
class PaymentCardExecutingRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setTds2ProvisionAttemptsDay(mixed $tds2ProvisionAttemptsDay): static
    {
        ...
        if (!is_null($tds2ProvisionAttemptsDay) && mb_strlen($tds2ProvisionAttemptsDay) < 1) {
            throw new \InvalidArgumentException('invalid length for $tds2ProvisionAttemptsDay when calling PaymentCardExecutingRequest., must be bigger than or equal to 1.');
        }
