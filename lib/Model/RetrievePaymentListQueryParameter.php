 ...
 */
class RetrievePaymentListQueryParameter implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'retrievePaymentList_query_parameter';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['payType' => '\Fincode\OpenAPI\Model\PayType', 'keyword' => 'string', 'totalAmountMin' => 'int', 'totalAmountMax' => 'int', 'customerId' => 'string', 'processDateFrom' => 'string', 'processDateTo' => 'string', 'status' => '\Fincode\OpenAPI\Model\PaymentStatus', 'authMaxDateFrom' => 'string', 'authMaxDateTo' => 'string', 'subscriptionId' => 'string', 'payPattern' => 'string', 'updateDateFrom' => 'string', 'updateDateTo' => 'string', 'sort' => 'string', 'page' => 'int', 'limit' => 'int', 'countOnly' => 'bool', 'updatedFrom' => 'string', 'updatedTo' => 'string', 'paymentTermFrom' => 'string', 'paymentTermTo' => 'string', 'paymentDateFrom' => 'string', 'paymentDateTo' => 'string', 'overpaymentFlag' => 'string', 'cancelOverpaymentFlag' => 'string', 'targetDateFrom' => 'string', 'targetDateTo' => 'string', 'withdrawalDateFrom' => 'string', 'withdrawalDateTo' => 'string', 'resultCode' => '\Fincode\OpenAPI\Model\DirectDebitResultCode', 'billingTotalAmountMin' => 'string', 'billingTotalAmountMax' => 'string', 'transactionDateFrom' => 'string', 'transactionDateTo' => 'string', 'expireOverpaymentFlag' => 'string', 'amountPattern' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['payType' => null, 'keyword' => null, 'totalAmountMin' => 'int64', 'totalAmountMax' => 'int64', 'customerId' => null, 'processDateFrom' => null, 'processDateTo' => null, 'status' => null, 'authMaxDateFrom' => null, 'authMaxDateTo' => null, 'subscriptionId' => null, 'payPattern' => null, 'updateDateFrom' => null, 'updateDateTo' => null, 'sort' => null, 'page' => null, 'limit' => null, 'countOnly' => null, 'updatedFrom' => null, 'updatedTo' => null, 'paymentTermFrom' => null, 'paymentTermTo' => null, 'paymentDateFrom' => null, 'paymentDateTo' => null, 'overpaymentFlag' => null, 'cancelOverpaymentFlag' => null, 'targetDateFrom' => null, 'targetDateTo' => null, 'withdrawalDateFrom' => null, 'withdrawalDateTo' => null, 'resultCode' => null, 'billingTotalAmountMin' => null, 'billingTotalAmountMax' => null, 'transactionDateFrom' => null, 'transactionDateTo' => null, 'expireOverpaymentFlag' => null, 'amountPattern' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['payType' => false, 'keyword' => true, 'totalAmountMin' => false, 'totalAmountMax' => false, 'customerId' => false, 'processDateFrom' => false, 'processDateTo' => false, 'status' => false, 'authMaxDateFrom' => false, 'authMaxDateTo' => false, 'subscriptionId' => false, 'payPattern' => false, 'updateDateFrom' => false, 'updateDateTo' => false, 'sort' => true, 'page' => true, 'limit' => true, 'countOnly' => true, 'updatedFrom' => false, 'updatedTo' => false, 'paymentTermFrom' => false, 'paymentTermTo' => false, 'paymentDateFrom' => false, 'paymentDateTo' => false, 'overpaymentFlag' => false, 'cancelOverpaymentFlag' => false, 'targetDateFrom' => true, 'targetDateTo' => true, 'withdrawalDateFrom' => true, 'withdrawalDateTo' => true, 'resultCode' => false, 'billingTotalAmountMin' => false, 'billingTotalAmountMax' => false, 'transactionDateFrom' => false, 'transactionDateTo' => false, 'expireOverpaymentFlag' => false, 'amountPattern' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['payType' => 'pay_type', 'keyword' => 'keyword', 'totalAmountMin' => 'total_amount_min', 'totalAmountMax' => 'total_amount_max', 'customerId' => 'customer_id', 'processDateFrom' => 'process_date_from', 'processDateTo' => 'process_date_to', 'status' => 'status', 'authMaxDateFrom' => 'auth_max_date_from', 'authMaxDateTo' => 'auth_max_date_to', 'subscriptionId' => 'subscription_id', 'payPattern' => 'pay_pattern', 'updateDateFrom' => 'update_date_from', 'updateDateTo' => 'update_date_to', 'sort' => 'sort', 'page' => 'page', 'limit' => 'limit', 'countOnly' => 'count_only', 'updatedFrom' => 'updated_from', 'updatedTo' => 'updated_to', 'paymentTermFrom' => 'payment_term_from', 'paymentTermTo' => 'payment_term_to', 'paymentDateFrom' => 'payment_date_from', 'paymentDateTo' => 'payment_date_to', 'overpaymentFlag' => 'overpayment_flag', 'cancelOverpaymentFlag' => 'cancel_overpayment_flag', 'targetDateFrom' => 'target_date_from', 'targetDateTo' => 'target_date_to', 'withdrawalDateFrom' => 'withdrawal_date_from', 'withdrawalDateTo' => 'withdrawal_date_to', 'resultCode' => 'result_code', 'billingTotalAmountMin' => 'billing_total_amount_min', 'billingTotalAmountMax' => 'billing_total_amount_max', 'transactionDateFrom' => 'transaction_date_from', 'transactionDateTo' => 'transaction_date_to', 'expireOverpaymentFlag' => 'expire_overpayment_flag', 'amountPattern' => 'amount_pattern'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['payType' => 'setPayType', 'keyword' => 'setKeyword', 'totalAmountMin' => 'setTotalAmountMin', 'totalAmountMax' => 'setTotalAmountMax', 'customerId' => 'setCustomerId', 'processDateFrom' => 'setProcessDateFrom', 'processDateTo' => 'setProcessDateTo', 'status' => 'setStatus', 'authMaxDateFrom' => 'setAuthMaxDateFrom', 'authMaxDateTo' => 'setAuthMaxDateTo', 'subscriptionId' => 'setSubscriptionId', 'payPattern' => 'setPayPattern', 'updateDateFrom' => 'setUpdateDateFrom', 'updateDateTo' => 'setUpdateDateTo', 'sort' => 'setSort', 'page' => 'setPage', 'limit' => 'setLimit', 'countOnly' => 'setCountOnly', 'updatedFrom' => 'setUpdatedFrom', 'updatedTo' => 'setUpdatedTo', 'paymentTermFrom' => 'setPaymentTermFrom', 'paymentTermTo' => 'setPaymentTermTo', 'paymentDateFrom' => 'setPaymentDateFrom', 'paymentDateTo' => 'setPaymentDateTo', 'overpaymentFlag' => 'setOverpaymentFlag', 'cancelOverpaymentFlag' => 'setCancelOverpaymentFlag', 'targetDateFrom' => 'setTargetDateFrom', 'targetDateTo' => 'setTargetDateTo', 'withdrawalDateFrom' => 'setWithdrawalDateFrom', 'withdrawalDateTo' => 'setWithdrawalDateTo', 'resultCode' => 'setResultCode', 'billingTotalAmountMin' => 'setBillingTotalAmountMin', 'billingTotalAmountMax' => 'setBillingTotalAmountMax', 'transactionDateFrom' => 'setTransactionDateFrom', 'transactionDateTo' => 'setTransactionDateTo', 'expireOverpaymentFlag' => 'setExpireOverpaymentFlag', 'amountPattern' => 'setAmountPattern'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['payType' => 'getPayType', 'keyword' => 'getKeyword', 'totalAmountMin' => 'getTotalAmountMin', 'totalAmountMax' => 'getTotalAmountMax', 'customerId' => 'getCustomerId', 'processDateFrom' => 'getProcessDateFrom', 'processDateTo' => 'getProcessDateTo', 'status' => 'getStatus', 'authMaxDateFrom' => 'getAuthMaxDateFrom', 'authMaxDateTo' => 'getAuthMaxDateTo', 'subscriptionId' => 'getSubscriptionId', 'payPattern' => 'getPayPattern', 'updateDateFrom' => 'getUpdateDateFrom', 'updateDateTo' => 'getUpdateDateTo', 'sort' => 'getSort', 'page' => 'getPage', 'limit' => 'getLimit', 'countOnly' => 'getCountOnly', 'updatedFrom' => 'getUpdatedFrom', 'updatedTo' => 'getUpdatedTo', 'paymentTermFrom' => 'getPaymentTermFrom', 'paymentTermTo' => 'getPaymentTermTo', 'paymentDateFrom' => 'getPaymentDateFrom', 'paymentDateTo' => 'getPaymentDateTo', 'overpaymentFlag' => 'getOverpaymentFlag', 'cancelOverpaymentFlag' => 'getCancelOverpaymentFlag', 'targetDateFrom' => 'getTargetDateFrom', 'targetDateTo' => 'getTargetDateTo', 'withdrawalDateFrom' => 'getWithdrawalDateFrom', 'withdrawalDateTo' => 'getWithdrawalDateTo', 'resultCode' => 'getResultCode', 'billingTotalAmountMin' => 'getBillingTotalAmountMin', 'billingTotalAmountMax' => 'getBillingTotalAmountMax', 'transactionDateFrom' => 'getTransactionDateFrom', 'transactionDateTo' => 'getTransactionDateTo', 'expireOverpaymentFlag' => 'getExpireOverpaymentFlag', 'amountPattern' => 'getAmountPattern'];
    ...
    public function setKeyword(mixed $keyword): static
    {
        ...
        if (!is_null($keyword) && mb_strlen($keyword) > 100) {
            throw new \InvalidArgumentException('invalid length for $keyword when calling RetrievePaymentListQueryParameter., must be smaller than or equal to 100.');
        }
        if (!is_null($keyword) && mb_strlen($keyword) < 1) {
            throw new \InvalidArgumentException('invalid length for $keyword when calling RetrievePaymentListQueryParameter., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling RetrievePaymentListQueryParameter., must be smaller than or equal to 60.');
        }
        if (mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling RetrievePaymentListQueryParameter., must be bigger than or equal to 1.');
        }
     ...
     * Sets sort.
     *
     * @param string|null $sort ソートする項目と順序を指定します。\\ 例： `?sort=updated␣desc,created␣asc`\\ \\ ソート可能な項目  - `status`: ステータス - `process_date`: 処理日時 - `total_amount`: 合計金額 - `payment_term`: 支払い期限 - `payment_date`: 支払い日時 - `created`: 作成日時 - `updated`: 更新日時
     */
    ...
    public function setBillingTotalAmountMin(mixed $billingTotalAmountMin): static
    {
        ...
        if (mb_strlen($billingTotalAmountMin) > 10) {
            throw new \InvalidArgumentException('invalid length for $billingTotalAmountMin when calling RetrievePaymentListQueryParameter., must be smaller than or equal to 10.');
        }
        if (mb_strlen($billingTotalAmountMin) < 1) {
            throw new \InvalidArgumentException('invalid length for $billingTotalAmountMin when calling RetrievePaymentListQueryParameter., must be bigger than or equal to 1.');
        }
    ...
    public function setBillingTotalAmountMax(mixed $billingTotalAmountMax): static
    {
        ...
        if (mb_strlen($billingTotalAmountMax) > 10) {
            throw new \InvalidArgumentException('invalid length for $billingTotalAmountMax when calling RetrievePaymentListQueryParameter., must be smaller than or equal to 10.');
        }
        if (mb_strlen($billingTotalAmountMax) < 1) {
            throw new \InvalidArgumentException('invalid length for $billingTotalAmountMax when calling RetrievePaymentListQueryParameter., must be bigger than or equal to 1.');
        }
