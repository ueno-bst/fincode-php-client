 ...
 */
class WebhookEventPaymentCard implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'WebhookEvent.Payment.Card';
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['shopId' => 'shop_id', 'orderId' => 'order_id', 'accessId' => 'access_id', 'payType' => 'pay_type', 'status' => 'status', 'customerId' => 'customer_id', 'method' => 'method', 'clientField1' => 'client_field_1', 'clientField2' => 'client_field_2', 'clientField3' => 'client_field_3', 'amount' => 'amount', 'tax' => 'tax', 'currency' => 'currency', 'jobCode' => 'job_code', 'subscriptionId' => 'subscription_id', 'bulkPaymentId' => 'bulk_payment_id', 'forward' => 'forward', 'transactionId' => 'transaction_id', 'transactionDate' => 'transaction_date', 'approve' => 'approve', 'errorCode' => 'error_code', 'event' => 'event'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['shopId' => 'setShopId', 'orderId' => 'setOrderId', 'accessId' => 'setAccessId', 'payType' => 'setPayType', 'status' => 'setStatus', 'customerId' => 'setCustomerId', 'method' => 'setMethod', 'clientField1' => 'setClientField1', 'clientField2' => 'setClientField2', 'clientField3' => 'setClientField3', 'amount' => 'setAmount', 'tax' => 'setTax', 'currency' => 'setCurrency', 'jobCode' => 'setJobCode', 'subscriptionId' => 'setSubscriptionId', 'bulkPaymentId' => 'setBulkPaymentId', 'forward' => 'setForward', 'transactionId' => 'setTransactionId', 'transactionDate' => 'setTransactionDate', 'approve' => 'setApprove', 'errorCode' => 'setErrorCode', 'event' => 'setEvent'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['shopId' => 'getShopId', 'orderId' => 'getOrderId', 'accessId' => 'getAccessId', 'payType' => 'getPayType', 'status' => 'getStatus', 'customerId' => 'getCustomerId', 'method' => 'getMethod', 'clientField1' => 'getClientField1', 'clientField2' => 'getClientField2', 'clientField3' => 'getClientField3', 'amount' => 'getAmount', 'tax' => 'getTax', 'currency' => 'getCurrency', 'jobCode' => 'getJobCode', 'subscriptionId' => 'getSubscriptionId', 'bulkPaymentId' => 'getBulkPaymentId', 'forward' => 'getForward', 'transactionId' => 'getTransactionId', 'transactionDate' => 'getTransactionDate', 'approve' => 'getApprove', 'errorCode' => 'getErrorCode', 'event' => 'getEvent'];
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling WebhookEventPaymentCard., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling WebhookEventPaymentCard., must be bigger than or equal to 13.');
        }
    ...
    public function setOrderId(mixed $orderId): static
    {
        ...
        if (mb_strlen($orderId) > 30) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling WebhookEventPaymentCard., must be smaller than or equal to 30.');
        }
        if (mb_strlen($orderId) < 1) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling WebhookEventPaymentCard., must be bigger than or equal to 1.');
        }
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling WebhookEventPaymentCard., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling WebhookEventPaymentCard., must be bigger than or equal to 24.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (!is_null($customerId) && mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling WebhookEventPaymentCard., must be smaller than or equal to 60.');
        }
        if (!is_null($customerId) && mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling WebhookEventPaymentCard., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling WebhookEventPaymentCard., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling WebhookEventPaymentCard., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling WebhookEventPaymentCard., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling WebhookEventPaymentCard., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling WebhookEventPaymentCard., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling WebhookEventPaymentCard., must be bigger than or equal to 1.');
        }
    ...
    public function setAmount(mixed $amount): static
    {
        ...
        if (mb_strlen($amount) > 7) {
            throw new \InvalidArgumentException('invalid length for $amount when calling WebhookEventPaymentCard., must be smaller than or equal to 7.');
        }
        if (mb_strlen($amount) < 1) {
            throw new \InvalidArgumentException('invalid length for $amount when calling WebhookEventPaymentCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTax(mixed $tax): static
    {
        ...
        if (mb_strlen($tax) > 7) {
            throw new \InvalidArgumentException('invalid length for $tax when calling WebhookEventPaymentCard., must be smaller than or equal to 7.');
        }
        if (mb_strlen($tax) < 1) {
            throw new \InvalidArgumentException('invalid length for $tax when calling WebhookEventPaymentCard., must be bigger than or equal to 1.');
        }
    ...
    public function setSubscriptionId(mixed $subscriptionId): static
    {
        ...
        if (!is_null($subscriptionId) && mb_strlen($subscriptionId) > 25) {
            throw new \InvalidArgumentException('invalid length for $subscriptionId when calling WebhookEventPaymentCard., must be smaller than or equal to 25.');
        }
        if (!is_null($subscriptionId) && mb_strlen($subscriptionId) < 1) {
            throw new \InvalidArgumentException('invalid length for $subscriptionId when calling WebhookEventPaymentCard., must be bigger than or equal to 1.');
        }
     ...
     * Sets bulkPaymentId.
     *
     * @param string $bulkPaymentId 一括決済ID
     */
    public function setBulkPaymentId(mixed $bulkPaymentId): static
    {
        if (is_null($bulkPaymentId)) {
            throw new \InvalidArgumentException('non-nullable bulkPaymentId cannot be null');
        }
        if (mb_strlen($bulkPaymentId) > 25) {
            throw new \InvalidArgumentException('invalid length for $bulkPaymentId when calling WebhookEventPaymentCard., must be smaller than or equal to 25.');
        }
        if (mb_strlen($bulkPaymentId) < 25) {
            throw new \InvalidArgumentException('invalid length for $bulkPaymentId when calling WebhookEventPaymentCard., must be bigger than or equal to 25.');
        }
    ...
    public function setForward(mixed $forward): static
    {
        ...
        if (!is_null($forward) && mb_strlen($forward) > 7) {
            throw new \InvalidArgumentException('invalid length for $forward when calling WebhookEventPaymentCard., must be smaller than or equal to 7.');
        }
        if (!is_null($forward) && mb_strlen($forward) < 1) {
            throw new \InvalidArgumentException('invalid length for $forward when calling WebhookEventPaymentCard., must be bigger than or equal to 1.');
        }
    ...
    public function setTransactionId(mixed $transactionId): static
    {
        ...
        if (!is_null($transactionId) && mb_strlen($transactionId) > 28) {
            throw new \InvalidArgumentException('invalid length for $transactionId when calling WebhookEventPaymentCard., must be smaller than or equal to 28.');
        }
        if (!is_null($transactionId) && mb_strlen($transactionId) < 28) {
            throw new \InvalidArgumentException('invalid length for $transactionId when calling WebhookEventPaymentCard., must be bigger than or equal to 28.');
        }
    ...
    public function setApprove(mixed $approve): static
    {
        ...
        if (!is_null($approve) && mb_strlen($approve) > 7) {
            throw new \InvalidArgumentException('invalid length for $approve when calling WebhookEventPaymentCard., must be smaller than or equal to 7.');
        }
        if (!is_null($approve) && mb_strlen($approve) < 1) {
            throw new \InvalidArgumentException('invalid length for $approve when calling WebhookEventPaymentCard., must be bigger than or equal to 1.');
        }
    ...
    public function setErrorCode(mixed $errorCode): static
    {
        ...
        if (!is_null($errorCode) && mb_strlen($errorCode) > 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling WebhookEventPaymentCard., must be smaller than or equal to 11.');
        }
        if (!is_null($errorCode) && mb_strlen($errorCode) < 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling WebhookEventPaymentCard., must be bigger than or equal to 11.');
        }
