 ...
 */
class RetrievePaymentListQueryParameterOneOf2 implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'retrievePaymentList_query_parameter_oneOf_2';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['payType' => '\Fincode\OpenAPI\Model\PayType', 'keyword' => 'string', 'totalAmountMin' => 'int', 'totalAmountMax' => 'int', 'customerId' => 'string', 'processDateFrom' => 'string', 'processDateTo' => 'string', 'targetDateFrom' => 'string', 'targetDateTo' => 'string', 'withdrawalDateFrom' => 'string', 'withdrawalDateTo' => 'string', 'resultCode' => '\Fincode\OpenAPI\Model\DirectDebitResultCode', 'payPattern' => 'string', 'subscriptionId' => 'string', 'updatedFrom' => 'string', 'updatedTo' => 'string', 'sort' => 'string', 'page' => 'int', 'limit' => 'int', 'countOnly' => 'bool'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['payType' => null, 'keyword' => null, 'totalAmountMin' => 'int64', 'totalAmountMax' => 'int64', 'customerId' => null, 'processDateFrom' => null, 'processDateTo' => null, 'targetDateFrom' => null, 'targetDateTo' => null, 'withdrawalDateFrom' => null, 'withdrawalDateTo' => null, 'resultCode' => null, 'payPattern' => null, 'subscriptionId' => null, 'updatedFrom' => null, 'updatedTo' => null, 'sort' => null, 'page' => null, 'limit' => null, 'countOnly' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['payType' => false, 'keyword' => true, 'totalAmountMin' => false, 'totalAmountMax' => false, 'customerId' => false, 'processDateFrom' => false, 'processDateTo' => false, 'targetDateFrom' => true, 'targetDateTo' => true, 'withdrawalDateFrom' => true, 'withdrawalDateTo' => true, 'resultCode' => false, 'payPattern' => false, 'subscriptionId' => false, 'updatedFrom' => false, 'updatedTo' => false, 'sort' => true, 'page' => true, 'limit' => true, 'countOnly' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['payType' => 'pay_type', 'keyword' => 'keyword', 'totalAmountMin' => 'total_amount_min', 'totalAmountMax' => 'total_amount_max', 'customerId' => 'customer_id', 'processDateFrom' => 'process_date_from', 'processDateTo' => 'process_date_to', 'targetDateFrom' => 'target_date_from', 'targetDateTo' => 'target_date_to', 'withdrawalDateFrom' => 'withdrawal_date_from', 'withdrawalDateTo' => 'withdrawal_date_to', 'resultCode' => 'result_code', 'payPattern' => 'pay_pattern', 'subscriptionId' => 'subscription_id', 'updatedFrom' => 'updated_from', 'updatedTo' => 'updated_to', 'sort' => 'sort', 'page' => 'page', 'limit' => 'limit', 'countOnly' => 'count_only'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['payType' => 'setPayType', 'keyword' => 'setKeyword', 'totalAmountMin' => 'setTotalAmountMin', 'totalAmountMax' => 'setTotalAmountMax', 'customerId' => 'setCustomerId', 'processDateFrom' => 'setProcessDateFrom', 'processDateTo' => 'setProcessDateTo', 'targetDateFrom' => 'setTargetDateFrom', 'targetDateTo' => 'setTargetDateTo', 'withdrawalDateFrom' => 'setWithdrawalDateFrom', 'withdrawalDateTo' => 'setWithdrawalDateTo', 'resultCode' => 'setResultCode', 'payPattern' => 'setPayPattern', 'subscriptionId' => 'setSubscriptionId', 'updatedFrom' => 'setUpdatedFrom', 'updatedTo' => 'setUpdatedTo', 'sort' => 'setSort', 'page' => 'setPage', 'limit' => 'setLimit', 'countOnly' => 'setCountOnly'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['payType' => 'getPayType', 'keyword' => 'getKeyword', 'totalAmountMin' => 'getTotalAmountMin', 'totalAmountMax' => 'getTotalAmountMax', 'customerId' => 'getCustomerId', 'processDateFrom' => 'getProcessDateFrom', 'processDateTo' => 'getProcessDateTo', 'targetDateFrom' => 'getTargetDateFrom', 'targetDateTo' => 'getTargetDateTo', 'withdrawalDateFrom' => 'getWithdrawalDateFrom', 'withdrawalDateTo' => 'getWithdrawalDateTo', 'resultCode' => 'getResultCode', 'payPattern' => 'getPayPattern', 'subscriptionId' => 'getSubscriptionId', 'updatedFrom' => 'getUpdatedFrom', 'updatedTo' => 'getUpdatedTo', 'sort' => 'getSort', 'page' => 'getPage', 'limit' => 'getLimit', 'countOnly' => 'getCountOnly'];
    ...
    public function setKeyword(mixed $keyword): static
    {
        ...
        if (!is_null($keyword) && mb_strlen($keyword) > 100) {
            throw new \InvalidArgumentException('invalid length for $keyword when calling RetrievePaymentListQueryParameterOneOf2., must be smaller than or equal to 100.');
        }
        if (!is_null($keyword) && mb_strlen($keyword) < 1) {
            throw new \InvalidArgumentException('invalid length for $keyword when calling RetrievePaymentListQueryParameterOneOf2., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling RetrievePaymentListQueryParameterOneOf2., must be smaller than or equal to 60.');
        }
        if (mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling RetrievePaymentListQueryParameterOneOf2., must be bigger than or equal to 1.');
        }
     ...
     * Sets sort.
     *
     * @param string|null $sort ソートする項目と順序を指定します。\\ 例： `?sort=updated␣desc,created␣asc`\\ \\ ソート可能な項目  - `status`: ステータス - `process_date`: 処理日時 - `total_amount`: 合計金額 - `target_date`: 振替指定日 - `withdrawal_date`: 引き落とし日 - `created`: 作成日時 - `updated`: 更新日時
     */
