...
class RetrievePaymentListQueryParameterOneOf implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets sort.
     *
     * @param string|null $sort ソートする項目と順序を指定します。\\ 例： `?sort=updated␣desc,created␣asc`\\ \\ ソート可能な項目  - `status`: ステータス - `process_data`: 処理日時 - `total_amount`: 合計金額 - `auth_max_date`: 仮売上有効期限 - `created`: 作成日時 - `updated`: 更新日時
     */
