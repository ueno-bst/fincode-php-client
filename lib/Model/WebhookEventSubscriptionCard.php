 ...
 */
class WebhookEventSubscriptionCard implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'WebhookEvent.Subscription.Card';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['shopId' => 'string', 'subscriptionId' => 'string', 'planId' => 'string', 'customerId' => 'string', 'cardId' => 'string', 'defaultCardFlag' => '\OpenAPI\Fincode\Model\DefaultFlag', 'status' => '\OpenAPI\Fincode\Model\SubscriptionStatus', 'clientField1' => 'string', 'clientField2' => 'string', 'clientField3' => 'string', 'processDate' => 'string', 'startDate' => 'string', 'stopDate' => 'string', 'nextChargeDate' => 'string', 'endMonthFlag' => '\OpenAPI\Fincode\Model\EndMonthFlag', 'payType' => '\OpenAPI\Fincode\Model\SubscriptionPayType', 'event' => '\OpenAPI\Fincode\Model\FincodeEvent'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['shopId' => null, 'subscriptionId' => null, 'planId' => null, 'customerId' => null, 'cardId' => null, 'defaultCardFlag' => null, 'status' => null, 'clientField1' => null, 'clientField2' => null, 'clientField3' => null, 'processDate' => null, 'startDate' => null, 'stopDate' => null, 'nextChargeDate' => null, 'endMonthFlag' => null, 'payType' => null, 'event' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['shopId' => false, 'subscriptionId' => true, 'planId' => true, 'customerId' => true, 'cardId' => true, 'defaultCardFlag' => true, 'status' => false, 'clientField1' => true, 'clientField2' => true, 'clientField3' => true, 'processDate' => true, 'startDate' => true, 'stopDate' => true, 'nextChargeDate' => true, 'endMonthFlag' => true, 'payType' => false, 'event' => false];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['shopId' => 'shop_id', 'subscriptionId' => 'subscription_id', 'planId' => 'plan_id', 'customerId' => 'customer_id', 'cardId' => 'card_id', 'defaultCardFlag' => 'default_card_flag', 'status' => 'status', 'clientField1' => 'client_field_1', 'clientField2' => 'client_field_2', 'clientField3' => 'client_field_3', 'processDate' => 'process_date', 'startDate' => 'start_date', 'stopDate' => 'stop_date', 'nextChargeDate' => 'next_charge_date', 'endMonthFlag' => 'end_month_flag', 'payType' => 'pay_type', 'event' => 'event'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['shopId' => 'setShopId', 'subscriptionId' => 'setSubscriptionId', 'planId' => 'setPlanId', 'customerId' => 'setCustomerId', 'cardId' => 'setCardId', 'defaultCardFlag' => 'setDefaultCardFlag', 'status' => 'setStatus', 'clientField1' => 'setClientField1', 'clientField2' => 'setClientField2', 'clientField3' => 'setClientField3', 'processDate' => 'setProcessDate', 'startDate' => 'setStartDate', 'stopDate' => 'setStopDate', 'nextChargeDate' => 'setNextChargeDate', 'endMonthFlag' => 'setEndMonthFlag', 'payType' => 'setPayType', 'event' => 'setEvent'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['shopId' => 'getShopId', 'subscriptionId' => 'getSubscriptionId', 'planId' => 'getPlanId', 'customerId' => 'getCustomerId', 'cardId' => 'getCardId', 'defaultCardFlag' => 'getDefaultCardFlag', 'status' => 'getStatus', 'clientField1' => 'getClientField1', 'clientField2' => 'getClientField2', 'clientField3' => 'getClientField3', 'processDate' => 'getProcessDate', 'startDate' => 'getStartDate', 'stopDate' => 'getStopDate', 'nextChargeDate' => 'getNextChargeDate', 'endMonthFlag' => 'getEndMonthFlag', 'payType' => 'getPayType', 'event' => 'getEvent'];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('defaultCardFlag', $data ?? [], null);
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling WebhookEventSubscriptionCard., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling WebhookEventSubscriptionCard., must be bigger than or equal to 13.');
        }
    ...
    public function setSubscriptionId(mixed $subscriptionId): static
    {
        ...
        if (!is_null($subscriptionId) && mb_strlen($subscriptionId) > 25) {
            throw new \InvalidArgumentException('invalid length for $subscriptionId when calling WebhookEventSubscriptionCard., must be smaller than or equal to 25.');
        }
        if (!is_null($subscriptionId) && mb_strlen($subscriptionId) < 1) {
            throw new \InvalidArgumentException('invalid length for $subscriptionId when calling WebhookEventSubscriptionCard., must be bigger than or equal to 1.');
        }
    ...
    public function setPlanId(mixed $planId): static
    {
        ...
        if (!is_null($planId) && mb_strlen($planId) > 25) {
            throw new \InvalidArgumentException('invalid length for $planId when calling WebhookEventSubscriptionCard., must be smaller than or equal to 25.');
        }
        if (!is_null($planId) && mb_strlen($planId) < 1) {
            throw new \InvalidArgumentException('invalid length for $planId when calling WebhookEventSubscriptionCard., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (!is_null($customerId) && mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling WebhookEventSubscriptionCard., must be smaller than or equal to 60.');
        }
        if (!is_null($customerId) && mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling WebhookEventSubscriptionCard., must be bigger than or equal to 1.');
        }
    ...
    public function setCardId(mixed $cardId): static
    {
        ...
        if (!is_null($cardId) && mb_strlen($cardId) > 25) {
            throw new \InvalidArgumentException('invalid length for $cardId when calling WebhookEventSubscriptionCard., must be smaller than or equal to 25.');
        }
        if (!is_null($cardId) && mb_strlen($cardId) < 25) {
            throw new \InvalidArgumentException('invalid length for $cardId when calling WebhookEventSubscriptionCard., must be bigger than or equal to 25.');
        }
    ...
    /**
     * Gets defaultCardFlag.
     *
     * @return DefaultFlag|null
     */
    public function getDefaultCardFlag(): mixed
    {
        return $this->container['defaultCardFlag'];
    }

    /**
     * Sets defaultCardFlag.
     *
     * @param DefaultFlag|null $defaultCardFlag defaultCardFlag
     */
    public function setDefaultCardFlag(mixed $defaultCardFlag): static
    {
        if (is_null($defaultCardFlag)) {
            $this->openAPINullablesSetToNull[] = 'defaultCardFlag';
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('defaultCardFlag', $nullablesSetToNull);
            if (false !== $index) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['defaultCardFlag'] = $defaultCardFlag;
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling WebhookEventSubscriptionCard., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling WebhookEventSubscriptionCard., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling WebhookEventSubscriptionCard., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling WebhookEventSubscriptionCard., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling WebhookEventSubscriptionCard., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling WebhookEventSubscriptionCard., must be bigger than or equal to 1.');
        }
