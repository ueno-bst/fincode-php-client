 ...
 */
class PaymentListRetrievingVirtualAccountQueryParams implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Payment.ListRetrieving.VirtualAccount.QueryParams';
    /**
     ...
     */
    protected static array $openAPIFormats = ['status' => null, 'billingTotalAmountMin' => null, 'billingTotalAmountMax' => null, 'paymentTermFrom' => null, 'paymentTermTo' => null, 'transactionDateFrom' => null, 'transactionDateTo' => null, 'updatedFrom' => null, 'updatedTo' => null, 'overpaymentFlag' => null, 'cancelOverpaymentFlag' => null, 'expireOverpaymentFlag' => null, 'amountPattern' => null, 'sort' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['status' => false, 'billingTotalAmountMin' => false, 'billingTotalAmountMax' => false, 'paymentTermFrom' => false, 'paymentTermTo' => false, 'transactionDateFrom' => false, 'transactionDateTo' => false, 'updatedFrom' => false, 'updatedTo' => false, 'overpaymentFlag' => false, 'cancelOverpaymentFlag' => false, 'expireOverpaymentFlag' => false, 'amountPattern' => true, 'sort' => true];
    /**
    ...
    public function setBillingTotalAmountMin(mixed $billingTotalAmountMin): static
    {
        ...
        if (mb_strlen($billingTotalAmountMin) > 10) {
            throw new \InvalidArgumentException('invalid length for $billingTotalAmountMin when calling PaymentListRetrievingVirtualAccountQueryParams., must be smaller than or equal to 10.');
        }
        if (mb_strlen($billingTotalAmountMin) < 1) {
            throw new \InvalidArgumentException('invalid length for $billingTotalAmountMin when calling PaymentListRetrievingVirtualAccountQueryParams., must be bigger than or equal to 1.');
        }
    ...
    public function setBillingTotalAmountMax(mixed $billingTotalAmountMax): static
    {
        ...
        if (mb_strlen($billingTotalAmountMax) > 10) {
            throw new \InvalidArgumentException('invalid length for $billingTotalAmountMax when calling PaymentListRetrievingVirtualAccountQueryParams., must be smaller than or equal to 10.');
        }
        if (mb_strlen($billingTotalAmountMax) < 1) {
            throw new \InvalidArgumentException('invalid length for $billingTotalAmountMax when calling PaymentListRetrievingVirtualAccountQueryParams., must be bigger than or equal to 1.');
        }
