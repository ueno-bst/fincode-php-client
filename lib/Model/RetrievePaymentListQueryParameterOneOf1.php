...
class RetrievePaymentListQueryParameterOneOf1 implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static array $openAPITypes = ['payType' => '\OpenAPI\Fincode\Model\PayType', 'keyword' => 'string', 'totalAmountMin' => 'int', 'totalAmountMax' => 'int', 'customerId' => 'string', 'processDateFrom' => 'string', 'processDateTo' => 'string', 'status' => '\OpenAPI\Fincode\Model\PaymentStatus', 'paymentTermFrom' => 'string', 'paymentTermTo' => 'string', 'paymentDateFrom' => 'string', 'paymentDateTo' => 'string', 'updatedFrom' => 'string', 'updatedTo' => 'string', 'overpaymentFlag' => 'string', 'cancelOverpaymentFlag' => 'string', 'sort' => 'string', 'page' => 'int', 'limit' => 'int', 'countOnly' => 'bool'];
    /**
