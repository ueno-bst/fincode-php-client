 ...
 */
class RetrievePaymentListQueryParameterOneOf1 implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'retrievePaymentList_query_parameter_oneOf_1';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['payType' => '\Fincode\OpenAPI\Model\PayType', 'keyword' => 'string', 'totalAmountMin' => 'int', 'totalAmountMax' => 'int', 'customerId' => 'string', 'processDateFrom' => 'string', 'processDateTo' => 'string', 'status' => '\Fincode\OpenAPI\Model\PaymentStatus', 'paymentTermFrom' => 'string', 'paymentTermTo' => 'string', 'paymentDateFrom' => 'string', 'paymentDateTo' => 'string', 'updatedFrom' => 'string', 'updatedTo' => 'string', 'overpaymentFlag' => 'string', 'cancelOverpaymentFlag' => 'string', 'sort' => 'string', 'page' => 'int', 'limit' => 'int', 'countOnly' => 'bool'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['payType' => null, 'keyword' => null, 'totalAmountMin' => 'int64', 'totalAmountMax' => 'int64', 'customerId' => null, 'processDateFrom' => null, 'processDateTo' => null, 'status' => null, 'paymentTermFrom' => null, 'paymentTermTo' => null, 'paymentDateFrom' => null, 'paymentDateTo' => null, 'updatedFrom' => null, 'updatedTo' => null, 'overpaymentFlag' => null, 'cancelOverpaymentFlag' => null, 'sort' => null, 'page' => null, 'limit' => null, 'countOnly' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['payType' => false, 'keyword' => true, 'totalAmountMin' => false, 'totalAmountMax' => false, 'customerId' => false, 'processDateFrom' => false, 'processDateTo' => false, 'status' => false, 'paymentTermFrom' => false, 'paymentTermTo' => false, 'paymentDateFrom' => false, 'paymentDateTo' => false, 'updatedFrom' => false, 'updatedTo' => false, 'overpaymentFlag' => false, 'cancelOverpaymentFlag' => false, 'sort' => true, 'page' => true, 'limit' => true, 'countOnly' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['payType' => 'pay_type', 'keyword' => 'keyword', 'totalAmountMin' => 'total_amount_min', 'totalAmountMax' => 'total_amount_max', 'customerId' => 'customer_id', 'processDateFrom' => 'process_date_from', 'processDateTo' => 'process_date_to', 'status' => 'status', 'paymentTermFrom' => 'payment_term_from', 'paymentTermTo' => 'payment_term_to', 'paymentDateFrom' => 'payment_date_from', 'paymentDateTo' => 'payment_date_to', 'updatedFrom' => 'updated_from', 'updatedTo' => 'updated_to', 'overpaymentFlag' => 'overpayment_flag', 'cancelOverpaymentFlag' => 'cancel_overpayment_flag', 'sort' => 'sort', 'page' => 'page', 'limit' => 'limit', 'countOnly' => 'count_only'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['payType' => 'setPayType', 'keyword' => 'setKeyword', 'totalAmountMin' => 'setTotalAmountMin', 'totalAmountMax' => 'setTotalAmountMax', 'customerId' => 'setCustomerId', 'processDateFrom' => 'setProcessDateFrom', 'processDateTo' => 'setProcessDateTo', 'status' => 'setStatus', 'paymentTermFrom' => 'setPaymentTermFrom', 'paymentTermTo' => 'setPaymentTermTo', 'paymentDateFrom' => 'setPaymentDateFrom', 'paymentDateTo' => 'setPaymentDateTo', 'updatedFrom' => 'setUpdatedFrom', 'updatedTo' => 'setUpdatedTo', 'overpaymentFlag' => 'setOverpaymentFlag', 'cancelOverpaymentFlag' => 'setCancelOverpaymentFlag', 'sort' => 'setSort', 'page' => 'setPage', 'limit' => 'setLimit', 'countOnly' => 'setCountOnly'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['payType' => 'getPayType', 'keyword' => 'getKeyword', 'totalAmountMin' => 'getTotalAmountMin', 'totalAmountMax' => 'getTotalAmountMax', 'customerId' => 'getCustomerId', 'processDateFrom' => 'getProcessDateFrom', 'processDateTo' => 'getProcessDateTo', 'status' => 'getStatus', 'paymentTermFrom' => 'getPaymentTermFrom', 'paymentTermTo' => 'getPaymentTermTo', 'paymentDateFrom' => 'getPaymentDateFrom', 'paymentDateTo' => 'getPaymentDateTo', 'updatedFrom' => 'getUpdatedFrom', 'updatedTo' => 'getUpdatedTo', 'overpaymentFlag' => 'getOverpaymentFlag', 'cancelOverpaymentFlag' => 'getCancelOverpaymentFlag', 'sort' => 'getSort', 'page' => 'getPage', 'limit' => 'getLimit', 'countOnly' => 'getCountOnly'];
    ...
    public function setKeyword(mixed $keyword): static
    {
        ...
        if (!is_null($keyword) && mb_strlen($keyword) > 100) {
            throw new \InvalidArgumentException('invalid length for $keyword when calling RetrievePaymentListQueryParameterOneOf1., must be smaller than or equal to 100.');
        }
        if (!is_null($keyword) && mb_strlen($keyword) < 1) {
            throw new \InvalidArgumentException('invalid length for $keyword when calling RetrievePaymentListQueryParameterOneOf1., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling RetrievePaymentListQueryParameterOneOf1., must be smaller than or equal to 60.');
        }
        if (mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling RetrievePaymentListQueryParameterOneOf1., must be bigger than or equal to 1.');
        }
