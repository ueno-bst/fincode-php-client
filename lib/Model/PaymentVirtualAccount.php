...
class PaymentVirtualAccount implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setPaymentMethodId(mixed $paymentMethodId): static
    {
        ...
        if (mb_strlen($paymentMethodId) > 25) {
            throw new \InvalidArgumentException('invalid length for $paymentMethodId when calling PaymentVirtualAccount., must be smaller than or equal to 25.');
        }
        if (mb_strlen($paymentMethodId) < 25) {
            throw new \InvalidArgumentException('invalid length for $paymentMethodId when calling PaymentVirtualAccount., must be bigger than or equal to 25.');
        }
    ...
    public function setVaBranchCode(mixed $vaBranchCode): static
    {
        ...
        if (!is_null($vaBranchCode) && mb_strlen($vaBranchCode) > 3) {
            throw new \InvalidArgumentException('invalid length for $vaBranchCode when calling PaymentVirtualAccount., must be smaller than or equal to 3.');
        }
        if (!is_null($vaBranchCode) && mb_strlen($vaBranchCode) < 1) {
            throw new \InvalidArgumentException('invalid length for $vaBranchCode when calling PaymentVirtualAccount., must be bigger than or equal to 1.');
        }
    ...
    public function setVaBranchName(mixed $vaBranchName): static
    {
        ...
        if (!is_null($vaBranchName) && mb_strlen($vaBranchName) > 15) {
            throw new \InvalidArgumentException('invalid length for $vaBranchName when calling PaymentVirtualAccount., must be smaller than or equal to 15.');
        }
    ...
    public function setVaAccountNumber(mixed $vaAccountNumber): static
    {
        ...
        if (!is_null($vaAccountNumber) && mb_strlen($vaAccountNumber) > 7) {
            throw new \InvalidArgumentException('invalid length for $vaAccountNumber when calling PaymentVirtualAccount., must be smaller than or equal to 7.');
        }
        if (!is_null($vaAccountNumber) && mb_strlen($vaAccountNumber) < 7) {
            throw new \InvalidArgumentException('invalid length for $vaAccountNumber when calling PaymentVirtualAccount., must be bigger than or equal to 7.');
        }
    ...
    public function setVaAccountName(mixed $vaAccountName): static
    {
        ...
        if (!is_null($vaAccountName) && mb_strlen($vaAccountName) > 40) {
            throw new \InvalidArgumentException('invalid length for $vaAccountName when calling PaymentVirtualAccount., must be smaller than or equal to 40.');
        }
    ...
    public function setVirtualAccountId(mixed $virtualAccountId): static
    {
        ...
        if (!is_null($virtualAccountId) && mb_strlen($virtualAccountId) > 10) {
            throw new \InvalidArgumentException('invalid length for $virtualAccountId when calling PaymentVirtualAccount., must be smaller than or equal to 10.');
        }
        if (!is_null($virtualAccountId) && mb_strlen($virtualAccountId) < 10) {
            throw new \InvalidArgumentException('invalid length for $virtualAccountId when calling PaymentVirtualAccount., must be bigger than or equal to 10.');
        }
    ...
    public function setRemitterAccountName(mixed $remitterAccountName): static
    {
        ...
        if (!is_null($remitterAccountName) && mb_strlen($remitterAccountName) > 48) {
            throw new \InvalidArgumentException('invalid length for $remitterAccountName when calling PaymentVirtualAccount., must be smaller than or equal to 48.');
        }
    ...
    public function setRemitterBankName(mixed $remitterBankName): static
    {
        ...
        if (!is_null($remitterBankName) && mb_strlen($remitterBankName) > 30) {
            throw new \InvalidArgumentException('invalid length for $remitterBankName when calling PaymentVirtualAccount., must be smaller than or equal to 30.');
        }
    ...
    public function setRemitterBranchName(mixed $remitterBranchName): static
    {
        ...
        if (!is_null($remitterBranchName) && mb_strlen($remitterBranchName) > 15) {
            throw new \InvalidArgumentException('invalid length for $remitterBranchName when calling PaymentVirtualAccount., must be smaller than or equal to 15.');
        }
