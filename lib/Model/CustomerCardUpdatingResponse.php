 ...
 */
class CustomerCardUpdatingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'CustomerCard.Updating.Response';
    /**
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 25) {
            throw new \InvalidArgumentException('invalid length for $id when calling CustomerCardUpdatingResponse., must be smaller than or equal to 25.');
        }
        if (mb_strlen($id) < 25) {
            throw new \InvalidArgumentException('invalid length for $id when calling CustomerCardUpdatingResponse., must be bigger than or equal to 25.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling CustomerCardUpdatingResponse., must be smaller than or equal to 60.');
        }
        if (mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling CustomerCardUpdatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCardNo(mixed $cardNo): static
    {
        ...
        if (mb_strlen($cardNo) > 16) {
            throw new \InvalidArgumentException('invalid length for $cardNo when calling CustomerCardUpdatingResponse., must be smaller than or equal to 16.');
        }
    ...
    public function setExpire(mixed $expire): static
    {
        ...
        if (!is_null($expire) && mb_strlen($expire) > 4) {
            throw new \InvalidArgumentException('invalid length for $expire when calling CustomerCardUpdatingResponse., must be smaller than or equal to 4.');
        }
        if (!is_null($expire) && mb_strlen($expire) < 4) {
            throw new \InvalidArgumentException('invalid length for $expire when calling CustomerCardUpdatingResponse., must be bigger than or equal to 4.');
        }
        if (!is_null($expire) && is_string($expire) && !preg_match('/^\\d{2}\\d{2}$/', $expire)) {
            throw new \InvalidArgumentException('invalid value for $expire when calling CustomerCardUpdatingResponse., must conform to the pattern /^\\d{2}\\d{2}$/.');
        }
    ...
    public function setHolderName(mixed $holderName): static
    {
        ...
        if (!is_null($holderName) && mb_strlen($holderName) > 50) {
            throw new \InvalidArgumentException('invalid length for $holderName when calling CustomerCardUpdatingResponse., must be smaller than or equal to 50.');
        }
        if (!is_null($holderName) && mb_strlen($holderName) < 1) {
            throw new \InvalidArgumentException('invalid length for $holderName when calling CustomerCardUpdatingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setCardNoHash(mixed $cardNoHash): static
    {
        ...
        if (mb_strlen($cardNoHash) > 64) {
            throw new \InvalidArgumentException('invalid length for $cardNoHash when calling CustomerCardUpdatingResponse., must be smaller than or equal to 64.');
        }
        if (mb_strlen($cardNoHash) < 1) {
            throw new \InvalidArgumentException('invalid length for $cardNoHash when calling CustomerCardUpdatingResponse., must be bigger than or equal to 1.');
        }
