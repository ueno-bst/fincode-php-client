 ...
 */
class PaymentBulkErrorDetail implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'PaymentBulkErrorDetail';
    /**
     ...
     */
    protected static array $openAPIFormats = ['number' => null, 'orderId' => null, 'errors' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['number' => false, 'orderId' => false, 'errors' => false];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['number' => 'number', 'orderId' => 'order_id', 'errors' => 'errors'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['number' => 'setNumber', 'orderId' => 'setOrderId', 'errors' => 'setErrors'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['number' => 'getNumber', 'orderId' => 'getOrderId', 'errors' => 'getErrors'];
     ...
     * Sets number.
     *
     * @param string $number 行数
     */
    public function setNumber(mixed $number): static
    {
        if (is_null($number)) {
    ...
    public function setOrderId(mixed $orderId): static
    {
        ...
        if (mb_strlen($orderId) > 30) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling PaymentBulkErrorDetail., must be smaller than or equal to 30.');
        }
        if (mb_strlen($orderId) < 1) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling PaymentBulkErrorDetail., must be bigger than or equal to 1.');
        }
