 ...
 */
class PaymentSessionCreatingRequestPaypay implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'PaymentSession_Creating_Request_paypay';
    /**
     ...
     */
    protected static array $openAPIFormats = ['jobCode' => null, 'orderDescription' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['jobCode' => true, 'orderDescription' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['jobCode' => 'job_code', 'orderDescription' => 'order_description'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['jobCode' => 'setJobCode', 'orderDescription' => 'setOrderDescription'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['jobCode' => 'getJobCode', 'orderDescription' => 'getOrderDescription'];
     ...
     * Sets jobCode.
     *
     * @param PayPayPaymentJobCode|null $jobCode この決済URL上でPayPayによる決済を行った際、仮売上にするか即座に売上確定するか指定します。  - `AUTH`：仮売上にする - `CAPTURE`：即時売上
     */
     ...
     *
     * @param string|null $orderDescription 注文内容の説明\\ PayPayアプリ上で注文内容として表示されます
     */
    public function setOrderDescription(mixed $orderDescription): static
    {
        ...
        if (!is_null($orderDescription) && mb_strlen($orderDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $orderDescription when calling PaymentSessionCreatingRequestPaypay., must be smaller than or equal to 100.');
        }
