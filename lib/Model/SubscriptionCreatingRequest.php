 ...
 */
class SubscriptionCreatingRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Subscription.Creating.Request';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['id' => 'string', 'payType' => '\OpenAPI\Fincode\Model\SubscriptionPayType', 'planId' => 'string', 'customerId' => 'string', 'cardId' => 'string', 'paymentMethodId' => 'string', 'startDate' => 'string', 'stopDate' => 'string', 'endMonthFlag' => '\OpenAPI\Fincode\Model\EndMonthFlag', 'initialAmount' => 'string', 'initialTax' => 'string', 'remarks' => 'string', 'clientField1' => 'string', 'clientField2' => 'string', 'clientField3' => 'string', 'sendUrl' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['id' => null, 'payType' => null, 'planId' => null, 'customerId' => null, 'cardId' => null, 'paymentMethodId' => null, 'startDate' => null, 'stopDate' => null, 'endMonthFlag' => null, 'initialAmount' => null, 'initialTax' => null, 'remarks' => null, 'clientField1' => null, 'clientField2' => null, 'clientField3' => null, 'sendUrl' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['id' => false, 'payType' => false, 'planId' => false, 'customerId' => false, 'cardId' => false, 'paymentMethodId' => false, 'startDate' => false, 'stopDate' => true, 'endMonthFlag' => false, 'initialAmount' => false, 'initialTax' => false, 'remarks' => true, 'clientField1' => true, 'clientField2' => true, 'clientField3' => true, 'sendUrl' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['id' => 'id', 'payType' => 'pay_type', 'planId' => 'plan_id', 'customerId' => 'customer_id', 'cardId' => 'card_id', 'paymentMethodId' => 'payment_method_id', 'startDate' => 'start_date', 'stopDate' => 'stop_date', 'endMonthFlag' => 'end_month_flag', 'initialAmount' => 'initial_amount', 'initialTax' => 'initial_tax', 'remarks' => 'remarks', 'clientField1' => 'client_field_1', 'clientField2' => 'client_field_2', 'clientField3' => 'client_field_3', 'sendUrl' => 'send_url'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['id' => 'setId', 'payType' => 'setPayType', 'planId' => 'setPlanId', 'customerId' => 'setCustomerId', 'cardId' => 'setCardId', 'paymentMethodId' => 'setPaymentMethodId', 'startDate' => 'setStartDate', 'stopDate' => 'setStopDate', 'endMonthFlag' => 'setEndMonthFlag', 'initialAmount' => 'setInitialAmount', 'initialTax' => 'setInitialTax', 'remarks' => 'setRemarks', 'clientField1' => 'setClientField1', 'clientField2' => 'setClientField2', 'clientField3' => 'setClientField3', 'sendUrl' => 'setSendUrl'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['id' => 'getId', 'payType' => 'getPayType', 'planId' => 'getPlanId', 'customerId' => 'getCustomerId', 'cardId' => 'getCardId', 'paymentMethodId' => 'getPaymentMethodId', 'startDate' => 'getStartDate', 'stopDate' => 'getStopDate', 'endMonthFlag' => 'getEndMonthFlag', 'initialAmount' => 'getInitialAmount', 'initialTax' => 'getInitialTax', 'remarks' => 'getRemarks', 'clientField1' => 'getClientField1', 'clientField2' => 'getClientField2', 'clientField3' => 'getClientField3', 'sendUrl' => 'getSendUrl'];
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (null === $this->container['planId']) {
            $invalidProperties[] = "'planId' can't be null";
        }
        if (mb_strlen($this->container['planId']) > 25) {
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 25) {
            throw new \InvalidArgumentException('invalid length for $id when calling SubscriptionCreatingRequest., must be smaller than or equal to 25.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling SubscriptionCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPlanId(mixed $planId): static
    {
        ...
        if (mb_strlen($planId) > 25) {
            throw new \InvalidArgumentException('invalid length for $planId when calling SubscriptionCreatingRequest., must be smaller than or equal to 25.');
        }
        if (mb_strlen($planId) < 1) {
            throw new \InvalidArgumentException('invalid length for $planId when calling SubscriptionCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling SubscriptionCreatingRequest., must be smaller than or equal to 60.');
        }
        if (mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling SubscriptionCreatingRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets cardId.
     *
     * @param string $cardId カードID \\ （`pay_type = Card`の場合のみ利用可能）\\ このサブスクリプションで請求先となるカードのIDです。\\ 省略した場合、顧客のデフォルトカードが使用されます。
     */
    public function setCardId(mixed $cardId): static
    {
        ...
        if (mb_strlen($cardId) > 25) {
            throw new \InvalidArgumentException('invalid length for $cardId when calling SubscriptionCreatingRequest., must be smaller than or equal to 25.');
        }
        if (mb_strlen($cardId) < 25) {
            throw new \InvalidArgumentException('invalid length for $cardId when calling SubscriptionCreatingRequest., must be bigger than or equal to 25.');
        }
     ...
     *
     * @param string $paymentMethodId 決済手段ID \\ （`pay_type = Directdebit`の場合のみ利用可能）\\ このサブスクリプションで請求先となる決済手段のIDです。\\ 省略した場合、顧客のデフォルト決済手段が使用されます。
     */
    public function setPaymentMethodId(mixed $paymentMethodId): static
    {
        ...
        if (mb_strlen($paymentMethodId) > 25) {
            throw new \InvalidArgumentException('invalid length for $paymentMethodId when calling SubscriptionCreatingRequest., must be smaller than or equal to 25.');
        }
        if (mb_strlen($paymentMethodId) < 25) {
            throw new \InvalidArgumentException('invalid length for $paymentMethodId when calling SubscriptionCreatingRequest., must be bigger than or equal to 25.');
        }
     ...
     * Sets startDate.
     *
     * @param string $startDate 課金開始日\\ サブスクリプションの開始日です。    ※`pay_type = Directdebit`の場合、 サブスクリプションの登録が請求受付終了日の13:00を超えると課金開始日は翌月の同日となります。\\ \\ 形式：`yyyy/MM/dd`
     */
     ...
     * Sets stopDate.
     *
     * @param string|null $stopDate 課金停止日\\ サブスクリプションの停止日です。\\ 省略した場合、無期限となります。\\ \\ 形式：`yyyy/MM/dd`
     */
    ...
    public function setInitialAmount(mixed $initialAmount): static
    {
        ...
        if (mb_strlen($initialAmount) > 7) {
            throw new \InvalidArgumentException('invalid length for $initialAmount when calling SubscriptionCreatingRequest., must be smaller than or equal to 7.');
        }
        if (mb_strlen($initialAmount) < 1) {
            throw new \InvalidArgumentException('invalid length for $initialAmount when calling SubscriptionCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setInitialTax(mixed $initialTax): static
    {
        ...
        if (mb_strlen($initialTax) > 7) {
            throw new \InvalidArgumentException('invalid length for $initialTax when calling SubscriptionCreatingRequest., must be smaller than or equal to 7.');
        }
        if (mb_strlen($initialTax) < 1) {
            throw new \InvalidArgumentException('invalid length for $initialTax when calling SubscriptionCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setRemarks(mixed $remarks): static
    {
        ...
        if (!is_null($remarks) && mb_strlen($remarks) > 9) {
            throw new \InvalidArgumentException('invalid length for $remarks when calling SubscriptionCreatingRequest., must be smaller than or equal to 9.');
        }
        if (!is_null($remarks) && mb_strlen($remarks) < 1) {
            throw new \InvalidArgumentException('invalid length for $remarks when calling SubscriptionCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling SubscriptionCreatingRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling SubscriptionCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling SubscriptionCreatingRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling SubscriptionCreatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling SubscriptionCreatingRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling SubscriptionCreatingRequest., must be bigger than or equal to 1.');
        }
