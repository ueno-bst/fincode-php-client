 ...
 */
class ContentInfoV2 implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'ContentInfo.V2';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['content1Name' => 'string', 'content1Description' => 'string', 'content1UnitPrice' => 'int', 'content2Name' => 'string', 'content2Description' => 'string', 'content2UnitPrice' => 'int', 'content3Name' => 'string', 'content3Description' => 'string', 'content3UnitPrice' => 'int'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['content1Name' => null, 'content1Description' => null, 'content1UnitPrice' => null, 'content2Name' => null, 'content2Description' => null, 'content2UnitPrice' => null, 'content3Name' => null, 'content3Description' => null, 'content3UnitPrice' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['content1Name' => false, 'content1Description' => false, 'content1UnitPrice' => false, 'content2Name' => false, 'content2Description' => false, 'content2UnitPrice' => false, 'content3Name' => false, 'content3Description' => false, 'content3UnitPrice' => false];
    /**
    ...
    public function setContent1Name(mixed $content1Name): static
    {
        ...
        if (mb_strlen($content1Name) > 200) {
            throw new \InvalidArgumentException('invalid length for $content1Name when calling ContentInfoV2., must be smaller than or equal to 200.');
        }
        if (mb_strlen($content1Name) < 1) {
            throw new \InvalidArgumentException('invalid length for $content1Name when calling ContentInfoV2., must be bigger than or equal to 1.');
        }
    ...
    public function setContent1Description(mixed $content1Description): static
    {
        ...
        if (mb_strlen($content1Description) > 200) {
            throw new \InvalidArgumentException('invalid length for $content1Description when calling ContentInfoV2., must be smaller than or equal to 200.');
        }
        if (mb_strlen($content1Description) < 1) {
            throw new \InvalidArgumentException('invalid length for $content1Description when calling ContentInfoV2., must be bigger than or equal to 1.');
        }
    ...
    public function setContent2Name(mixed $content2Name): static
    {
        ...
        if (mb_strlen($content2Name) > 200) {
            throw new \InvalidArgumentException('invalid length for $content2Name when calling ContentInfoV2., must be smaller than or equal to 200.');
        }
        if (mb_strlen($content2Name) < 1) {
            throw new \InvalidArgumentException('invalid length for $content2Name when calling ContentInfoV2., must be bigger than or equal to 1.');
        }
    ...
    public function setContent2Description(mixed $content2Description): static
    {
        ...
        if (mb_strlen($content2Description) > 200) {
            throw new \InvalidArgumentException('invalid length for $content2Description when calling ContentInfoV2., must be smaller than or equal to 200.');
        }
        if (mb_strlen($content2Description) < 1) {
            throw new \InvalidArgumentException('invalid length for $content2Description when calling ContentInfoV2., must be bigger than or equal to 1.');
        }
    ...
    public function setContent3Name(mixed $content3Name): static
    {
        ...
        if (mb_strlen($content3Name) > 200) {
            throw new \InvalidArgumentException('invalid length for $content3Name when calling ContentInfoV2., must be smaller than or equal to 200.');
        }
        if (mb_strlen($content3Name) < 1) {
            throw new \InvalidArgumentException('invalid length for $content3Name when calling ContentInfoV2., must be bigger than or equal to 1.');
        }
    ...
    public function setContent3Description(mixed $content3Description): static
    {
        ...
        if (mb_strlen($content3Description) > 200) {
            throw new \InvalidArgumentException('invalid length for $content3Description when calling ContentInfoV2., must be smaller than or equal to 200.');
        }
        if (mb_strlen($content3Description) < 1) {
            throw new \InvalidArgumentException('invalid length for $content3Description when calling ContentInfoV2., must be bigger than or equal to 1.');
        }
