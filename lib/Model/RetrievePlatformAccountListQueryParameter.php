 ...
 */
class RetrievePlatformAccountListQueryParameter implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'retrievePlatformAccountList_query_parameter';
    /**
