...
class ExaminationInfoContractDetail implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setCorporateNumber(mixed $corporateNumber): static
    {
        ...
        if (!is_null($corporateNumber) && mb_strlen($corporateNumber) > 13) {
            throw new \InvalidArgumentException('invalid length for $corporateNumber when calling ExaminationInfoContractDetail., must be smaller than or equal to 13.');
        }
        if (!is_null($corporateNumber) && mb_strlen($corporateNumber) < 13) {
            throw new \InvalidArgumentException('invalid length for $corporateNumber when calling ExaminationInfoContractDetail., must be bigger than or equal to 13.');
        }
    ...
    public function setCorporateName(mixed $corporateName): static
    {
        ...
        if (!is_null($corporateName) && mb_strlen($corporateName) > 150) {
            throw new \InvalidArgumentException('invalid length for $corporateName when calling ExaminationInfoContractDetail., must be smaller than or equal to 150.');
        }
        if (!is_null($corporateName) && mb_strlen($corporateName) < 1) {
            throw new \InvalidArgumentException('invalid length for $corporateName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setCorporateNameKana(mixed $corporateNameKana): static
    {
        ...
        if (!is_null($corporateNameKana) && mb_strlen($corporateNameKana) > 150) {
            throw new \InvalidArgumentException('invalid length for $corporateNameKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 150.');
        }
        if (!is_null($corporateNameKana) && mb_strlen($corporateNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $corporateNameKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setHp(mixed $hp): static
    {
        ...
        if (!is_null($hp) && mb_strlen($hp) > 300) {
            throw new \InvalidArgumentException('invalid length for $hp when calling ExaminationInfoContractDetail., must be smaller than or equal to 300.');
        }
        if (!is_null($hp) && mb_strlen($hp) < 1) {
            throw new \InvalidArgumentException('invalid length for $hp when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setEstablishedAt(mixed $establishedAt): static
    {
        ...
        if (!is_null($establishedAt) && mb_strlen($establishedAt) > 10) {
            throw new \InvalidArgumentException('invalid length for $establishedAt when calling ExaminationInfoContractDetail., must be smaller than or equal to 10.');
        }
        if (!is_null($establishedAt) && mb_strlen($establishedAt) < 10) {
            throw new \InvalidArgumentException('invalid length for $establishedAt when calling ExaminationInfoContractDetail., must be bigger than or equal to 10.');
        }
    ...
    public function setBusinessDetails(mixed $businessDetails): static
    {
        ...
        if (!is_null($businessDetails) && mb_strlen($businessDetails) > 5000) {
            throw new \InvalidArgumentException('invalid length for $businessDetails when calling ExaminationInfoContractDetail., must be smaller than or equal to 5000.');
        }
        if (!is_null($businessDetails) && mb_strlen($businessDetails) < 1) {
            throw new \InvalidArgumentException('invalid length for $businessDetails when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyPostalCode(mixed $companyPostalCode): static
    {
        ...
        if (!is_null($companyPostalCode) && mb_strlen($companyPostalCode) > 8) {
            throw new \InvalidArgumentException('invalid length for $companyPostalCode when calling ExaminationInfoContractDetail., must be smaller than or equal to 8.');
        }
        if (!is_null($companyPostalCode) && mb_strlen($companyPostalCode) < 8) {
            throw new \InvalidArgumentException('invalid length for $companyPostalCode when calling ExaminationInfoContractDetail., must be bigger than or equal to 8.');
        }
    ...
    public function setCompanyPrefecture(mixed $companyPrefecture): static
    {
        ...
        if (!is_null($companyPrefecture) && mb_strlen($companyPrefecture) > 4) {
            throw new \InvalidArgumentException('invalid length for $companyPrefecture when calling ExaminationInfoContractDetail., must be smaller than or equal to 4.');
        }
        if (!is_null($companyPrefecture) && mb_strlen($companyPrefecture) < 3) {
            throw new \InvalidArgumentException('invalid length for $companyPrefecture when calling ExaminationInfoContractDetail., must be bigger than or equal to 3.');
        }
    ...
    public function setCompanyPrefectureKana(mixed $companyPrefectureKana): static
    {
        ...
        if (!is_null($companyPrefectureKana) && mb_strlen($companyPrefectureKana) > 6) {
            throw new \InvalidArgumentException('invalid length for $companyPrefectureKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 6.');
        }
        if (!is_null($companyPrefectureKana) && mb_strlen($companyPrefectureKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $companyPrefectureKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyAddressMunicipality(mixed $companyAddressMunicipality): static
    {
        ...
        if (!is_null($companyAddressMunicipality) && mb_strlen($companyAddressMunicipality) > 50) {
            throw new \InvalidArgumentException('invalid length for $companyAddressMunicipality when calling ExaminationInfoContractDetail., must be smaller than or equal to 50.');
        }
        if (!is_null($companyAddressMunicipality) && mb_strlen($companyAddressMunicipality) < 1) {
            throw new \InvalidArgumentException('invalid length for $companyAddressMunicipality when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyAddressMunicipalityKana(mixed $companyAddressMunicipalityKana): static
    {
        ...
        if (!is_null($companyAddressMunicipalityKana) && mb_strlen($companyAddressMunicipalityKana) > 100) {
            throw new \InvalidArgumentException('invalid length for $companyAddressMunicipalityKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($companyAddressMunicipalityKana) && mb_strlen($companyAddressMunicipalityKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $companyAddressMunicipalityKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyAddressSection(mixed $companyAddressSection): static
    {
        ...
        if (!is_null($companyAddressSection) && mb_strlen($companyAddressSection) > 50) {
            throw new \InvalidArgumentException('invalid length for $companyAddressSection when calling ExaminationInfoContractDetail., must be smaller than or equal to 50.');
        }
        if (!is_null($companyAddressSection) && mb_strlen($companyAddressSection) < 1) {
            throw new \InvalidArgumentException('invalid length for $companyAddressSection when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyAddressSectionKana(mixed $companyAddressSectionKana): static
    {
        ...
        if (!is_null($companyAddressSectionKana) && mb_strlen($companyAddressSectionKana) > 100) {
            throw new \InvalidArgumentException('invalid length for $companyAddressSectionKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($companyAddressSectionKana) && mb_strlen($companyAddressSectionKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $companyAddressSectionKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyAddressChrome(mixed $companyAddressChrome): static
    {
        ...
        if (!is_null($companyAddressChrome) && mb_strlen($companyAddressChrome) > 100) {
            throw new \InvalidArgumentException('invalid length for $companyAddressChrome when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($companyAddressChrome) && mb_strlen($companyAddressChrome) < 1) {
            throw new \InvalidArgumentException('invalid length for $companyAddressChrome when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyAddressChromeKana(mixed $companyAddressChromeKana): static
    {
        ...
        if (!is_null($companyAddressChromeKana) && mb_strlen($companyAddressChromeKana) > 100) {
            throw new \InvalidArgumentException('invalid length for $companyAddressChromeKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($companyAddressChromeKana) && mb_strlen($companyAddressChromeKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $companyAddressChromeKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyAddressBuildingName(mixed $companyAddressBuildingName): static
    {
        ...
        if (!is_null($companyAddressBuildingName) && mb_strlen($companyAddressBuildingName) > 100) {
            throw new \InvalidArgumentException('invalid length for $companyAddressBuildingName when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($companyAddressBuildingName) && mb_strlen($companyAddressBuildingName) < 1) {
            throw new \InvalidArgumentException('invalid length for $companyAddressBuildingName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyAddressBuildingNameKana(mixed $companyAddressBuildingNameKana): static
    {
        ...
        if (!is_null($companyAddressBuildingNameKana) && mb_strlen($companyAddressBuildingNameKana) > 100) {
            throw new \InvalidArgumentException('invalid length for $companyAddressBuildingNameKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($companyAddressBuildingNameKana) && mb_strlen($companyAddressBuildingNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $companyAddressBuildingNameKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyTel(mixed $companyTel): static
    {
        ...
        if (!is_null($companyTel) && mb_strlen($companyTel) > 15) {
            throw new \InvalidArgumentException('invalid length for $companyTel when calling ExaminationInfoContractDetail., must be smaller than or equal to 15.');
        }
        if (!is_null($companyTel) && mb_strlen($companyTel) < 1) {
            throw new \InvalidArgumentException('invalid length for $companyTel when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeLastName(mixed $representativeLastName): static
    {
        ...
        if (!is_null($representativeLastName) && mb_strlen($representativeLastName) > 20) {
            throw new \InvalidArgumentException('invalid length for $representativeLastName when calling ExaminationInfoContractDetail., must be smaller than or equal to 20.');
        }
        if (!is_null($representativeLastName) && mb_strlen($representativeLastName) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativeLastName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeLastNameKana(mixed $representativeLastNameKana): static
    {
        ...
        if (!is_null($representativeLastNameKana) && mb_strlen($representativeLastNameKana) > 20) {
            throw new \InvalidArgumentException('invalid length for $representativeLastNameKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 20.');
        }
        if (!is_null($representativeLastNameKana) && mb_strlen($representativeLastNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativeLastNameKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeFirstName(mixed $representativeFirstName): static
    {
        ...
        if (!is_null($representativeFirstName) && mb_strlen($representativeFirstName) > 20) {
            throw new \InvalidArgumentException('invalid length for $representativeFirstName when calling ExaminationInfoContractDetail., must be smaller than or equal to 20.');
        }
        if (!is_null($representativeFirstName) && mb_strlen($representativeFirstName) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativeFirstName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeFirstNameKana(mixed $representativeFirstNameKana): static
    {
        ...
        if (!is_null($representativeFirstNameKana) && mb_strlen($representativeFirstNameKana) > 20) {
            throw new \InvalidArgumentException('invalid length for $representativeFirstNameKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 20.');
        }
        if (!is_null($representativeFirstNameKana) && mb_strlen($representativeFirstNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativeFirstNameKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeBirthday(mixed $representativeBirthday): static
    {
        ...
        if (!is_null($representativeBirthday) && is_string($representativeBirthday) && !preg_match('/^\\d{4}\\/\\d{2}\\/\\d{2}$/', $representativeBirthday)) {
            throw new \InvalidArgumentException('invalid value for $representativeBirthday when calling ExaminationInfoContractDetail., must conform to the pattern /^\\d{4}\\/\\d{2}\\/\\d{2}$/.');
        }
    ...
    public function setRepresentativePostalCode(mixed $representativePostalCode): static
    {
        ...
        if (!is_null($representativePostalCode) && mb_strlen($representativePostalCode) > 8) {
            throw new \InvalidArgumentException('invalid length for $representativePostalCode when calling ExaminationInfoContractDetail., must be smaller than or equal to 8.');
        }
        if (!is_null($representativePostalCode) && mb_strlen($representativePostalCode) < 8) {
            throw new \InvalidArgumentException('invalid length for $representativePostalCode when calling ExaminationInfoContractDetail., must be bigger than or equal to 8.');
        }
        if (!is_null($representativePostalCode) && is_string($representativePostalCode) && !preg_match('/^\\d{3}-\\d{4}$/', $representativePostalCode)) {
            throw new \InvalidArgumentException('invalid value for $representativePostalCode when calling ExaminationInfoContractDetail., must conform to the pattern /^\\d{3}-\\d{4}$/.');
        }
    ...
    public function setRepresentativePrefecture(mixed $representativePrefecture): static
    {
        ...
        if (!is_null($representativePrefecture) && mb_strlen($representativePrefecture) > 4) {
            throw new \InvalidArgumentException('invalid length for $representativePrefecture when calling ExaminationInfoContractDetail., must be smaller than or equal to 4.');
        }
        if (!is_null($representativePrefecture) && mb_strlen($representativePrefecture) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativePrefecture when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativePrefectureKana(mixed $representativePrefectureKana): static
    {
        ...
        if (!is_null($representativePrefectureKana) && mb_strlen($representativePrefectureKana) > 6) {
            throw new \InvalidArgumentException('invalid length for $representativePrefectureKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 6.');
        }
        if (!is_null($representativePrefectureKana) && mb_strlen($representativePrefectureKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativePrefectureKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeAddressMunicipality(mixed $representativeAddressMunicipality): static
    {
        ...
        if (!is_null($representativeAddressMunicipality) && mb_strlen($representativeAddressMunicipality) > 50) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressMunicipality when calling ExaminationInfoContractDetail., must be smaller than or equal to 50.');
        }
        if (!is_null($representativeAddressMunicipality) && mb_strlen($representativeAddressMunicipality) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressMunicipality when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeAddressMunicipalityKana(mixed $representativeAddressMunicipalityKana): static
    {
        ...
        if (!is_null($representativeAddressMunicipalityKana) && mb_strlen($representativeAddressMunicipalityKana) > 100) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressMunicipalityKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($representativeAddressMunicipalityKana) && mb_strlen($representativeAddressMunicipalityKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressMunicipalityKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeAddressSection(mixed $representativeAddressSection): static
    {
        ...
        if (!is_null($representativeAddressSection) && mb_strlen($representativeAddressSection) > 50) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressSection when calling ExaminationInfoContractDetail., must be smaller than or equal to 50.');
        }
        if (!is_null($representativeAddressSection) && mb_strlen($representativeAddressSection) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressSection when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeAddressSectionKana(mixed $representativeAddressSectionKana): static
    {
        ...
        if (!is_null($representativeAddressSectionKana) && mb_strlen($representativeAddressSectionKana) > 100) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressSectionKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($representativeAddressSectionKana) && mb_strlen($representativeAddressSectionKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressSectionKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeAddressChrome(mixed $representativeAddressChrome): static
    {
        ...
        if (!is_null($representativeAddressChrome) && mb_strlen($representativeAddressChrome) > 50) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressChrome when calling ExaminationInfoContractDetail., must be smaller than or equal to 50.');
        }
        if (!is_null($representativeAddressChrome) && mb_strlen($representativeAddressChrome) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressChrome when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeAddressChromeKana(mixed $representativeAddressChromeKana): static
    {
        ...
        if (!is_null($representativeAddressChromeKana) && mb_strlen($representativeAddressChromeKana) > 100) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressChromeKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($representativeAddressChromeKana) && mb_strlen($representativeAddressChromeKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressChromeKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeAddressBuildingName(mixed $representativeAddressBuildingName): static
    {
        ...
        if (!is_null($representativeAddressBuildingName) && mb_strlen($representativeAddressBuildingName) > 100) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressBuildingName when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($representativeAddressBuildingName) && mb_strlen($representativeAddressBuildingName) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressBuildingName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeAddressBuildingNameKana(mixed $representativeAddressBuildingNameKana): static
    {
        ...
        if (!is_null($representativeAddressBuildingNameKana) && mb_strlen($representativeAddressBuildingNameKana) > 100) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressBuildingNameKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($representativeAddressBuildingNameKana) && mb_strlen($representativeAddressBuildingNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $representativeAddressBuildingNameKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setRepresentativeTel(mixed $representativeTel): static
    {
        ...
        if (!is_null($representativeTel) && mb_strlen($representativeTel) > 12) {
            throw new \InvalidArgumentException('invalid length for $representativeTel when calling ExaminationInfoContractDetail., must be smaller than or equal to 12.');
        }
        if (!is_null($representativeTel) && mb_strlen($representativeTel) < 11) {
            throw new \InvalidArgumentException('invalid length for $representativeTel when calling ExaminationInfoContractDetail., must be bigger than or equal to 11.');
        }
        if (!is_null($representativeTel) && is_string($representativeTel) && !preg_match('/^\\d{11,12}$/', $representativeTel)) {
            throw new \InvalidArgumentException('invalid value for $representativeTel when calling ExaminationInfoContractDetail., must conform to the pattern /^\\d{11,12}$/.');
        }
    ...
    public function setStaff1LastName(mixed $staff1LastName): static
    {
        ...
        if (!is_null($staff1LastName) && mb_strlen($staff1LastName) > 20) {
            throw new \InvalidArgumentException('invalid length for $staff1LastName when calling ExaminationInfoContractDetail., must be smaller than or equal to 20.');
        }
        if (!is_null($staff1LastName) && mb_strlen($staff1LastName) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff1LastName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setStaff1LastNameKana(mixed $staff1LastNameKana): static
    {
        ...
        if (!is_null($staff1LastNameKana) && mb_strlen($staff1LastNameKana) > 20) {
            throw new \InvalidArgumentException('invalid length for $staff1LastNameKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 20.');
        }
        if (!is_null($staff1LastNameKana) && mb_strlen($staff1LastNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff1LastNameKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setStaff1FirstName(mixed $staff1FirstName): static
    {
        ...
        if (!is_null($staff1FirstName) && mb_strlen($staff1FirstName) > 20) {
            throw new \InvalidArgumentException('invalid length for $staff1FirstName when calling ExaminationInfoContractDetail., must be smaller than or equal to 20.');
        }
        if (!is_null($staff1FirstName) && mb_strlen($staff1FirstName) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff1FirstName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setStaff1FirstNameKana(mixed $staff1FirstNameKana): static
    {
        ...
        if (!is_null($staff1FirstNameKana) && mb_strlen($staff1FirstNameKana) > 20) {
            throw new \InvalidArgumentException('invalid length for $staff1FirstNameKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 20.');
        }
        if (!is_null($staff1FirstNameKana) && mb_strlen($staff1FirstNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff1FirstNameKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setStaff1CompanyName(mixed $staff1CompanyName): static
    {
        ...
        if (!is_null($staff1CompanyName) && mb_strlen($staff1CompanyName) > 150) {
            throw new \InvalidArgumentException('invalid length for $staff1CompanyName when calling ExaminationInfoContractDetail., must be smaller than or equal to 150.');
        }
        if (!is_null($staff1CompanyName) && mb_strlen($staff1CompanyName) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff1CompanyName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setStaff1Belongs(mixed $staff1Belongs): static
    {
        ...
        if (!is_null($staff1Belongs) && mb_strlen($staff1Belongs) > 50) {
            throw new \InvalidArgumentException('invalid length for $staff1Belongs when calling ExaminationInfoContractDetail., must be smaller than or equal to 50.');
        }
        if (!is_null($staff1Belongs) && mb_strlen($staff1Belongs) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff1Belongs when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setStaff1Tel(mixed $staff1Tel): static
    {
        ...
        if (!is_null($staff1Tel) && mb_strlen($staff1Tel) > 12) {
            throw new \InvalidArgumentException('invalid length for $staff1Tel when calling ExaminationInfoContractDetail., must be smaller than or equal to 12.');
        }
        if (!is_null($staff1Tel) && mb_strlen($staff1Tel) < 11) {
            throw new \InvalidArgumentException('invalid length for $staff1Tel when calling ExaminationInfoContractDetail., must be bigger than or equal to 11.');
        }
        if (!is_null($staff1Tel) && is_string($staff1Tel) && !preg_match('/^\\d{11,12}$/', $staff1Tel)) {
            throw new \InvalidArgumentException('invalid value for $staff1Tel when calling ExaminationInfoContractDetail., must conform to the pattern /^\\d{11,12}$/.');
        }
    ...
    public function setStaff1Mail(mixed $staff1Mail): static
    {
        ...
        if (!is_null($staff1Mail) && mb_strlen($staff1Mail) > 254) {
            throw new \InvalidArgumentException('invalid length for $staff1Mail when calling ExaminationInfoContractDetail., must be smaller than or equal to 254.');
        }
        if (!is_null($staff1Mail) && mb_strlen($staff1Mail) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff1Mail when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setStaff2LastName(mixed $staff2LastName): static
    {
        ...
        if (!is_null($staff2LastName) && mb_strlen($staff2LastName) > 20) {
            throw new \InvalidArgumentException('invalid length for $staff2LastName when calling ExaminationInfoContractDetail., must be smaller than or equal to 20.');
        }
        if (!is_null($staff2LastName) && mb_strlen($staff2LastName) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff2LastName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setStaff2LastNameKana(mixed $staff2LastNameKana): static
    {
        ...
        if (!is_null($staff2LastNameKana) && mb_strlen($staff2LastNameKana) > 20) {
            throw new \InvalidArgumentException('invalid length for $staff2LastNameKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 20.');
        }
        if (!is_null($staff2LastNameKana) && mb_strlen($staff2LastNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff2LastNameKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setStaff2FirstName(mixed $staff2FirstName): static
    {
        ...
        if (!is_null($staff2FirstName) && mb_strlen($staff2FirstName) > 20) {
            throw new \InvalidArgumentException('invalid length for $staff2FirstName when calling ExaminationInfoContractDetail., must be smaller than or equal to 20.');
        }
        if (!is_null($staff2FirstName) && mb_strlen($staff2FirstName) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff2FirstName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setStaff2FirstNameKana(mixed $staff2FirstNameKana): static
    {
        ...
        if (!is_null($staff2FirstNameKana) && mb_strlen($staff2FirstNameKana) > 20) {
            throw new \InvalidArgumentException('invalid length for $staff2FirstNameKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 20.');
        }
        if (!is_null($staff2FirstNameKana) && mb_strlen($staff2FirstNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff2FirstNameKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setStaff2CompanyName(mixed $staff2CompanyName): static
    {
        ...
        if (!is_null($staff2CompanyName) && mb_strlen($staff2CompanyName) > 150) {
            throw new \InvalidArgumentException('invalid length for $staff2CompanyName when calling ExaminationInfoContractDetail., must be smaller than or equal to 150.');
        }
        if (!is_null($staff2CompanyName) && mb_strlen($staff2CompanyName) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff2CompanyName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setStaff2Belongs(mixed $staff2Belongs): static
    {
        ...
        if (!is_null($staff2Belongs) && mb_strlen($staff2Belongs) > 50) {
            throw new \InvalidArgumentException('invalid length for $staff2Belongs when calling ExaminationInfoContractDetail., must be smaller than or equal to 50.');
        }
        if (!is_null($staff2Belongs) && mb_strlen($staff2Belongs) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff2Belongs when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setStaff2Tel(mixed $staff2Tel): static
    {
        ...
        if (!is_null($staff2Tel) && mb_strlen($staff2Tel) > 12) {
            throw new \InvalidArgumentException('invalid length for $staff2Tel when calling ExaminationInfoContractDetail., must be smaller than or equal to 12.');
        }
        if (!is_null($staff2Tel) && mb_strlen($staff2Tel) < 11) {
            throw new \InvalidArgumentException('invalid length for $staff2Tel when calling ExaminationInfoContractDetail., must be bigger than or equal to 11.');
        }
        if (!is_null($staff2Tel) && is_string($staff2Tel) && !preg_match('/^\\d{11,12}$/', $staff2Tel)) {
            throw new \InvalidArgumentException('invalid value for $staff2Tel when calling ExaminationInfoContractDetail., must conform to the pattern /^\\d{11,12}$/.');
        }
    ...
    public function setStaff2Mail(mixed $staff2Mail): static
    {
        ...
        if (!is_null($staff2Mail) && mb_strlen($staff2Mail) > 254) {
            throw new \InvalidArgumentException('invalid length for $staff2Mail when calling ExaminationInfoContractDetail., must be smaller than or equal to 254.');
        }
        if (!is_null($staff2Mail) && mb_strlen($staff2Mail) < 1) {
            throw new \InvalidArgumentException('invalid length for $staff2Mail when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setUrl(mixed $url): static
    {
        ...
        if (!is_null($url) && mb_strlen($url) > 300) {
            throw new \InvalidArgumentException('invalid length for $url when calling ExaminationInfoContractDetail., must be smaller than or equal to 300.');
        }
        if (!is_null($url) && mb_strlen($url) < 1) {
            throw new \InvalidArgumentException('invalid length for $url when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setSiteCredential(mixed $siteCredential): static
    {
        ...
        if (!is_null($siteCredential) && mb_strlen($siteCredential) > 100) {
            throw new \InvalidArgumentException('invalid length for $siteCredential when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($siteCredential) && mb_strlen($siteCredential) < 1) {
            throw new \InvalidArgumentException('invalid length for $siteCredential when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopName(mixed $shopName): static
    {
        ...
        if (!is_null($shopName) && mb_strlen($shopName) > 100) {
            throw new \InvalidArgumentException('invalid length for $shopName when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($shopName) && mb_strlen($shopName) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopNameKana(mixed $shopNameKana): static
    {
        ...
        if (!is_null($shopNameKana) && mb_strlen($shopNameKana) > 100) {
            throw new \InvalidArgumentException('invalid length for $shopNameKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($shopNameKana) && mb_strlen($shopNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopNameKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopNameEn(mixed $shopNameEn): static
    {
        ...
        if (!is_null($shopNameEn) && mb_strlen($shopNameEn) > 25) {
            throw new \InvalidArgumentException('invalid length for $shopNameEn when calling ExaminationInfoContractDetail., must be smaller than or equal to 25.');
        }
        if (!is_null($shopNameEn) && mb_strlen($shopNameEn) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopNameEn when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopDistributorName(mixed $shopDistributorName): static
    {
        ...
        if (!is_null($shopDistributorName) && mb_strlen($shopDistributorName) > 300) {
            throw new \InvalidArgumentException('invalid length for $shopDistributorName when calling ExaminationInfoContractDetail., must be smaller than or equal to 300.');
        }
        if (!is_null($shopDistributorName) && mb_strlen($shopDistributorName) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopDistributorName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopSalesManagerName(mixed $shopSalesManagerName): static
    {
        ...
        if (!is_null($shopSalesManagerName) && mb_strlen($shopSalesManagerName) > 300) {
            throw new \InvalidArgumentException('invalid length for $shopSalesManagerName when calling ExaminationInfoContractDetail., must be smaller than or equal to 300.');
        }
        if (!is_null($shopSalesManagerName) && mb_strlen($shopSalesManagerName) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopSalesManagerName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopServiceName(mixed $shopServiceName): static
    {
        ...
        if (!is_null($shopServiceName) && mb_strlen($shopServiceName) > 300) {
            throw new \InvalidArgumentException('invalid length for $shopServiceName when calling ExaminationInfoContractDetail., must be smaller than or equal to 300.');
        }
        if (!is_null($shopServiceName) && mb_strlen($shopServiceName) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopServiceName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopSupportTel(mixed $shopSupportTel): static
    {
        ...
        if (!is_null($shopSupportTel) && mb_strlen($shopSupportTel) > 15) {
            throw new \InvalidArgumentException('invalid length for $shopSupportTel when calling ExaminationInfoContractDetail., must be smaller than or equal to 15.');
        }
        if (!is_null($shopSupportTel) && mb_strlen($shopSupportTel) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopSupportTel when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopSupportMail(mixed $shopSupportMail): static
    {
        ...
        if (!is_null($shopSupportMail) && mb_strlen($shopSupportMail) > 254) {
            throw new \InvalidArgumentException('invalid length for $shopSupportMail when calling ExaminationInfoContractDetail., must be smaller than or equal to 254.');
        }
        if (!is_null($shopSupportMail) && mb_strlen($shopSupportMail) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopSupportMail when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopPostCode(mixed $shopPostCode): static
    {
        ...
        if (!is_null($shopPostCode) && mb_strlen($shopPostCode) > 8) {
            throw new \InvalidArgumentException('invalid length for $shopPostCode when calling ExaminationInfoContractDetail., must be smaller than or equal to 8.');
        }
        if (!is_null($shopPostCode) && mb_strlen($shopPostCode) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopPostCode when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopPrefecture(mixed $shopPrefecture): static
    {
        ...
        if (!is_null($shopPrefecture) && mb_strlen($shopPrefecture) > 4) {
            throw new \InvalidArgumentException('invalid length for $shopPrefecture when calling ExaminationInfoContractDetail., must be smaller than or equal to 4.');
        }
        if (!is_null($shopPrefecture) && mb_strlen($shopPrefecture) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopPrefecture when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopAddressMunicipality(mixed $shopAddressMunicipality): static
    {
        ...
        if (!is_null($shopAddressMunicipality) && mb_strlen($shopAddressMunicipality) > 50) {
            throw new \InvalidArgumentException('invalid length for $shopAddressMunicipality when calling ExaminationInfoContractDetail., must be smaller than or equal to 50.');
        }
        if (!is_null($shopAddressMunicipality) && mb_strlen($shopAddressMunicipality) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopAddressMunicipality when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopAddressSection(mixed $shopAddressSection): static
    {
        ...
        if (!is_null($shopAddressSection) && mb_strlen($shopAddressSection) > 50) {
            throw new \InvalidArgumentException('invalid length for $shopAddressSection when calling ExaminationInfoContractDetail., must be smaller than or equal to 50.');
        }
        if (!is_null($shopAddressSection) && mb_strlen($shopAddressSection) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopAddressSection when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopAddressChrome(mixed $shopAddressChrome): static
    {
        ...
        if (!is_null($shopAddressChrome) && mb_strlen($shopAddressChrome) > 50) {
            throw new \InvalidArgumentException('invalid length for $shopAddressChrome when calling ExaminationInfoContractDetail., must be smaller than or equal to 50.');
        }
        if (!is_null($shopAddressChrome) && mb_strlen($shopAddressChrome) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopAddressChrome when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopAddressBuildingName(mixed $shopAddressBuildingName): static
    {
        ...
        if (!is_null($shopAddressBuildingName) && mb_strlen($shopAddressBuildingName) > 100) {
            throw new \InvalidArgumentException('invalid length for $shopAddressBuildingName when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($shopAddressBuildingName) && mb_strlen($shopAddressBuildingName) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopAddressBuildingName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopAddressBuildingNameKana(mixed $shopAddressBuildingNameKana): static
    {
        ...
        if (!is_null($shopAddressBuildingNameKana) && mb_strlen($shopAddressBuildingNameKana) > 100) {
            throw new \InvalidArgumentException('invalid length for $shopAddressBuildingNameKana when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($shopAddressBuildingNameKana) && mb_strlen($shopAddressBuildingNameKana) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopAddressBuildingNameKana when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopPaymentMethod(mixed $shopPaymentMethod): static
    {
        ...
        if (!is_null($shopPaymentMethod) && mb_strlen($shopPaymentMethod) > 1000) {
            throw new \InvalidArgumentException('invalid length for $shopPaymentMethod when calling ExaminationInfoContractDetail., must be smaller than or equal to 1000.');
        }
        if (!is_null($shopPaymentMethod) && mb_strlen($shopPaymentMethod) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopPaymentMethod when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopChargeDescription(mixed $shopChargeDescription): static
    {
        ...
        if (!is_null($shopChargeDescription) && mb_strlen($shopChargeDescription) > 5000) {
            throw new \InvalidArgumentException('invalid length for $shopChargeDescription when calling ExaminationInfoContractDetail., must be smaller than or equal to 5000.');
        }
        if (!is_null($shopChargeDescription) && mb_strlen($shopChargeDescription) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopChargeDescription when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopProductDelieveryTime(mixed $shopProductDelieveryTime): static
    {
        ...
        if (!is_null($shopProductDelieveryTime) && mb_strlen($shopProductDelieveryTime) > 1000) {
            throw new \InvalidArgumentException('invalid length for $shopProductDelieveryTime when calling ExaminationInfoContractDetail., must be smaller than or equal to 1000.');
        }
        if (!is_null($shopProductDelieveryTime) && mb_strlen($shopProductDelieveryTime) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopProductDelieveryTime when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setShopReturnGoodsHandingConditions(mixed $shopReturnGoodsHandingConditions): static
    {
        ...
        if (!is_null($shopReturnGoodsHandingConditions) && mb_strlen($shopReturnGoodsHandingConditions) > 5000) {
            throw new \InvalidArgumentException('invalid length for $shopReturnGoodsHandingConditions when calling ExaminationInfoContractDetail., must be smaller than or equal to 5000.');
        }
        if (!is_null($shopReturnGoodsHandingConditions) && mb_strlen($shopReturnGoodsHandingConditions) < 1) {
            throw new \InvalidArgumentException('invalid length for $shopReturnGoodsHandingConditions when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setPlatformName(mixed $platformName): static
    {
        ...
        if (!is_null($platformName) && mb_strlen($platformName) > 100) {
            throw new \InvalidArgumentException('invalid length for $platformName when calling ExaminationInfoContractDetail., must be smaller than or equal to 100.');
        }
        if (!is_null($platformName) && mb_strlen($platformName) < 1) {
            throw new \InvalidArgumentException('invalid length for $platformName when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setSupportTel(mixed $supportTel): static
    {
        ...
        if (!is_null($supportTel) && mb_strlen($supportTel) > 15) {
            throw new \InvalidArgumentException('invalid length for $supportTel when calling ExaminationInfoContractDetail., must be smaller than or equal to 15.');
        }
        if (!is_null($supportTel) && mb_strlen($supportTel) < 1) {
            throw new \InvalidArgumentException('invalid length for $supportTel when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setSupportMail(mixed $supportMail): static
    {
        ...
        if (!is_null($supportMail) && mb_strlen($supportMail) > 254) {
            throw new \InvalidArgumentException('invalid length for $supportMail when calling ExaminationInfoContractDetail., must be smaller than or equal to 254.');
        }
        if (!is_null($supportMail) && mb_strlen($supportMail) < 1) {
            throw new \InvalidArgumentException('invalid length for $supportMail when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setContentDescription(mixed $contentDescription): static
    {
        ...
        if (!is_null($contentDescription) && mb_strlen($contentDescription) > 5000) {
            throw new \InvalidArgumentException('invalid length for $contentDescription when calling ExaminationInfoContractDetail., must be smaller than or equal to 5000.');
        }
        if (!is_null($contentDescription) && mb_strlen($contentDescription) < 1) {
            throw new \InvalidArgumentException('invalid length for $contentDescription when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setExpirationDateOfPoint(mixed $expirationDateOfPoint): static
    {
        ...
        if (!is_null($expirationDateOfPoint) && mb_strlen($expirationDateOfPoint) > 300) {
            throw new \InvalidArgumentException('invalid length for $expirationDateOfPoint when calling ExaminationInfoContractDetail., must be smaller than or equal to 300.');
        }
        if (!is_null($expirationDateOfPoint) && mb_strlen($expirationDateOfPoint) < 1) {
            throw new \InvalidArgumentException('invalid length for $expirationDateOfPoint when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
    ...
    public function setUsageOfPoint(mixed $usageOfPoint): static
    {
        ...
        if (!is_null($usageOfPoint) && mb_strlen($usageOfPoint) > 300) {
            throw new \InvalidArgumentException('invalid length for $usageOfPoint when calling ExaminationInfoContractDetail., must be smaller than or equal to 300.');
        }
        if (!is_null($usageOfPoint) && mb_strlen($usageOfPoint) < 1) {
            throw new \InvalidArgumentException('invalid length for $usageOfPoint when calling ExaminationInfoContractDetail., must be bigger than or equal to 1.');
        }
     ...
     * Sets lostTrial.
     *
     * @param bool|null $lostTrial 改正割賦販売法に基づく訴訟敗訴歴があるかどうかの表明  - `true`: 改正割賦販売法に基づく訴訟敗訴歴がない - `false`: 改正割賦販売法に基づく訴訟敗訴歴がある
     */
