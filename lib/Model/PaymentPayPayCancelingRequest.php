 ...
 */
class PaymentPayPayCancelingRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Payment.PayPay.Canceling.Request';
    /**
     ...
     */
    protected static array $openAPIFormats = ['payType' => null, 'accessId' => null, 'cancelDescription' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['payType' => false, 'accessId' => false, 'cancelDescription' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['payType' => 'pay_type', 'accessId' => 'access_id', 'cancelDescription' => 'cancel_description'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['payType' => 'setPayType', 'accessId' => 'setAccessId', 'cancelDescription' => 'setCancelDescription'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['payType' => 'getPayType', 'accessId' => 'getAccessId', 'cancelDescription' => 'getCancelDescription'];
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentPayPayCancelingRequest., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling PaymentPayPayCancelingRequest., must be bigger than or equal to 24.');
        }
    ...
    public function setCancelDescription(mixed $cancelDescription): static
    {
        ...
        if (!is_null($cancelDescription) && mb_strlen($cancelDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $cancelDescription when calling PaymentPayPayCancelingRequest., must be smaller than or equal to 100.');
        }
