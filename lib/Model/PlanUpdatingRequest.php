 ...
 */
class PlanUpdatingRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Plan.Updating.Request';
    /**
     ...
     */
    protected static array $openAPIFormats = ['planName' => null, 'description' => null, 'amount' => null, 'tax' => null, 'intervalPattern' => null, 'intervalCount' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['planName' => false, 'description' => true, 'amount' => false, 'tax' => false, 'intervalPattern' => false, 'intervalCount' => false];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['planName' => 'plan_name', 'description' => 'description', 'amount' => 'amount', 'tax' => 'tax', 'intervalPattern' => 'interval_pattern', 'intervalCount' => 'interval_count'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['planName' => 'setPlanName', 'description' => 'setDescription', 'amount' => 'setAmount', 'tax' => 'setTax', 'intervalPattern' => 'setIntervalPattern', 'intervalCount' => 'setIntervalCount'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['planName' => 'getPlanName', 'description' => 'getDescription', 'amount' => 'getAmount', 'tax' => 'getTax', 'intervalPattern' => 'getIntervalPattern', 'intervalCount' => 'getIntervalCount'];
    ...
    public function setPlanName(mixed $planName): static
    {
        ...
        if (mb_strlen($planName) > 200) {
            throw new \InvalidArgumentException('invalid length for $planName when calling PlanUpdatingRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setDescription(mixed $description): static
    {
        ...
        if (!is_null($description) && mb_strlen($description) > 400) {
            throw new \InvalidArgumentException('invalid length for $description when calling PlanUpdatingRequest., must be smaller than or equal to 400.');
        }
    ...
    public function setAmount(mixed $amount): static
    {
        ...
        if (mb_strlen($amount) > 7) {
            throw new \InvalidArgumentException('invalid length for $amount when calling PlanUpdatingRequest., must be smaller than or equal to 7.');
        }
        if (mb_strlen($amount) < 1) {
            throw new \InvalidArgumentException('invalid length for $amount when calling PlanUpdatingRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTax(mixed $tax): static
    {
        ...
        if (mb_strlen($tax) > 7) {
            throw new \InvalidArgumentException('invalid length for $tax when calling PlanUpdatingRequest., must be smaller than or equal to 7.');
        }
        if (mb_strlen($tax) < 1) {
            throw new \InvalidArgumentException('invalid length for $tax when calling PlanUpdatingRequest., must be bigger than or equal to 1.');
        }
