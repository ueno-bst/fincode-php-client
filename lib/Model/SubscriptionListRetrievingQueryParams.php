 ...
 */
class SubscriptionListRetrievingQueryParams implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Subscription.ListRetrieving.QueryParams';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['payType' => '\OpenAPI\Fincode\Model\SubscriptionPayType', 'id' => 'string', 'customerId' => 'string', 'planId' => 'string', 'status' => '\OpenAPI\Fincode\Model\SubscriptionStatus', 'totalAmountMin' => 'int', 'totalAmountMax' => 'int', 'intervalPattern' => '\OpenAPI\Fincode\Model\PropertiesIntervalPattern', 'startDateFrom' => 'string', 'startDateTo' => 'string', 'stopDateFrom' => 'string', 'stopDateTo' => 'string', 'nextChargeDateFrom' => 'string', 'nextChargeDateTo' => 'string', 'updateDateFrom' => 'string', 'updateDateTo' => 'string', 'sort' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['payType' => null, 'id' => null, 'customerId' => null, 'planId' => null, 'status' => null, 'totalAmountMin' => 'int64', 'totalAmountMax' => 'int64', 'intervalPattern' => null, 'startDateFrom' => null, 'startDateTo' => null, 'stopDateFrom' => null, 'stopDateTo' => null, 'nextChargeDateFrom' => null, 'nextChargeDateTo' => null, 'updateDateFrom' => null, 'updateDateTo' => null, 'sort' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['payType' => false, 'id' => false, 'customerId' => false, 'planId' => false, 'status' => false, 'totalAmountMin' => false, 'totalAmountMax' => false, 'intervalPattern' => false, 'startDateFrom' => false, 'startDateTo' => false, 'stopDateFrom' => false, 'stopDateTo' => false, 'nextChargeDateFrom' => false, 'nextChargeDateTo' => false, 'updateDateFrom' => false, 'updateDateTo' => false, 'sort' => true];
    /**
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 25) {
            throw new \InvalidArgumentException('invalid length for $id when calling SubscriptionListRetrievingQueryParams., must be smaller than or equal to 25.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling SubscriptionListRetrievingQueryParams., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling SubscriptionListRetrievingQueryParams., must be smaller than or equal to 60.');
        }
        if (mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling SubscriptionListRetrievingQueryParams., must be bigger than or equal to 1.');
        }
    ...
    public function setPlanId(mixed $planId): static
    {
        ...
        if (mb_strlen($planId) > 25) {
            throw new \InvalidArgumentException('invalid length for $planId when calling SubscriptionListRetrievingQueryParams., must be smaller than or equal to 25.');
        }
        if (mb_strlen($planId) < 1) {
            throw new \InvalidArgumentException('invalid length for $planId when calling SubscriptionListRetrievingQueryParams., must be bigger than or equal to 1.');
        }
