...
class CapturePaymentRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static string $openAPIModelName = 'capturePayment_request';
    /**
     * Array of property to type mappings. Used for (de)serialization.
     *
     * @var array<string, string>
     */
    protected static array $openAPITypes = ['payType' => '\OpenAPI\Fincode\Model\PayType', 'accessId' => 'string', 'method' => '\OpenAPI\Fincode\Model\CardPayMethod', 'payTimes' => '\OpenAPI\Fincode\Model\CardPayTimes', 'captureDescription' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization.
     *
     * @var array<string, string|null>
     */
    protected static array $openAPIFormats = ['payType' => null, 'accessId' => null, 'method' => null, 'payTimes' => null, 'captureDescription' => null];
    /**
     * Array of nullable properties. Used for (de)serialization.
     *
     * @var array<string, bool>
     */
    protected static array $openAPINullables = ['payType' => false, 'accessId' => false, 'method' => false, 'payTimes' => true, 'captureDescription' => true];
    /**
     ...
     * @var array<string, string>
     */
    protected static array $attributeMap = ['payType' => 'pay_type', 'accessId' => 'access_id', 'method' => 'method', 'payTimes' => 'pay_times', 'captureDescription' => 'capture_description'];
    /**
     * Array of attributes to setter functions (for deserialization of responses).
     *
     * @var array<string, string>
     */
    protected static array $setters = ['payType' => 'setPayType', 'accessId' => 'setAccessId', 'method' => 'setMethod', 'payTimes' => 'setPayTimes', 'captureDescription' => 'setCaptureDescription'];
    /**
     * Array of attributes to getter functions (for serialization of requests).
     *
     * @var array<string, string>
     */
    protected static array $getters = ['payType' => 'getPayType', 'accessId' => 'getAccessId', 'method' => 'getMethod', 'payTimes' => 'getPayTimes', 'captureDescription' => 'getCaptureDescription'];
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling CapturePaymentRequest., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling CapturePaymentRequest., must be bigger than or equal to 24.');
        }
     ...
     * Sets method.
     *
     * @param CardPayMethod $method 支払方法\\ `CANCELED`ステータスの決済に対して指定ができます。  - `1`: 一括払い - `2`: 分割払い - `5`: リボ払い
     */
     ...
     * Sets payTimes.
     *
     * @param CardPayTimes|null $payTimes （分割払いの場合）支払回数\\ `CANCELED`ステータスの決済に対して指定ができます。\\ \\ 指定可能な値： `3`, `5`, `6`, `10`, `12`, `15`, `18`, `20`, `24`
     */
    ...
    public function setCaptureDescription(mixed $captureDescription): static
    {
        ...
        if (!is_null($captureDescription) && mb_strlen($captureDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $captureDescription when calling CapturePaymentRequest., must be smaller than or equal to 100.');
        }
