 ...
 */
class PlanRetrievingResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'Plan.Retrieving.Response';
    /**
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 25) {
            throw new \InvalidArgumentException('invalid length for $id when calling PlanRetrievingResponse., must be smaller than or equal to 25.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling PlanRetrievingResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setPlanName(mixed $planName): static
    {
        ...
        if (mb_strlen($planName) > 200) {
            throw new \InvalidArgumentException('invalid length for $planName when calling PlanRetrievingResponse., must be smaller than or equal to 200.');
        }
    ...
    public function setDescription(mixed $description): static
    {
        ...
        if (!is_null($description) && mb_strlen($description) > 400) {
            throw new \InvalidArgumentException('invalid length for $description when calling PlanRetrievingResponse., must be smaller than or equal to 400.');
        }
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PlanRetrievingResponse., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling PlanRetrievingResponse., must be bigger than or equal to 13.');
        }
