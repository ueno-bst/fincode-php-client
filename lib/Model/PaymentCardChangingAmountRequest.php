...
class PaymentCardChangingAmountRequest implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     */
    protected static array $openAPITypes = ['payType' => '\Fincode\OpenAPI\Model\PayType', 'accessId' => 'string', 'amount' => 'string', 'tax' => 'string', 'jobCode' => '\Fincode\OpenAPI\Model\CardPaymentJobCode'];
    /**
