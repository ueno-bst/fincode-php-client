 ...
 */
class CapturePayment200Response implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    protected static string $openAPIModelName = 'capturePayment_200_response';
    /**
     ...
     */
    protected static array $openAPIFormats = ['shopId' => null, 'id' => null, 'accessId' => null, 'amount' => null, 'tax' => null, 'totalAmount' => 'int64', 'clientField1' => null, 'clientField2' => null, 'clientField3' => null, 'processDate' => null, 'customerId' => null, 'customerGroupId' => null, 'errorCode' => null, 'created' => null, 'updated' => null, 'payType' => null, 'jobCode' => null, 'status' => null, 'cardId' => null, 'brand' => null, 'cardNo' => null, 'expire' => null, 'holderName' => null, 'cardNoHash' => null, 'method' => null, 'payTimes' => null, 'bulkPaymentId' => null, 'subscriptionId' => null, 'tdsType' => null, 'tds2Type' => null, 'tds2RetUrl' => null, 'returnUrl' => null, 'returnUrlOnFailure' => null, 'tds2Status' => null, 'merchantName' => null, 'forward' => null, 'issuer' => null, 'transactionId' => null, 'approve' => null, 'authMaxDate' => null, 'itemCode' => null, 'sendUrl' => null, 'acs' => null, 'codeUrl' => null, 'codeExpiryDate' => null, 'redirectUrl' => null, 'redirectType' => null, 'orderDescription' => null, 'captureDescription' => null, 'updateDescription' => null, 'cancelDescription' => null, 'storeId' => null, 'codeId' => null, 'paymentId' => null, 'paypayResultCode' => null, 'merchantPaymentId' => null, 'merchantCaptureId' => null, 'merchantUpdateId' => null, 'merchantRevertId' => null, 'merchantRefundId' => null, 'paymentDate' => null];
    /**
    ...
    public function setShopId(mixed $shopId): static
    {
        ...
        if (mb_strlen($shopId) > 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling CapturePayment200Response., must be smaller than or equal to 13.');
        }
        if (mb_strlen($shopId) < 13) {
            throw new \InvalidArgumentException('invalid length for $shopId when calling CapturePayment200Response., must be bigger than or equal to 13.');
        }
    ...
    public function setId(mixed $id): static
    {
        ...
        if (mb_strlen($id) > 30) {
            throw new \InvalidArgumentException('invalid length for $id when calling CapturePayment200Response., must be smaller than or equal to 30.');
        }
        if (mb_strlen($id) < 1) {
            throw new \InvalidArgumentException('invalid length for $id when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setAccessId(mixed $accessId): static
    {
        ...
        if (mb_strlen($accessId) > 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling CapturePayment200Response., must be smaller than or equal to 24.');
        }
        if (mb_strlen($accessId) < 24) {
            throw new \InvalidArgumentException('invalid length for $accessId when calling CapturePayment200Response., must be bigger than or equal to 24.');
        }
    ...
    public function setClientField1(mixed $clientField1): static
    {
        ...
        if (!is_null($clientField1) && mb_strlen($clientField1) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling CapturePayment200Response., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField1) && mb_strlen($clientField1) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField1 when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField2(mixed $clientField2): static
    {
        ...
        if (!is_null($clientField2) && mb_strlen($clientField2) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling CapturePayment200Response., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField2) && mb_strlen($clientField2) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField2 when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setClientField3(mixed $clientField3): static
    {
        ...
        if (!is_null($clientField3) && mb_strlen($clientField3) > 100) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling CapturePayment200Response., must be smaller than or equal to 100.');
        }
        if (!is_null($clientField3) && mb_strlen($clientField3) < 1) {
            throw new \InvalidArgumentException('invalid length for $clientField3 when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId(mixed $customerId): static
    {
        ...
        if (!is_null($customerId) && mb_strlen($customerId) > 60) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling CapturePayment200Response., must be smaller than or equal to 60.');
        }
        if (!is_null($customerId) && mb_strlen($customerId) < 1) {
            throw new \InvalidArgumentException('invalid length for $customerId when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId(mixed $customerGroupId): static
    {
        ...
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) > 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling CapturePayment200Response., must be smaller than or equal to 13.');
        }
        if (!is_null($customerGroupId) && mb_strlen($customerGroupId) < 13) {
            throw new \InvalidArgumentException('invalid length for $customerGroupId when calling CapturePayment200Response., must be bigger than or equal to 13.');
        }
    ...
    public function setErrorCode(mixed $errorCode): static
    {
        ...
        if (!is_null($errorCode) && mb_strlen($errorCode) > 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling CapturePayment200Response., must be smaller than or equal to 11.');
        }
        if (!is_null($errorCode) && mb_strlen($errorCode) < 11) {
            throw new \InvalidArgumentException('invalid length for $errorCode when calling CapturePayment200Response., must be bigger than or equal to 11.');
        }
    ...
    public function setCardId(mixed $cardId): static
    {
        ...
        if (!is_null($cardId) && mb_strlen($cardId) > 25) {
            throw new \InvalidArgumentException('invalid length for $cardId when calling CapturePayment200Response., must be smaller than or equal to 25.');
        }
        if (!is_null($cardId) && mb_strlen($cardId) < 25) {
            throw new \InvalidArgumentException('invalid length for $cardId when calling CapturePayment200Response., must be bigger than or equal to 25.');
        }
    ...
    public function setCardNo(mixed $cardNo): static
    {
        ...
        if (!is_null($cardNo) && mb_strlen($cardNo) > 16) {
            throw new \InvalidArgumentException('invalid length for $cardNo when calling CapturePayment200Response., must be smaller than or equal to 16.');
        }
    ...
    public function setExpire(mixed $expire): static
    {
        ...
        if (!is_null($expire) && mb_strlen($expire) > 4) {
            throw new \InvalidArgumentException('invalid length for $expire when calling CapturePayment200Response., must be smaller than or equal to 4.');
        }
        if (!is_null($expire) && mb_strlen($expire) < 4) {
            throw new \InvalidArgumentException('invalid length for $expire when calling CapturePayment200Response., must be bigger than or equal to 4.');
        }
        if (!is_null($expire) && is_string($expire) && !preg_match('/^\\d{2}\\d{2}$/', $expire)) {
            throw new \InvalidArgumentException('invalid value for $expire when calling CapturePayment200Response., must conform to the pattern /^\\d{2}\\d{2}$/.');
        }
    ...
    public function setHolderName(mixed $holderName): static
    {
        ...
        if (!is_null($holderName) && mb_strlen($holderName) > 50) {
            throw new \InvalidArgumentException('invalid length for $holderName when calling CapturePayment200Response., must be smaller than or equal to 50.');
        }
        if (!is_null($holderName) && mb_strlen($holderName) < 1) {
            throw new \InvalidArgumentException('invalid length for $holderName when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setCardNoHash(mixed $cardNoHash): static
    {
        ...
        if (!is_null($cardNoHash) && mb_strlen($cardNoHash) > 64) {
            throw new \InvalidArgumentException('invalid length for $cardNoHash when calling CapturePayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($cardNoHash) && mb_strlen($cardNoHash) < 1) {
            throw new \InvalidArgumentException('invalid length for $cardNoHash when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setBulkPaymentId(mixed $bulkPaymentId): static
    {
        ...
        if (!is_null($bulkPaymentId) && mb_strlen($bulkPaymentId) > 25) {
            throw new \InvalidArgumentException('invalid length for $bulkPaymentId when calling CapturePayment200Response., must be smaller than or equal to 25.');
        }
        if (!is_null($bulkPaymentId) && mb_strlen($bulkPaymentId) < 25) {
            throw new \InvalidArgumentException('invalid length for $bulkPaymentId when calling CapturePayment200Response., must be bigger than or equal to 25.');
        }
    ...
    public function setSubscriptionId(mixed $subscriptionId): static
    {
        ...
        if (!is_null($subscriptionId) && mb_strlen($subscriptionId) > 25) {
            throw new \InvalidArgumentException('invalid length for $subscriptionId when calling CapturePayment200Response., must be smaller than or equal to 25.');
        }
        if (!is_null($subscriptionId) && mb_strlen($subscriptionId) < 1) {
            throw new \InvalidArgumentException('invalid length for $subscriptionId when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setTds2RetUrl(mixed $tds2RetUrl): static
    {
        ...
        if (!is_null($tds2RetUrl) && mb_strlen($tds2RetUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $tds2RetUrl when calling CapturePayment200Response., must be smaller than or equal to 256.');
        }
    ...
    public function setReturnUrl(mixed $returnUrl): static
    {
        ...
        if (!is_null($returnUrl) && mb_strlen($returnUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $returnUrl when calling CapturePayment200Response., must be smaller than or equal to 256.');
        }
    ...
    public function setReturnUrlOnFailure(mixed $returnUrlOnFailure): static
    {
        ...
        if (!is_null($returnUrlOnFailure) && mb_strlen($returnUrlOnFailure) > 256) {
            throw new \InvalidArgumentException('invalid length for $returnUrlOnFailure when calling CapturePayment200Response., must be smaller than or equal to 256.');
        }
    ...
    public function setMerchantName(mixed $merchantName): static
    {
        ...
        if (!is_null($merchantName) && mb_strlen($merchantName) > 25) {
            throw new \InvalidArgumentException('invalid length for $merchantName when calling CapturePayment200Response., must be smaller than or equal to 25.');
        }
    ...
    public function setForward(mixed $forward): static
    {
        ...
        if (!is_null($forward) && mb_strlen($forward) > 7) {
            throw new \InvalidArgumentException('invalid length for $forward when calling CapturePayment200Response., must be smaller than or equal to 7.');
        }
        if (!is_null($forward) && mb_strlen($forward) < 1) {
            throw new \InvalidArgumentException('invalid length for $forward when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setIssuer(mixed $issuer): static
    {
        ...
        if (!is_null($issuer) && mb_strlen($issuer) > 7) {
            throw new \InvalidArgumentException('invalid length for $issuer when calling CapturePayment200Response., must be smaller than or equal to 7.');
        }
        if (!is_null($issuer) && mb_strlen($issuer) < 1) {
            throw new \InvalidArgumentException('invalid length for $issuer when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setTransactionId(mixed $transactionId): static
    {
        ...
        if (!is_null($transactionId) && mb_strlen($transactionId) > 28) {
            throw new \InvalidArgumentException('invalid length for $transactionId when calling CapturePayment200Response., must be smaller than or equal to 28.');
        }
        if (!is_null($transactionId) && mb_strlen($transactionId) < 28) {
            throw new \InvalidArgumentException('invalid length for $transactionId when calling CapturePayment200Response., must be bigger than or equal to 28.');
        }
    ...
    public function setApprove(mixed $approve): static
    {
        ...
        if (!is_null($approve) && mb_strlen($approve) > 7) {
            throw new \InvalidArgumentException('invalid length for $approve when calling CapturePayment200Response., must be smaller than or equal to 7.');
        }
        if (!is_null($approve) && mb_strlen($approve) < 1) {
            throw new \InvalidArgumentException('invalid length for $approve when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setItemCode(mixed $itemCode): static
    {
        ...
        if (!is_null($itemCode) && mb_strlen($itemCode) > 7) {
            throw new \InvalidArgumentException('invalid length for $itemCode when calling CapturePayment200Response., must be smaller than or equal to 7.');
        }
        if (!is_null($itemCode) && mb_strlen($itemCode) < 7) {
            throw new \InvalidArgumentException('invalid length for $itemCode when calling CapturePayment200Response., must be bigger than or equal to 7.');
        }
    ...
    public function setAcs(mixed $acs): static
    {
        ...
        if (!is_null($acs) && mb_strlen($acs) > 1) {
            throw new \InvalidArgumentException('invalid length for $acs when calling CapturePayment200Response., must be smaller than or equal to 1.');
        }
        if (!is_null($acs) && mb_strlen($acs) < 1) {
            throw new \InvalidArgumentException('invalid length for $acs when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setCodeUrl(mixed $codeUrl): static
    {
        ...
        if (!is_null($codeUrl) && mb_strlen($codeUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $codeUrl when calling CapturePayment200Response., must be smaller than or equal to 256.');
        }
        if (!is_null($codeUrl) && mb_strlen($codeUrl) < 1) {
            throw new \InvalidArgumentException('invalid length for $codeUrl when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setRedirectUrl(mixed $redirectUrl): static
    {
        ...
        if (!is_null($redirectUrl) && mb_strlen($redirectUrl) > 256) {
            throw new \InvalidArgumentException('invalid length for $redirectUrl when calling CapturePayment200Response., must be smaller than or equal to 256.');
        }
        if (!is_null($redirectUrl) && mb_strlen($redirectUrl) < 1) {
            throw new \InvalidArgumentException('invalid length for $redirectUrl when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderDescription(mixed $orderDescription): static
    {
        ...
        if (!is_null($orderDescription) && mb_strlen($orderDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $orderDescription when calling CapturePayment200Response., must be smaller than or equal to 100.');
        }
    ...
    public function setCaptureDescription(mixed $captureDescription): static
    {
        ...
        if (!is_null($captureDescription) && mb_strlen($captureDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $captureDescription when calling CapturePayment200Response., must be smaller than or equal to 100.');
        }
    ...
    public function setUpdateDescription(mixed $updateDescription): static
    {
        ...
        if (!is_null($updateDescription) && mb_strlen($updateDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $updateDescription when calling CapturePayment200Response., must be smaller than or equal to 100.');
        }
    ...
    public function setCancelDescription(mixed $cancelDescription): static
    {
        ...
        if (!is_null($cancelDescription) && mb_strlen($cancelDescription) > 100) {
            throw new \InvalidArgumentException('invalid length for $cancelDescription when calling CapturePayment200Response., must be smaller than or equal to 100.');
        }
    ...
    public function setStoreId(mixed $storeId): static
    {
        ...
        if (!is_null($storeId) && mb_strlen($storeId) > 18) {
            throw new \InvalidArgumentException('invalid length for $storeId when calling CapturePayment200Response., must be smaller than or equal to 18.');
        }
        if (!is_null($storeId) && mb_strlen($storeId) < 1) {
            throw new \InvalidArgumentException('invalid length for $storeId when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setCodeId(mixed $codeId): static
    {
        ...
        if (!is_null($codeId) && mb_strlen($codeId) > 64) {
            throw new \InvalidArgumentException('invalid length for $codeId when calling CapturePayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($codeId) && mb_strlen($codeId) < 1) {
            throw new \InvalidArgumentException('invalid length for $codeId when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentId(mixed $paymentId): static
    {
        ...
        if (!is_null($paymentId) && mb_strlen($paymentId) > 64) {
            throw new \InvalidArgumentException('invalid length for $paymentId when calling CapturePayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($paymentId) && mb_strlen($paymentId) < 1) {
            throw new \InvalidArgumentException('invalid length for $paymentId when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setPaypayResultCode(mixed $paypayResultCode): static
    {
        ...
        if (!is_null($paypayResultCode) && mb_strlen($paypayResultCode) > 256) {
            throw new \InvalidArgumentException('invalid length for $paypayResultCode when calling CapturePayment200Response., must be smaller than or equal to 256.');
        }
        if (!is_null($paypayResultCode) && mb_strlen($paypayResultCode) < 1) {
            throw new \InvalidArgumentException('invalid length for $paypayResultCode when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantPaymentId(mixed $merchantPaymentId): static
    {
        ...
        if (!is_null($merchantPaymentId) && mb_strlen($merchantPaymentId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantPaymentId when calling CapturePayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantPaymentId) && mb_strlen($merchantPaymentId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantPaymentId when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantCaptureId(mixed $merchantCaptureId): static
    {
        ...
        if (!is_null($merchantCaptureId) && mb_strlen($merchantCaptureId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantCaptureId when calling CapturePayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantCaptureId) && mb_strlen($merchantCaptureId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantCaptureId when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantUpdateId(mixed $merchantUpdateId): static
    {
        ...
        if (!is_null($merchantUpdateId) && mb_strlen($merchantUpdateId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantUpdateId when calling CapturePayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantUpdateId) && mb_strlen($merchantUpdateId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantUpdateId when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantRevertId(mixed $merchantRevertId): static
    {
        ...
        if (!is_null($merchantRevertId) && mb_strlen($merchantRevertId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantRevertId when calling CapturePayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantRevertId) && mb_strlen($merchantRevertId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantRevertId when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setMerchantRefundId(mixed $merchantRefundId): static
    {
        ...
        if (!is_null($merchantRefundId) && mb_strlen($merchantRefundId) > 64) {
            throw new \InvalidArgumentException('invalid length for $merchantRefundId when calling CapturePayment200Response., must be smaller than or equal to 64.');
        }
        if (!is_null($merchantRefundId) && mb_strlen($merchantRefundId) < 1) {
            throw new \InvalidArgumentException('invalid length for $merchantRefundId when calling CapturePayment200Response., must be bigger than or equal to 1.');
        }
